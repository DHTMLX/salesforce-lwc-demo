...
dhtmlxGantt v.9.0.14 Professional Evaluation
...
function Ze(t) {
  t._get_linked_task = function(o, l) {
    var c = null, d = l ? o.target : o.source;
    return t.isTaskExists(d) && (c = t.getTask(d)), c;
  ...
  t._isLinksCacheEnabled = function() {
    ...
    e = {}, i = {}, a = {}, r = {}, n = !1;
  }, t._formatLink = function(o, l, c) {
    if (n && e[o.id]) return e[o.id];
    var d = [], u = this._get_link_target(o), h = this._get_link_source(o);
    if (!h || !u || t.isSummaryTask(u) && t.isChildOf(h.id, u.id) || t.isSummaryTask(h) && t.isChildOf(u.id, h.id)) return d;
    var _ = t.config.schedule_from_end && t.config.project_end, f = t.config.auto_scheduling_move_projects;
    !t.config.auto_scheduling_compatibility && t.config.auto_scheduling_strict && (f = !1), l = l || this.isSummaryTask(h) && !s(h) ? this.getSubtaskDates(h.id) : { start_date: h.start_date, end_date: h.end_date };
    ...
    c || (c = { start_date: u.start_date, end_date: u.end_date }, this.isSummaryTask(u) && !s(u) && ((c = this.getSubtaskDates(u.id)).start_date = c.end_date, this.eachTask(function(S) {
      S.type !== this.config.types.project && !S.$target.length && S.start_date < c.start_date && (c.start_date = S.start_date);
    }, u.id)));
    for (var v = this._getImplicitLinks(o, u, function(S) {
      return !f || _ || S.$target.length || t.getState("tasksDnd").drag_id == S.id ? 0 : t.calculateDuration({ start_date: c.start_date, end_date: S.start_date, task: u });
    }), b = 0, g = y.length; b < g; b++) for (var m = y[b], p = 0, k = v.length; p < k; p++) {
      var w = v[p], x = 1 * m.lag + 1 * w.lag, $ = { id: o.id, type: o.type, source: m.task, target: w.task, subtaskLink: m.subtaskLink, lag: (1 * o.lag || 0) + x };
      t._linkedTasks[$.target] = t._linkedTasks[$.target] || {}, t._linkedTasks[$.target][$.source] = !0, d.push(t._convertToFinishToStartLink(w.task, $, h, u, m.taskParent, w.taskParent));
    }
    return n && (e[o.id] = d), d;
    ...
    if (this.isSummaryTask(o)) {
      let l = !0;
      if (this.eachTask(function(c) {
        l && t._isAutoSchedulable(c) && (l = !1);
      }, o.id), l) return !1;
    }
    return !0;
  }, t._getImplicitLinks = function(o, l, c, d) {
    var u = [];
    if (this.isSummaryTask(l) && !s(l)) {
      ...
      for (var f in this.eachTask(function(k) {
        ...
        if (t._isAutoSchedulable(y)) {
          ...
          if (!h) {
            let k = !0;
            for (const x in t._linkedTasks[y.id]) if (t.isChildOf(x, o.target)) {
              k = !1;
              break;
            }
            let w = 0;
            k && (w = c(y)), u.push({ task: y.id, taskParent: y.parent, lag: w, subtaskLink: !0 });
          }
        }
      }
    ...
    for (var c = [], d = [], u = l ? o.$source : o.$target, h = 0; h < u.length; h++) {
    ...
    for (h = 0; h < c.length; h++) d = d.concat(this._formatLink(c[h]));
    return d;
  }, t._getInheritedDependencies = function(o, l) {
    var c, d = !1, u = [];
    return this.isTaskExists(o.id) && this.eachParent(function(h) {
      var _;
      d || (n && (c = l ? i : a)[h.id] ? u = u.concat(c[h.id]) : this.isSummaryTask(h) && (this._isAutoSchedulable(h) ? (_ = this._getDirectDependencies(h, l), n && (c[h.id] = _), u = u.concat(_)) : d = !0));
    }, o.id, this), u;
    ...
    var c = this._getDirectSuccessors(o);
    return l ? c : c.concat(this._getInheritedSuccessors(o));
  }, t._getPredecessors = function(o, l) {
    var c, d = String(o.id) + "-" + String(l);
    if (n && r[d]) return r[d];
    var u = this._getDirectPredecessors(o);
    return c = l ? u : u.concat(this._getInheritedPredecessors(o)), n && (r[d] = c), c;
  }, t._convertToFinishToStartLink = function(o, l, c, d, u, h) {
    var _ = { target: o, link: t.config.links.finish_to_start, id: l.id, lag: l.lag || 0, sourceLag: 0, targetLag: 0, trueLag: l.lag || 0, source: l.source, preferredStart: null, sourceParent: u, targetParent: h, hashSum: null, subtaskLink: l.subtaskLink }, f = 0;
    switch (String(l.type)) {
      case String(t.config.links.start_to_start):
        f = -c.duration, _.sourceLag = f;
        break;
      case String(t.config.links.finish_to_finish):
        f = -d.duration, _.targetLag = f;
        break;
      case String(t.config.links.start_to_finish):
        f = -c.duration - d.duration, _.sourceLag = -c.duration, _.targetLag = -d.duration;
        break;
      default:
        f = 0;
    }
...
var Qe = { second: 1, minute: 60, hour: 3600, day: 86400, week: 604800, month: 2592e3, quarter: 7776e3, year: 31536e3 };
function Zt(t) {
  return Qe[t] || Qe.hour;
}
function ht(t, n) {
...
function en() {
  return { getVertices: function(t) {
    ...
    for (var s = n.filter(function(u) {
      ...
      o.push(l);
      var c = e[l];
      for (i = 0; i < c.$source.length; i++) {
        var d = e[t[c.$source[i]].target];
        d.$incoming--, d.$incoming || s.push(d.id);
      }
    }
    return o;
    ...
    for (var e = {}, i = [], a = this.groupAdjacentEdges(n), r = !1, s = [], o = 0; o < t.length; o++) {
      var l = y(t[o]);
      if (!l.visited) for (var c = [l], d = 0; c.length; ) {
        var u = c.pop();
        u.visited || (u.index = d, u.lowLink = d, d++, i.push(u), u.onStack = !0, u.visited = !0), r = !1, n = a[u.id] || [];
        for (var h = 0; h < n.length; h++) {
          var _ = y(n[h].target);
          if (_.edge = n[h], _.index === void 0) {
            c.push(u), c.push(_), r = !0;
            break;
          }
        ...
        if (!r) {
          if (u.index == u.lowLink) {
            for (var f = { tasks: [], links: [], linkKeys: [] }; (_ = i.pop()).onStack = !1, f.tasks.push(_.id), _.edge && (f.links.push(_.edge.id), f.linkKeys.push(_.edge.hashSum)), _ != u; ) ;
            s.push(f);
          }
          c.length && (_ = u, (u = c[c.length - 1]).lowLink = Math.min(u.lowLink, _.lowLink));
        }
      }
    }
    return s;
...
function nn(t) {
  return { getVirtualRoot: function() {
    ...
    for (var l = [], c = 0; c < s.length; c++) a[r = s[c].hashSum] || (a[r] = !0, l.push(s[c]));
    for (c = 0; c < o.length; c++) a[r = o[c].hashSum] || (a[r] = !0, l.push(o[c]));
    return l;
    ...
    for (var r, s = n === void 0 ? t.config.root_id : n, o = (e = {}, {}), l = [{ from: s, includePredecessors: i, isChild: !1 }]; l.length; ) {
      var c = l.pop(), d = c.isChild;
      if (!e[s = c.from]) {
        r = t.isTaskExists(s) ? t.getTask(s) : this.getVirtualRoot(), e[s] = !0;
        for (var u = this._collectRelations(r, d, i, o), h = 0; h < u.length; h++) {
          var _ = u[h];
          let v = !0;
  ...
  constructor(n) {
    this.isAsapTask = (e) => {
      ...
      if (this._gantt.eachTask((l) => s(l), e), i) for (let l = 0; l < i.length; l++) {
        const c = i[l];
        r[c.target] || (o = this._gantt.getTask(c.target), s(o)), r[c.source] || (o = this._gantt.getTask(c.source), s(o));
      }
...
class je {
  ...
  resolveRelationDate(n, e, i) {
    ...
    const l = this._gantt.getTask(n), c = e.successors;
    let d = null;
    const u = i[n];
    for (let _ = 0; _ < c.length; _++) {
      const f = c[_];
      o = f.preferredStart;
      const y = this.getLatestEndDate(f, i, l), v = this._gantt.calculateEndDate({ start_date: y, duration: -l.duration, task: l });
      this._comparator.isGreaterOrDefault(d, y, l) && (d = y), this._comparator.isGreaterOrDefault(o, v, l) && this._comparator.isGreaterOrDefault(a, y, l) && (a = y, s = v, r = f.id);
    }
    !c.length && this._gantt.config.project_end && (this._comparator.isGreaterOrDefault(this._gantt.config.project_end, l.end_date, l) && (a = this._gantt.config.project_end), this._gantt.callEvent("onBeforeTaskAutoSchedule", [l, l.end_date]) === !1 && (a = l.end_date)), a && (l.duration ? (a = this._gantt.getClosestWorkTime({ date: a, dir: "future", task: l }), s = this._gantt.calculateEndDate({ start_date: a, duration: -l.duration, task: l })) : s = a = this._gantt.getClosestWorkTime({ date: a, dir: "past", task: l }));
    const h = Pt.Create(u);
    return h.link = r, h.task = n, h.end_date = a, h.start_date = s, h.kind = "alap", d && (h.latestSchedulingStart = this._gantt.calculateEndDate({ start_date: d, duration: -l.duration, task: l }), h.latestSchedulingEnd = d), h;
  }
...
class Fe {
  ...
  resolveRelationDate(n, e, i) {
    ...
    const o = this._gantt.getTask(n), l = e.predecessors, c = {};
    let d = null;
    for (let f = 0; f < l.length; f++) {
      const y = l[f];
      s = y.preferredStart;
      const v = this.getEarliestStartDate(y, i, o);
      if (this._comparator.isSmallerOrDefault(d, v, o) && (d = v), this._comparator.isSmallerOrDefault(s, v, o) && this._comparator.isSmallerOrDefault(a, v, o) && (a = v, r = y.id), !o.duration) {
        const b = this._gantt.getLink(y.id);
        (c[b.type] === void 0 || c[b.type] < +v) && (c[b.type] = +v);
      }
    }
    ...
    let u = null;
    if (a) if (o.duration) a = this._gantt.getClosestWorkTime({ date: a, dir: "future", task: o }), u = this._gantt.calculateEndDate({ start_date: a, duration: o.duration, task: o });
    else {
      let f = "future";
      const y = this._gantt.config.links;
      if (c[y.finish_to_finish] !== void 0) {
        const v = l.length === 1;
        let b = !0;
        for (const g in c) if (g != y.finish_to_finish && c[y.finish_to_finish] < c[g]) {
          b = !1;
          break;
        }
        (v || b) && (f = "past");
    ...
    return _.link = r, _.task = n, _.start_date = a, _.end_date = u, _.kind = "asap", d && (_.earliestSchedulingStart = d, _.earliestSchedulingEnd = this._gantt.calculateEndDate({ start_date: d, duration: o.duration, task: o })), _;
  }
  ...
  getEarliestStartDate(n, e, i) {
    const a = this.getPredecessorEndDate(n.source, e), r = i, s = this._gantt.getTask(n.source);
    let o;
    if (a && n.lag && 1 * n.lag == 1 * n.lag) {
      let l = r;
      this._gantt.config.auto_scheduling_move_projects && n.subtaskLink && this._gantt.isTaskExists(n.targetParent) && (l = this._gantt.getTask(n.targetParent)), o = this._gantt.getClosestWorkTime({ date: a, dir: "future", task: s }), n.sourceLag && (o = this._gantt.calculateEndDate({ start_date: o, duration: 1 * n.sourceLag, task: s })), n.targetLag && (o = this._gantt.calculateEndDate({ start_date: o, duration: 1 * n.targetLag, task: l })), o = this._gantt.calculateEndDate({ start_date: o, duration: 1 * n.trueLag, task: l });
    } else {
      const l = this._gantt.getLink(n.id).type === this._gantt.config.links.finish_to_finish;
      o = !r.duration && l ? this._gantt.getClosestWorkTime({ date: a, dir: "past", task: r }) : this._gantt.getClosestWorkTime({ date: a, dir: "future", task: r });
    }
    return o;
  }
}
class ai {
  ...
  generatePlan(n, e) {
    const i = this._graphHelper, a = this._gantt, r = this._constraintsHelper, s = this._alapStrategy, o = this._asapStrategy, { orderedIds: l, reversedIds: c, relationsMap: d, plansHash: u } = this.buildWorkCollections(n, e, i);
    let h;
    return this.processConstraints(l, u, a, r), h = a.config.schedule_from_end ? this.iterateTasks(c, l, r.isAlapTask, s, o, d, u) : this.iterateTasks(l, c, r.isAsapTask, o, s, d, u), h;
  }
  applyProjectPlan(n) {
    const e = this._gantt;
    let i, a, r, s;
    ...
    for (let l = 0; l < n.length; l++) {
      ...
      let c = null;
      i.start_date && a.start_date.valueOf() !== i.start_date.valueOf() && (c = i.start_date), c && (a.start_date = c, a.end_date = e.calculateEndDate(a), o.push(a.id), e.callEvent("onAfterTaskAutoSchedule", [a, c, r, s]));
    }
    return o;
  }
  iterateTasks(n, e, i, a, r, s, o) {
    const l = this._gantt, c = [];
    for (let d = 0; d < n.length; d++) {
      const u = n[d], h = l.getTask(u);
      if (!l._isAutoSchedulable(h)) continue;
      const _ = a.resolveRelationDate(u, s[u], o);
      this.limitPlanDates(h, _), i(h) ? this.processResolvedDate(h, _, c, o) : o[h.id] = _;
    }
    for (let d = 0; d < e.length; d++) {
      const u = e[d], h = l.getTask(u);
      if (l._isAutoSchedulable(h) && !i(h)) {
        const _ = r.resolveRelationDate(u, s[u], o);
        this.limitPlanDates(h, _), this.processResolvedDate(h, _, c, o);
      }
    }
  ...
  summaryLagChanged(n, e, i) {
    ...
    for (const o in e) e[o].predecessors.forEach((l) => {
      if (l.subtaskLink) {
        const c = n.getLink(l.id);
        this.getProjectUpdates(n, i, l, c, "source", a, r), this.getProjectUpdates(n, i, l, c, "target", a, r);
      }
    });
    let s = !1;
    for (const o in a) {
      ...
      const c = n.getTask(o), d = n.calculateDuration({ start_date: c.start_date, end_date: c.end_date, task: c }), u = n.calculateDuration({ start_date: l.min, end_date: l.max, task: c });
      u !== d && (c.start_date = l.min, c.end_date = l.max, c.duration = u);
    }
    for (const o in r) {
      const l = r[o];
      let c, d;
      const u = a[l.source], h = a[l.target];
      u && (c = { start_date: u.start_date, end_date: u.end_date }), h && (c = { start_date: h.start_date, end_date: h.end_date }), n._formatLink(l, c, d).forEach(function(_) {
        for (const f in e) e[f].predecessors.forEach(function(y) {
          const v = y.id === _.id, b = y.target === _.target, g = y.source === _.source;
          v && b && g && (y.lag = _.lag, y.sourceLag = _.sourceLag, y.targetLag = _.targetLag, y.hashSum = _.hashSum);
        });
      }), s = !0;
    }
    return s;
  ...
  getProjectUpdates(n, e, i, a, r, s, o) {
    if (n.getTask(a[r]).type === n.config.types.project) {
      ...
      const l = s[a[r]];
      let c = e[i[r]];
      c && (r != "source" || c.start_date && c.end_date || (c = n.getTask(c.task)), l.min = l.min || c.start_date, l.min > c.start_date && (l.min = c.start_date), l.max = l.max || c.end_date, l.max < c.end_date && (l.max = c.end_date), o[a.id] = a);
    }
  }
  ...
  buildWorkCollections(n, e, i) {
    ...
    for (let c = 0, d = r.length; c < d; c++) {
      const u = r[c], h = a.getTask(u);
      a._isAutoSchedulable(h) && (l[u] = { successors: [], predecessors: [] }, o[u] = null);
    }
    for (let c = 0, d = e.length; c < d; c++) {
      const u = e[c];
      o[u.id] === void 0 && (s.unshift(u.id), r.unshift(u.id), o[u.id] = null, l[u.id] = { successors: [], predecessors: [] });
    }
    for (let c = 0, d = n.length; c < d; c++) {
      const u = n[c];
      l[u.source] && l[u.source].successors.push(u), l[u.target] && l[u.target].predecessors.push(u);
    }
  ...
  processConstraints(n, e, i, a) {
    for (let r = 0; r < n.length; r++) {
      ...
      if (l && l !== U.ASAP && l !== U.ALAP) {
        const c = a.processConstraint(o, Pt.Create());
        e[o.id] = c;
      }
    }
  }
...
function he(t, n, e) {
  ...
  for (; i.length > 0; ) if (o = i.shift(), !e[o]) {
    ...
    for (let d = 0; d < n.length; d++) {
      const u = n[d];
      u.source == o || u.sourceParent == o ? (e[u.target] || (i.push(u.target), s[u.id] = !0, n.splice(d, 1), d--), r[u.hashSum] = u) : u.target != o && u.targetParent != o || (e[u.source] || (i.push(u.source), s[u.id] = !0, n.splice(d, 1), d--), r[u.hashSum] = u);
    }
  }
  const l = [];
  let c = [];
  for (const d in s) l.push(d);
  for (const d in r) c.push(r[d]);
  return c.length || (c = n), { tasks: a, links: l, processedLinks: c };
}
class ri {
  constructor(n, e) {
    this.getConnectedGroupRelations = (i) => he(i, this._linksBuilder.getLinkedTasks(), {}).processedLinks, this.getConnectedGroup = (i) => {
      ...
      return function(r) {
        const s = {}, o = [];
        let l, c, d;
        for (let u = 0; u < r.length; u++) if (l = r[u].source, c = r[u].target, d = null, s[l] ? s[c] || (d = c) : d = l, d) {
          const h = r.length;
          o.push(he(d, r, s)), h !== r.length && (u = -1);
        }
        return o;
...
class si {
  constructor(n, e, i) {
    this.isCircularLink = (a) => !!this.getLoopContainingLink(a), this.getLoopContainingLink = (a) => {
      ...
      const c = r.findLoops(l);
      for (let d = 0; d < c.length; d++) {
        const u = c[d].links;
        for (let h = 0; h < u.length; h++) if (u[h] == a.id) return c[d];
      }
      return null;
    }, this.findCycles = () => {
...
function oi(t, n, e, i) {
  const a = function() {
    ...
    }), t.attachEvent("onBeforeLinkAdd", c), t.attachEvent("onBeforeLinkAdd", d), t.attachEvent("onBeforeLinkUpdate", c), t.attachEvent("onBeforeLinkUpdate", d), t.attachEvent("onBeforeTaskDrag", function(x, $, S) {
      return t.config.auto_scheduling && (t.getState().drag_mode !== "progress" && (r = _(x)), s = x), !0;
    });
    const g = function(x, $) {
      const S = t.getTask(x);
      y(S, $) || v(S);
    ...
    t.attachEvent("onBeforeTaskChanged", function(x, $, S) {
      ...
      x === s && (clearTimeout(w), w = setTimeout(function() {
        (function(T, E) {
          if (t.config.auto_scheduling && !t._autoscheduling_in_progress) {
            ...
            if (h(E, C)) {
              if (g(T, E), t.config.auto_scheduling_move_projects && s == T) {
                let A = !0;
      ...
      if (t.config.auto_scheduling && !t._autoscheduling_in_progress) {
        m = !1;
        const S = t.getTask(x);
        h($, S) && (p = x, y($, S) && ($.$keep_constraints = !0), t.getConstraintType($) === t.getConstraintType(S) && +$.constraint_date == +S.constraint_date || (m = !0));
      }
      return !0;
    }), t.attachEvent("onAfterTaskUpdate", function(x, $) {
      return t.config.auto_scheduling && !t._autoscheduling_in_progress && p !== null && p == x && (p = null, $.$keep_constraints ? delete $.$keep_constraints : m || v($), t.autoSchedule($.id), m || b($)), !0;
    });
  };
...
function K(t) {
  ...
  if (t.getBoundingClientRect) {
    ...
    n = r.top + l - d, e = r.left + c - u, i = document.body.offsetWidth - r.right, a = document.body.offsetHeight - r.bottom;
  } else {
...
function Ut(t) {
  ...
  for (e.sort(function(r, s) {
    ...
    var a = e[i];
    (ci(a) || ui(a) || di(a)) && li(a) || (e.splice(i, 1), i--);
  }
  return e;
}
function Tn() {
...
function yt(t, n, e) {
  ...
  for (e === void 0 && (e = !0); i; ) {
    if (a = it(i)) {
      ...
      if (r >= 0) {
        if (!e) return i;
        var s = r === 0 || !Ce(a.charAt(r - 1)), o = r + n.length >= a.length || !Ce(a.charAt(r + n.length));
        if (s && o) return i;
      }
    }
    i = i.parentNode;
...
function ct(t, n) {
  var s;
  const e = document.documentElement, i = K(n), { clientX: a, clientY: r } = ((s = t.touches) == null ? void 0 : s[0]) ?? t;
...
function Dt(t) {
  if (!t || !In()) return document.body;
  for (; t.parentNode && (t = t.parentNode); ) if (t instanceof ShadowRoot) return t.host;
  return document.body;
}
const Ln = Object.freeze(Object.defineProperty({ __proto__: null, addClassName: xt, closest: dt, getActiveElement: De, getChildNodes: Dn, getClassName: it, getClosestSizedElement: Mn, getFocusableNodes: Ut, getNodePosition: K, getRelativeEventPosition: ct, getRelativeNodePosition: An, getRootNode: Dt, getScrollSize: Tn, getTargetNode: At, hasClass: function(t, n) {
  return "classList" in t ? t.classList.contains(n) : new RegExp("\\b" + n + "\\b").test(t.className);
}, hasShadowParent: function(t) {
  return !!Dt(t);
}, insertNode: En, isChildOf: et, isShadowDomSupported: In, locateAttribute: tt, locateClassName: yt, removeClassName: Nt, removeNode: Cn, toNode: We }, Symbol.toStringTag, { value: "Module" })), Y = typeof window < "u" ? window : global;
let hi = class {
  constructor(t) {
  ...
  attach(t, n, e) {
    ...
    this._originPosition = Y.getComputedStyle(a).display, this._restoreOriginPosition = () => {
    ...
    this._domEvents.attach(l, "mouseup", (f) => {
      ...
      this._touchStarts = !0, this._longTapTimer = setTimeout(() => {
        this._touchStarts && (u(c(f)), this._touchStarts = !1, this._touchActive = !0);
      }, this._gantt.config.touch_drag);
    }), this._domEvents.attach(l, "touchend", (f) => {
      this._touchStarts = !1, this._touchActive = !1, clearTimeout(this._longTapTimer), h(c(f));
    }), this._domEvents.attach(a, "touchmove", (f) => {
      if (this._touchActive) {
        let y = d();
        if (y && i.utils.dom.closest(f.target, y)) return;
        _(c(f)), f.preventDefault();
    ...
    const d = () => {
      ...
      s = null;
      let y = d();
      y && i.utils.dom.closest(f.target, y) || (r.registerProvider("clickDrag", () => ({ autoscroll: this._mouseDown })), n && f[n] !== !0 || (s = this._getCoordinates(f, t)));
    }, h = (f) => {
...
Nn.prototype = { _silentStart: function() {
  this._silent_mode = !0;
}, _silentEnd: function() {
  this._silent_mode = !1;
} };
...
class te {
  constructor(n) {
    this._mouseDown = !1, this._calculateDirectionVector = () => {
      ...
      this._mouseDown = !1, _e = !1;
    }, this._startDrag = (e) => {
      const i = this._gantt;
      this._originAutoscroll = i.config.autoscroll, i.config.autoscroll = !1, _e = !0, i.$root.classList.add("gantt_noselect"), this._originalReadonly = i.config.readonly, i.config.readonly = !0, i.config.drag_timeline && i.config.drag_timeline.render && i.render(), this._trace = [], this._mouseDown = !0;
...
function gi(t) {
  (function() {
    ...
    function a(c) {
      t.eventRemove(c, "keydown", s), t.event(c, "keydown", s), n.push(c);
    }
    function r() {
      var c = n.pop();
    ...
    function s(c) {
      ...
      d == n[n.length - 1] && t.$keyboardNavigation.trapFocus(d, c);
    }
    function o() {
      a(t.getLightbox());
    }
...
class fi {
  constructor(n) {
    this.show = (e, i) => {
      ...
      i._waiAria.quickInfoHeader(r, [e.header.title, e.header.date].join(" ")), o.innerHTML = e.header.title, l.innerHTML = e.header.date, e.header.title || e.header.date ? s.style.display = "" : s.style.display = "none", c.innerHTML = e.content;
      const u = e.buttons;
  ...
  _show_quick_info(n, e) {
    ...
    if (i.config.quick_info_detached) {
      ...
      const s = a.offsetWidth, o = a.offsetHeight, l = i.getScrollState(), c = r.xViewport, d = r.yViewport, u = c.offsetWidth + l.x - s, h = n.top - l.y + o;
      let _ = n.top;
      h > d.offsetHeight / 2 && (_ = n.top - (o + n.height + 2 * e), _ < l.y && h <= d.offsetHeight && (_ = n.top)), _ < l.y && (_ = l.y);
      const f = Math.min(Math.max(l.x, n.left - n.dx * (s - n.width)), u), y = _;
...
var ge, pi = {}.constructor.toString();
function X(t) {
  var n, e;
...
function ut() {
  return ge || (ge = (/* @__PURE__ */ new Date()).valueOf()), ++ge;
}
function z(t, n) {
...
const Hn = Object.freeze(Object.defineProperty({ __proto__: null, bind: z, copy: X, defined: G, event: Pn, eventRemove: Rn, mixin: O, uid: ut }, Symbol.toStringTag, { value: "Module" }));
function Ve(t, n) {
  t = t || Pn, n = n || Rn;
  var e = [], i = { attach: function(a, r, s, o) {
    ...
    for (var l = 0; l < e.length; l++) {
      var c = e[l];
      c.element === a && c.event === r && c.callback === s && c.capture === o && (e.splice(l, 1), l--);
    }
  }, detachAll: function() {
    ...
    return Ve(this.event, this.eventRemove);
  } };
  return i;
}
class mi {
  ...
  _calculateTooltipPosition(n) {
    const e = this._gantt, i = this._getViewPortSize(), a = this.getNode(), r = { top: 0, left: 0, width: a.offsetWidth, height: a.offsetHeight, bottom: 0, right: 0 }, s = e.config.tooltip_offset_x, o = e.config.tooltip_offset_y, l = document.body, c = ct(n, l), d = K(l);
  ...
  _getViewPortSize() {
    ...
    return e === n.$task_data ? (a = n.$task, r = 0, s = 0, i = K(n.$task)) : i = K(a), { left: i.x + s, top: i.y + r, width: i.width, height: i.height, bottom: i.y + i.height + r, right: i.x + i.width + s };
  }
}
class vi {
  constructor(n) {
    this._listeners = {}, this.tooltip = new mi(n), this._gantt = n, this._domEvents = Ve(), this._initDelayedFunctions();
  }
  destructor() {
  ...
  attach(n) {
    ...
    let a = null;
    const r = (s) => {
      const o = At(s), l = dt(o, n.selector);
      if (et(o, this.tooltip.getNode())) return;
      const c = () => {
        a = l, n.onmouseenter(s, l);
      };
      a ? l && l === a ? n.onmousemove(s, l) : (n.onmouseleave(s, a), a = null, l && l !== a && c()) : l && c();
    };
...
const an = { onBeforeUndo: "onAfterUndo", onBeforeRedo: "onAfterRedo" }, rn = ["onTaskDragStart", "onAfterTaskUpdate", "onAfterParentExpand", "onAfterTaskDelete", "onBeforeBatchUpdate"];
class ki {
  constructor(n, e) {
  ...
  setNestedTasks(n, e) {
    ...
    for (let c = 0; c < e.length; c++) a = this.setInitialTask(e[c]), s = s.concat(this._getLinks(a)), r.push(a);
    const o = {};
  ...
  _attachEvents() {
    ...
    for (const l in an) e.attachEvent(l, () => (this.startIgnore(), !0)), e.attachEvent(an[l], () => (this.stopIgnore(), !0));
    for (let l = 0; l < rn.length; l++) e.attachEvent(rn[l], () => (this.startBatchAction(), !0));
    e.attachEvent("onParse", () => {
      this._undo.clearUndoStack(), this._undo.clearRedoStack(), i();
    }), e.attachEvent("onAfterTaskAdd", (l, c) => {
      this.setInitialTask(l, !0), this.onTaskAdded(c);
    }), e.attachEvent("onAfterTaskUpdate", (l, c) => {
      this.onTaskUpdated(c);
    }), e.attachEvent("onAfterParentExpand", (l, c) => {
      this.onTaskUpdated(c);
    }), e.attachEvent("onAfterTaskDelete", (l, c) => {
      this.onTaskDeleted(c);
    }), e.attachEvent("onAfterLinkAdd", (l, c) => {
      this.setInitialLink(l, !0), this.onLinkAdded(c);
    }), e.attachEvent("onAfterLinkUpdate", (l, c) => {
      this.onLinkUpdated(c);
    }), e.attachEvent("onAfterLinkDelete", (l, c) => {
      this.onLinkDeleted(c);
    }), e.attachEvent("onRowDragEnd", (l, c) => (this.onTaskMoved(a(l)), this.toggleIgnoreMoveEvents(), !0)), e.attachEvent("onBeforeTaskDelete", (l) => {
      this.store(l, e.config.undo_types.task);
      const c = [];
      return i(), e.eachTask((d) => {
        c.push(d.id);
      }, l), this.setNestedTasks(l, c), !0;
    });
    const r = e.getDatastore("task");
    r.attachEvent("onBeforeItemMove", (l, c, d) => (this.isMoveEventsIgnored() || i(), !0)), r.attachEvent("onAfterItemMove", (l, c, d) => (this.isMoveEventsIgnored() || this.onTaskMoved(a(l)), !0)), e.attachEvent("onRowDragStart", (l, c, d) => (this.toggleIgnoreMoveEvents(!0), i(), !0));
    let s = null, o = !1;
    if (e.attachEvent("onBeforeTaskDrag", (l) => {
      if (s = e.getState().drag_id, s === l) {
        const c = e.getTask(l);
        e.isSummaryTask(c) && e.config.drag_project && (o = !0);
      }
      if (e.plugins().multiselect) {
        const c = e.getSelectedTasks();
        c.length > 1 && c.forEach((d) => {
          this.store(d, e.config.undo_types.task, !0);
        });
      }
      ...
      e.attachEvent("onGanttLayoutReady", () => {
        l && e.ext.inlineEditors.detachEvent(l), c && e.ext.inlineEditors.detachEvent(c), c = e.ext.inlineEditors.attachEvent("onEditStart", (d) => {
          this.store(d.id, e.config.undo_types.task);
        }), l = e.ext.inlineEditors.attachEvent("onBeforeEditStart", (d) => (this.stopBatchAction(), !0));
      });
    }
  }
  _storeCommand(n) {
  ...
  _applyAction(n) {
    ...
    s[i.task] = { add: "addTask", get: "getTask", update: "updateTask", remove: "deleteTask", move: "moveTask", isExists: "isTaskExists" }, s[i.link] = { add: "addLink", get: "getLink", update: "updateLink", remove: "deleteLink", isExists: "isLinkExists" }, r.batchUpdate(function() {
      for (let o = 0; o < n.commands.length; o++) {
        e = n.commands[o];
        const l = s[e.entity][e.type], c = s[e.entity].get, d = s[e.entity].isExists;
        if (e.type === a.add) r[l](e.oldValue, e.oldValue.parent, e.oldValue.$local_index);
        else if (e.type === a.remove) r[d](e.value.id) && r[l](e.value.id);
        else if (e.type === a.update) {
          const u = r[c](e.value.id);
...
const bi = { auto_scheduling: function(t) {
  Xe(t), Ze(t);
  var n = nn(t), e = en(), i = ze.Create(t), a = new ai(t, e, i), r = new ri(t, n), s = new si(t, e, n);
  t.getConnectedGroup = r.getConnectedGroup, t.getConstraintType = i.getConstraintType, t.getConstraintLimitations = function(l) {
    var c = i.processConstraint(l, null);
  ...
  }, t.isCircularLink = s.isCircularLink, t.findCycles = s.findCycles, t.config.constraint_types = U, t.config.auto_scheduling = !1, t.config.auto_scheduling_descendant_links = !1, t.config.auto_scheduling_initial = !0, t.config.auto_scheduling_strict = !1, t.config.auto_scheduling_move_projects = !0, t.config.project_start = null, t.config.project_end = null, t.config.schedule_from_end = !1;
  var o = !1;
  t.attachEvent("onParse", function() {
    return o = !0, !0;
  }), t.attachEvent("onBeforeGanttRender", function() {
    return o = !1, !0;
  }), t._autoSchedule = function(l, c) {
    if (t.callEvent("onBeforeAutoSchedule", [l]) !== !1) {
      t._autoscheduling_in_progress = !0;
      var d = i.getConstraints(l, t.isTaskExists(l) ? c : null), u = [], h = e.findLoops(c);
      if (h.length) t.callEvent("onAutoScheduleCircularLink", [h]);
      else {
        (function(f, y) {
          if (t.config.auto_scheduling_compatibility) for (var v = 0; v < y.length; v++) {
            var b = y[v], g = t.getTask(b.target);
            t.config.auto_scheduling_strict && b.target != f || (b.preferredStart = new Date(g.start_date));
          }
        })(l, c);
        for (let f = 0; f < c.length; f++) if (c[f].subtaskLink) {
          a._secondIterationRequired = !0, a._secondIteration = !1;
          break;
        }
        var _ = a.generatePlan(c, d);
        (function(f) {
      ...
      t._autoscheduling_in_progress = !1, t.callEvent("onAfterAutoSchedule", [l, u]);
    }
  }, t.autoSchedule = function(l, c) {
    var d;
    c = c === void 0 || !!c, d = l !== void 0 ? t.config.auto_scheduling_compatibility ? n.getLinkedTasks(l, c) : r.getConnectedGroupRelations(l) : n.getLinkedTasks(), t._autoSchedule(l, d);
  ...
  function e() {
    ...
    t.ext.clickDrag && t.ext.clickDrag.destructor(), t.ext.clickDrag = new hi(t);
    ...
    const r = t.$ui.getView("timeline"), s = new _i(i, t, r);
  ...
  Xe(t), Ze(t);
  var n = function(i) {
    var a = nn(i), r = en(), s = { _freeSlack: {}, _totalSlack: {}, _slackNeedCalculate: !0, _linkedTasksById: {}, _successorsByTaskId: {}, _projectEnd: null, _calculateSlacks: function() {
      ...
      if (l.length) {
        ...
        for (var d = 0; d < o.length; d++) o[d].hashSum in c && (o.splice(d, 1), d--);
      }
      const u = r.topologicalSort(o).reverse(), h = {};
      o.forEach((f) => {
        h[f.source] || (h[f.source] = { linked: [] }), h[f.source].linked.push({ target: f.target, link: f });
      });
      const _ = { _cache: {}, getDist: function(f, y) {
        const v = `${f.id}_${y.id}`;
        if (this._cache[v]) return this._cache[v];
        {
          const b = i.calculateDuration({ start_date: f.end_date, end_date: y.start_date, task: f });
          return this._cache[v] = b, b;
        }
      } };
      this._projectEnd = i.getSubtaskDates().end_date, this._calculateFreeSlack(o, u, h, _), this._calculateTotalSlack(o, u, h, _);
    }, _isCompletedTask: function(o) {
      return i.config.auto_scheduling_use_progress && o.progress == 1;
    }, _calculateFreeSlack: function(o, l, c, d) {
      const u = this._freeSlack = {}, h = {};
      ...
      o.forEach((f) => {
        ...
        if (!y) return;
        _[f.source] = !0;
        let v = d.getDist(y, i.getTask(f.target));
        v -= f.lag || 0, u[f.source] !== void 0 ? u[f.source] = Math.min(v, u[f.source]) : u[f.source] = v;
      });
      for (const f in h) {
        if (_[f]) continue;
        const y = h[f];
        this._isCompletedTask(y) || y.unscheduled ? u[y.id] = 0 : u[y.id] = i.calculateDuration({ start_date: y.end_date, end_date: this._projectEnd, task: y });
      }
    ...
    }, _calculateTotalSlack: function(o, l, c, d) {
      ...
      for (var u = {}, h = i.getTaskByTime(), _ = 0; _ < l.length; _++) {
        ...
        else if (c[y.id] || i.isSummaryTask(y)) {
          const v = c[y.id].linked;
          let b = null;
          for (var f = 0; f < v.length; f++) {
            const g = v[f], m = i.getTask(g.target);
            let p = 0;
            u[m.id] !== void 0 && (p += u[m.id]), p += d.getDist(y, m), p -= g.link.lag || 0, b = b === null ? p : Math.min(b, p);
          }
          u[y.id] = b || 0;
      ...
      if (this._totalSlack[l] === void 0) {
        if (i.isSummaryTask(i.getTask(l))) {
          var c = null;
          return i.eachTask((function(d) {
            var u = this._totalSlack[d.id];
            u !== void 0 && (c === null || u < c) && (c = u);
          }).bind(this), l), this._totalSlack[l] = c !== null ? c : i.calculateDuration({ start_date: o.end_date, end_date: this._projectEnd, task: o }), this._totalSlack[l];
        }
        return 0;
      }
  ...
  var e = function(i) {
    return i._isProjectEnd = function(a) {
      ...
      var r = i.bind(function() {
        return this.reset(), !0;
      }, this), s = i.bind(function(l, c) {
        return this._cache && (this._cache[c] = this._cache[l], delete this._cache[l]), !0;
      }, this);
      ...
      i.attachEvent("onAfterLinkAdd", o), i.attachEvent("onAfterLinkUpdate", o), i.attachEvent("onAfterLinkDelete", o), i.attachEvent("onAfterTaskAdd", o), i.attachEvent("onTaskIdChange", function(l, c) {
        return i.config.highlight_critical_path && i.isTaskExists(c) && i.refreshTask(c), !0;
  ...
  t.config.highlight_critical_path = !1, e.init(n), t.isCriticalTask = function(i) {
    ...
    if (s[0]) for (l = 0; l < s.length; l++) {
      var c = this.getLink(s[l]), d = this._getSlack(i, a, this._convertToFinishToStartLink(c.id, c, i, a, i.parent, a.parent));
      (r > d || l === 0) && (r = d);
    }
    ...
    var l = a.start_date, c = 0;
    c = +o > +l ? -this.calculateDuration({ start_date: l, end_date: o, task: i }) : this.calculateDuration({ start_date: o, end_date: l, task: i });
    var d = r.lag;
    return d && 1 * d == d && (c -= d), c;
  };
  ...
  t.ext.fullscreen = { expand() {
    if (c() || n() || !t.callEvent("onBeforeExpand", [this.getFullscreenElement()])) return;
    o = !0;
  ...
  (function(n) {
    n.config.keyboard_navigation = !0, n.config.keyboard_navigation_cells = !1, n.$keyboardNavigation = {}, n._compose = function() {
      ...
      e.$keyboardNavigation.getFocusableNodes = Ut, e.$keyboardNavigation.trapFocus = function(i, a) {
        if (a.keyCode != 9) return !1;
        for (var r = e.$keyboardNavigation.getFocusableNodes(i), s = De(), o = -1, l = 0; l < r.length; l++) if (r[l] == s) {
          o = l;
          break;
        }
        if (a.shiftKey) {
      ...
      e.$keyboardNavigation.HeaderCell = function(i) {
        ...
        var a = yt(i, "gantt_grid_head_cell");
        if (a) {
      ...
      e.$keyboardNavigation.TaskRow = function(i) {
        ...
        if (!i) {
          ...
          const c = e.config.show_chart && e.$ui.getView("timeline");
          a.top < s.y || a.top + r > s.y + l ? e.scrollTo(null, a.top - 20) : e.config.scroll_on_click && c && (a.left > s.x + o ? e.scrollTo(a.left - e.config.task_scroll_offset) : a.left + a.width < s.x && e.scrollTo(a.left + a.width - e.config.task_scroll_offset));
        }
      ...
      function l(v) {
        if (!n.config.keyboard_navigation || !n.config.keyboard_navigation_cells && s(v)) return !0;
        if (!o(v)) {
          var b, g = e.fromDomElement(v);
          if (g && (e.activeNode instanceof n.$keyboardNavigation.TaskCell && et(v.target, n.$task) && (g = new n.$keyboardNavigation.TaskCell(g.taskId, e.activeNode.columnIndex)), b = g, n.config.show_grid && n.$ui.getView("grid") && n.config.keyboard_navigation_cells)) {
            const m = v.target.classList.contains("gantt_row"), p = v.target.closest(".gantt_task_line"), k = n.utils.dom.getNodePosition(n.$grid).x, w = k + n.$grid.offsetWidth, x = n.utils.dom.getNodePosition(document.activeElement).x;
            if (m || p && (x < k || w < x)) {
      ...
      var c = n.attachEvent("onGanttReady", function() {
        if (n.detachEvent(c), n.$data.tasksStore.attachEvent("onStoreUpdated", function(b) {
          if (n.config.keyboard_navigation && e.isEnabled()) {
            const g = e.getActiveNode(), m = n.$ui.getView("grid");
            if (!m || !m.$grid_data) return;
            const p = m.getItemTop(b), k = m.$grid_data.scrollTop, w = k + m.$grid_data.getBoundingClientRect().height;
          ...
          n._smart_render._redrawTasks = function(b, g) {
            if (n.config.keyboard_navigation && e.isEnabled()) {
              ...
              if (m && m.taskId !== void 0) {
                for (var p = !1, k = 0; k < g.length; k++) if (g[k].id == m.taskId && g[k].start_date) {
                  p = !0;
                  break;
                }
      ...
      var y = {};
      _t(y), n.mixin(y, { addShortcut: function(v, b, g) {
        var m = _(g);
  ...
  t.ext || (t.ext = {}), t.ext.quickInfo = new fi(t), t.config.quickinfo_buttons = ["icon_edit", "icon_delete"], t.config.quick_info_detached = !0, t.config.show_quick_info = !0, t.templates.quick_info_title = function(a, r, s) {
  ...
  function l(d, u, h) {
    ...
    for (let f = 0; f < d.length; f++) {
      const y = d[f];
      for (let v = 0; v < y.commands.length; v++) y.commands[v].entity === _.command.entity.task ? r(y.commands[v], u, h) : y.commands[v].entity === _.command.entity.link && o(y.commands[v], u, h);
    }
  }
  function c(d, u, h) {
    const _ = n;
  ...
  function n(l, c, d) {
    if (!l || Array.isArray(d) && !d[0]) return 0;
    ...
    if (d[0].resource_id || (d = [{ resource_id: d, value: 8 }]), typeof l == "string" && (l = l.split(",")), l.length == 1) return d[0].resource_id = l[0], [d[0]];
    const u = [];
    l.length > 1 && (l = [...new Set(l)]);
    for (let h = 0; h < l.length; h++) {
      let _ = l[h], f = d.map(function(y) {
        return y.resource_id;
      }).reduce(function(y, v, b) {
        return v === _ && y.push(b), y;
      }, []);
      if (f.length > 0) f.forEach((y) => {
        d[y].resource_id = _, u.push(d[y]);
      });
      else {
        let y = t.copy(d[0]);
  ...
  function i(l, c) {
    for (var d = !1, u = !1, h = 0; h < l.length; h++) {
      var _ = l[h][c];
      if (Array.isArray(_) && (u = !0, _.length && _[0].resource_id !== void 0)) {
        d = !0;
        break;
      }
    }
    return { haveArrays: u, haveResourceAssignments: d };
  }
  function a(l) {
  ...
  function s(l, c) {
    return l[c] instanceof Array ? l[c].length ? a(l[c]) : 0 : l[c];
  }
  function o() {
    const l = this;
    this.$data.tasksStore._listenerToDrop && this.$data.tasksStore.detachEvent(this.$data.tasksStore._listenerToDrop);
    const c = Qt(function() {
      if (l._groups.is_active() && i(t.getTaskByTime(), l._groups.relation_property).haveArrays && (l._groups.dynamicGroups = !0), l._groups.regroup && t.getScrollState) {
        const d = t.getScrollState();
        l._groups.regroup(), d && t.scrollTo(d.x, d.y);
      }
      return !0;
    });
    this.$data.tasksStore.attachEvent("onAfterUpdate", function() {
      return c.$pending || c(), !0;
    }), t.attachEvent("onParse", function() {
      c.$pending || l._groups.is_active() && c();
    });
  }
  t._groups = { relation_property: null, relation_id_property: "$group_id", group_id: null, group_text: null, loading: !1, loaded: 0, dynamicGroups: !1, set_relation_value: void 0, _searchCache: null, init: function(l) {
    ...
    var d = l.$data.tasksStore.getParent;
    this._searchCache = null, l.attachEvent("onBeforeTaskMove", function(h, _, f) {
      var y = _ === this.config.root_id, v = this._groups.dynamicGroups && !(this._groups.set_relation_value instanceof Function);
      if (c.is_active() && (y || v)) return !1;
      var b = l.getTask(h);
      if (this._groups.save_tree_structure && l.isTaskExists(b.parent) && l.isTaskExists(_)) {
        var g = l.getTask(b.parent), m = l.getTask(_);
      ...
      if (l.config.order_branch && l.config.order_branch != "marker") {
        ...
        if (f.$initial_parent) {
          if (f.parent == l.config.root_id) {
            var y = l.getTask(f.$rendered_parent), v = l.getTask(f.$initial_parent), b = !1;
            this._groups.dynamicGroups && y[this._groups.group_id] != v[this._groups.group_id] && (b = !0), this._groups.dynamicGroups || y[this._groups.group_id] == v[this._groups.relation_property] || (b = !0), b && (f.parent = f.$initial_parent);
          }
      ...
      return c.is_active() ? c.get_parent(l, h) : d.apply(this, arguments);
    };
    var u = l.$data.tasksStore.setParent;
    l.$data.tasksStore.setParent = function(h, _) {
      if (!c.is_active()) return u.apply(this, arguments);
      if (c.set_relation_value instanceof Function && l.isTaskExists(_)) {
        var f = (b = l.getTask(_))[c.relation_id_property];
        if (!b.$virtual) {
          var y = s(b, c.relation_property);
          c._searchCache || c._buildCache();
          var v = c._searchCache[y];
          f = l.getTask(v)[c.relation_id_property];
        }
        h[c.group_id] === void 0 && (h[c.group_id] = f), c.save_tree_structure && h[c.group_id] != f && (h[c.group_id] = f), f && (f = typeof f == "string" ? f.split(",") : [f]), h[c.relation_property] = c.set_relation_value(f, h.id, h[c.relation_property]) || f;
      } else if (l.isTaskExists(_)) {
        var b = l.getTask(_);
        c.dynamicGroups || (b.$virtual ? h[c.relation_property] = b[c.relation_id_property] : h[c.relation_property] = b[c.relation_property]), this._setParentInner.apply(this, arguments);
      } else c.dynamicGroups && (h[c.group_id] === void 0 || !h.$virtual && h[c.relation_property][0] === [][0]) && (h[c.relation_property] !== c.group_id ? h[c.relation_property] = h[c.relation_property] || 0 : h[c.relation_property] = 0);
      return l.isTaskExists(_) && (h.$rendered_parent = _, !l.getTask(_).$virtual) ? u.apply(this, arguments) || _ : void 0;
    }, l.attachEvent("onBeforeTaskDisplay", function(h, _) {
      return !(c.is_active() && _.type == l.config.types.project && !_.$virtual);
    }), l.attachEvent("onBeforeParse", function() {
      c.loading = !0, c._clearCache();
    }), l.attachEvent("onTaskLoading", function() {
      return c.is_active() && (c.loaded--, c.loaded <= 0 && (c.loading = !1, c._clearCache(), l.eachTask(l.bind(function(h) {
        this.get_parent(l, h);
      }, c)))), !0;
    }), l.attachEvent("onParse", function() {
      c.loading = !1, c.loaded = 0;
    });
  }, _clearCache: function() {
    this._searchCache = null;
  }, _buildCache: function() {
    this._searchCache = {};
    for (var l = t.$data.tasksStore.getItems(), c = 0; c < l.length; c++) this._searchCache[l[c][this.relation_id_property]] = l[c].id;
  }, get_parent: function(l, c, d) {
    c.id === void 0 && (c = l.getTask(c));
    var u = s(c, this.relation_property);
    if (this.save_tree_structure && l.isTaskExists(c.parent)) {
      let f = l.getTask(c.parent);
      const y = s(f, this.relation_property);
      if (f.type != "project" && u == y) return c.parent;
    }
    if (this._groups_pull[u] === c.id) return l.config.root_id;
    ...
    if (!this.loading && u !== void 0) {
      ...
      l.isTaskExists(_) && _ != c.id && (h = this._searchCache[u]), this._groups_pull[u] = h;
    }
    return h;
  }, clear: function() {
  ...
  }, generate_sections: function(l, c) {
    for (var d = [], u = 0; u < l.length; u++) {
      var h = t.copy(l[u]);
      h.type = c, h.open === void 0 && (h.open = !0), h.$virtual = !0, h.readonly = !0, h[this.relation_id_property] = h[this.group_id], h.text = h[this.group_text], d.push(h);
    }
    return d;
  }, clear_temp_tasks: function(l) {
    for (var c = 0; c < l.length; c++) l[c].$virtual && (l.splice(c, 1), c--);
  }, generate_data: function(l, c) {
    var d = l.getLinks(), u = l.getTaskByTime();
    this.clear_temp_tasks(u), u.forEach(function(f) {
      f.$calculate_duration = !1;
    });
    var h = [];
    this.is_active() && c && c.length && (h = this.generate_sections(c, l.config.types.project));
    var _ = { links: d };
    return _.data = h.concat(u), _;
  }, update_settings: function(l, c, d) {
    this.clear(), this.relation_property = l, this.group_id = c, this.group_text = d;
  }, group_tasks: function(l, c, d, u, h) {
    this.update_settings(d, u, h);
    var _ = this.generate_data(l, c);
    ...
    var u = i(d, l.relation_property);
    u.haveArrays && (this._groups.dynamicGroups = !0), this._groups.set_relation_value || (this._groups.set_relation_value = function(y) {
      return y.haveResourceAssignments ? n : y.haveArrays ? e : null;
    }(u)), (l = l || {}).default_group_label = l.default_group_label || this.locale.labels.default_group || "None";
    var h = l.relation_property || null, _ = l.group_id || "key", f = l.group_text || "label";
    this._groups.regroup = function() {
      var y = t.getTaskByTime(), v = {}, b = !1;
      y.forEach(function(m) {
        m.$virtual && m.$open !== void 0 && (v[m[_]] = m.$open, b = !0);
      });
      var g = function(m, p, k) {
        var w;
        return w = m.groups ? k._groups.dynamicGroups ? function(x, $) {
          var S = {}, T = [], E = {}, C = $.relation_property, D = $.delimiter || ",", A = !1, I = 0;
          ht($.groups, function(R) {
            R.default && (A = !0, I = R.group_id), E[R.key || R[$.group_id]] = R;
          });
          for (var M = 0; M < x.length; M++) {
            var L, N, P = x[M][C];
            if (Lt(P)) if (P.length > 0) L = a(P), N = P.map(function(R, B) {
              var H;
              return H = R && typeof R == "object" ? R.resource_id : R, (R = E[H]).label || R.text;
            ...
            L !== void 0 && S[L] === void 0 && (S[L] = { key: L, label: N }, L === I && (S[L].default = !0), S[L][$.group_text] = N, S[L][$.group_id] = L);
          }
          return (T = function(R) {
            var B = [];
            for (var H in R) R.hasOwnProperty(H) && B.push(R[H]);
            return B;
      ...
      }), c._groups.group_tasks(c, g, h, _, f), !0;
  ...
  t.config.multiselect = !0, t.config.multiselect_one_level = !1, t._multiselect = { _selected: {}, _one_level: !1, _active: !0, _first_selected_when_shift: null, getDefaultSelected: function() {
    ...
    var i = this.getSelected(), a = this.getFirstSelected(), r = !1, s = this.getLastSelected(), o = t.config.multiselect, l = (function() {
      ...
      if (d && d.getState) {
        const h = d.getState(), _ = d.locateCell(n.target);
      ...
      if (s) {
        if (e) {
          var d = t.getGlobalTaskIndex(this.getFirstSelected()), u = t.getGlobalTaskIndex(e), h = t.getGlobalTaskIndex(s);
          d != -1 && h != -1 || (d = u, this.reset());
          for (var _ = s; t.getGlobalTaskIndex(_) !== d; ) this.unselect(_, n), _ = d > h ? t.getNext(_) : t.getPrev(_);
          for (_ = e; t.getGlobalTaskIndex(_) !== d; ) this.select(_, n) && !r && (r = !0, a = _), _ = d > u ? t.getNext(_) : t.getPrev(_);
        }
      } else s = e;
    }).bind(this);
    return o && (n.ctrlKey || n.metaKey) ? (this.isSelected(e) || this.setFirstSelected(e), e && this.toggle(e, n)) : o && n.shiftKey ? (t.isTaskExists(this.getFirstSelected()) && this.getFirstSelected() !== null || this.setFirstSelected(e), i.length ? c() : l()) : l(), this.isSelected(e) ? this.setLastSelected(e) : a ? e == s && this.setLastSelected(n.shiftKey ? a : this.getDefaultSelected()) : this.setLastSelected(null), this.getSelected().length || this.setLastSelected(null), this.getLastSelected() && this.isSelected(this.getFirstSelected()) || this.setFirstSelected(this.getLastSelected()), !0;
  } }, function() {
    var n = t.selectTask;
  ...
  t.attachEvent("onBeforeGanttRender", function() {
    ...
    return l = l || t.uid(), n[l] = function(c, d) {
      var u = document.createElement("div");
      return u.setAttribute("data-overlay-id", c), u.className = "gantt_overlay", u.style.display = "none", { id: c, render: d, isVisible: !1, isAttached: !1, node: u };
    }(l, o), l;
  ...
  return t.ext = t.ext || {}, t.ext.export_api = t.ext.export_api || { _apiUrl: "https://export.dhtmlx.com/gantt", _preparePDFConfigRaw(n, e) {
    ...
    const o = t.templates;
    return i.$text = o.task_text(n.start, n.end_date, n), i.$left = o.leftside_text ? o.leftside_text(n.start, n.end_date, n) : "", i.$right = o.rightside_text ? o.rightside_text(n.start, n.end_date, n) : "", i;
  }, _copyObjectColors(n) {
      ...
      if (i) {
        ...
        for (let s = 0; s < e.data.length; s++) {
          ...
          for (let l = 0; l < r.length; l++) {
            const c = i(o, r[l]);
            c && e.data[s].styles.push({ index: l, styles: t.ext.export_api._getStyles(c) });
          }
        }
      }
    }
    ...
    for (let c = 0; c < o.length; c++) {
      if (r[o[c]]) continue;
      const d = e[o[c]], u = i[d._target];
      l[u.id] && t.ext.export_api._onCircDependencyFind(d, e, a, r), l[u.id] = !0, t.ext.export_api._clearCircDependencies(u, e, i, a, r, d);
    }
    a[n.id] = !1;
    ...
    const s = e.auto_scheduling !== void 0 && !!e.auto_scheduling, o = { callback: e.callback || null, config: t.config, data: n, manual: s, name: i, worktime: a };
    for (const l in e) o[l] = e[l];
    return o;
  }, _sendImportAjaxMSP(n) {
    const e = n.server || t.ext.export_api._apiUrl, i = n.store || 0, a = n.data, r = n.callback, s = { durationUnit: n.durationUnit || void 0, projectProperties: n.projectProperties || void 0, taskProperties: n.taskProperties || void 0 };
...
const $i = { KEY_CODES: { UP: 38, DOWN: 40, LEFT: 37, RIGHT: 39, SPACE: 32, ENTER: 13, DELETE: 46, ESC: 27, TAB: 9 } };
var kt = typeof window < "u";
const bt = { isIE: kt && (navigator.userAgent.indexOf("MSIE") >= 0 || navigator.userAgent.indexOf("Trident") >= 0), isOpera: kt && (navigator.userAgent.indexOf("Opera") >= 0 || navigator.userAgent.indexOf("OPR") >= 0), isChrome: kt && navigator.userAgent.indexOf("Chrome") >= 0, isSafari: kt && (navigator.userAgent.indexOf("Safari") >= 0 || navigator.userAgent.indexOf("Konqueror") >= 0), isFF: kt && navigator.userAgent.indexOf("Firefox") >= 0, isIPad: kt && navigator.userAgent.search(/iPad/gi) >= 0, isEdge: kt && navigator.userAgent.indexOf("Edge") != -1, isNode: !kt || typeof navigator > "u" || !1, isSalesforce: kt && (!!Y.Sfdc || !!Y.$A || Y.Aura) };
function sn(t) {
...
function Mt(t, n) {
  ...
  if (n.length === 1) return typeof n[0] == "string" ? (e.url = n[0], e.async = !0) : (e.url = n[0].url, e.async = n[0].async || !0, e.callback = n[0].callback, e.headers = n[0].headers), n[0].data ? typeof n[0].data != "string" ? e.data = sn(n[0].data) : e.data = n[0].data : e.data = "", e;
  switch (e.url = n[0], t) {
    case "GET":
    case "DELETE":
    ...
    case "POST":
    case "PUT":
      n[1] ? typeof n[1] != "string" ? e.data = sn(n[1]) : e.data = n[1] : e.data = "", e.callback = n[2], e.headers = n[3];
  }
  return e;
}
const on = { date_to_str: (t, n, e) => {
...
} }, ln = { date_to_str: (t, n, e) => (i) => t.replace(/%[a-zA-Z]/g, (a) => {
  switch (a) {
    case "%d":
...
function xi(t) {
  ...
  var i = { init: function() {
    ...
    var s = on;
    return e() && (s = ln), s.date_to_str(a, r, t);
  }, str_to_date: function(a, r) {
    var s = on;
    return e() && (s = ln), s.str_to_date(a, r, t);
...
class wi {
  ...
  connect() {
    ...
    n && (this._socket = null, n.onclose = function() {
      ...
      return l.onclose = () => setTimeout(() => e.connect(), 2e3), l.onmessage = (c) => {
        ...
        switch (d.action) {
          case "result":
            ...
            break;
          case "event":
            e.fire(d.body.name, d.body.value);
            break;
          case "start":
            r();
            break;
...
ot.prototype = { _attachDataChange: function(t) {
  ...
  O(this.pull[t], n, !0), this.isSilent() || (this.callEvent("onAfterUpdate", [n.id, n]), this.callEvent("onStoreUpdated", [n.id, n, "update"]));
  ...
  return G(t.id) || (t.id = ut()), this.$initItem && (t = this.$initItem(t)), !(!this.isSilent() && this.callEvent("onBeforeAdd", [t.id, t]) === !1) && (this._addItemInner(t, n), this.isSilent() || (this.callEvent("onAfterAdd", [t.id, t]), this.callEvent("onStoreUpdated", [t.id, t, "add"])), t.id);
  ...
  this.eachItem(function(a) {
    this.callEvent("onFilterItem", [a.id, a]) && (Gt(a.id, null, this, this._ganttConfig) ? e.push(a.id) : n.push(a.id));
  });
...
var Ue = function(t) {
  var n;
  ot.apply(this, [t]), this._branches = {}, this.pull = {}, this.$initItem = function(o) {
    var l = o;
    t.initItem && (l = t.initItem(l));
    var c = this.getItem(o.id);
    return c && !gt(c.parent, l.parent) && this.move(l.id, l.$index || -1, l.parent || this._ganttConfig.root_id), l;
  ...
  return this._attachDataChange(function() {
    ...
    this._indexRangeCache = {}, this._eachItemMainRangeCache = null, e = {}, i = {}, a = {}, r = {}, s = !1, this.eachItem(function(o) {
      ...
      o.$open && a[l] !== !1 ? a[o.id] = !0 : a[o.id] = !1, this._isSplitItem(o) && (s = !0, e[o.id] = !0, i[o.id] = !0), s && i[l] && (i[o.id] = !0), a[l] || a[l] === void 0 ? r[o.id] = !0 : r[o.id] = !1;
    });
  }), this.attachEvent("onFilterItem", function(o, l) {
    var c = !1;
    this._ganttConfig && (c = this._ganttConfig.open_split_tasks);
    var d = r[l.id];
    return s && (d && i[l.id] && !e[l.id] && (d = !!c), i[l.id] && !e[l.id] && (l.$split_subtask = !0)), l.$expanded_branch = !!r[l.id], !!d;
...
Ue.prototype = O({ _buildTree: function(t) {
  ...
  1 * i !== i && (i = void 0), ot.prototype._addItemInner.call(this, t, i), this.setParent(t, e), t.hasOwnProperty("$rendered_parent") && this._move_branch(t, t.$rendered_parent), this._add_branch(t, n);
}, _changeIdInner: function(t, n) {
  var e = this.getChildren(t), i = this._searchVisibleOrder[t];
  ot.prototype._changeIdInner.call(this, t, n);
  ...
  }), t && ot.prototype._updateOrder.call(this, t);
}, _removeItemInner: function(t) {
  var n = [];
  this.eachItem(function(i) {
    n.push(i);
  }, t), n.push(this.getItem(t));
  for (var e = 0; e < n.length; e++) this._move_branch(n[e], this.getParent(n[e]), null), ot.prototype._removeItemInner.call(this, n[e].id), this._move_branch(n[e], this.getParent(n[e]), null);
}, move: function(t, n, e) {
  ...
  if (!gt(t, e)) {
    ...
    if (n == -1 && (n = o.length + 1), gt(s, e) && this.getBranchIndex(t) == n) return;
    if (this.callEvent("onBeforeItemMove", [t, e, n]) === !1) return !1;
    for (var l = [], c = 0; c < o.length; c++) Gt(o[c], null, this, this._ganttConfig) && (l.push(o[c]), o.splice(c, 1), c--);
    this._replace_branch_child(s, t);
    var d = (o = this.getChildren(e))[n];
    (d = lt(d, a)) ? o = o.slice(0, n).concat([t]).concat(o.slice(n)) : o.push(t), l.length && (o = o.concat(l)), gt(r.$rendered_parent, s) || gt(s, e) || (r.$rendered_parent = s), this.setParent(r, e), this._branches[e] = o;
  ...
  for (var n = this.getSiblings(t), e = 0, i = n.length; e < i; e++) if (gt(n[e], t)) {
    var a = n[e + 1];
  ...
  this._branches = {}, ot.prototype.clearAll.call(this);
  ...
  this._eachItemMainRangeCache = null, this._replace_branch_child(n, t.id), this.exists(e) || gt(e, this.$getRootId()) ? this._add_branch(t, void 0, e) : delete this._branches[t.id], t.$level = this.calculateItemLevel(t), this.eachItem(function(i) {
  ...
  var i = typeof t == "string" ? function(l, c) {
    return l[t] == c[t] || at(l[t]) && at(c[t]) && l[t].valueOf() == c[t].valueOf() ? 0 : l[t] > c[t] ? 1 : -1;
  } : t;
  if (n) {
    var a = i;
    i = function(l, c) {
  ...
  return ot.prototype.filter.apply(this, arguments);
}, open: function(t) {
  ...
  ot.prototype.destructor.call(this), this._branches = null, this._indexRangeCache = {}, this._eachItemMainRangeCache = null;
} }, ot.prototype);
const Ci = function(t, n) {
  const e = n.getDatastore(t), i = function(o, l) {
    const c = l.getLayers(), d = e.getItem(o);
    if (d && e.isVisible(o)) for (let u = 0; u < c.length; u++) c[u].render_item(d);
  }, a = function(o) {
    const l = o.getLayers();
    ...
    for (let _ = 0; _ < l.length; _++) {
      ...
      if (f.get_visible_range) {
        ...
        if (u.start !== void 0 && u.end !== void 0) {
          var h = u.start + " - " + u.end;
          d[h] ? y = d[h] : (y = e.getIndexRange(u.start, u.end), d[h] = y);
        } else {
      ...
      } else c || (c = e.getVisibleItems()), y = c;
    ...
    if (o.update_items) {
      ...
      if (o.get_visible_range) {
        ...
        if (l.start !== void 0 && l.end !== void 0 && (c = e.getIndexRange(l.start, l.end)), l.ids !== void 0) {
  ...
  e.attachEvent("onStoreUpdated", function(o, l, c) {
    if (J(n)) return !0;
    ...
    s(n) || (o && c != "move" && c != "delete" ? (e.callEvent("onBeforeRefreshItem", [l.id]), e.callEvent("onAfterRefreshItem", [l.id])) : (e.callEvent("onBeforeRefreshAll", []), e.callEvent("onAfterRefreshAll", [])));
    ...
    if (e.callEvent("onBeforeIdChange", [o, l]), !s(n) && !e.isSilent()) {
      ...
      }(c.getLayers(), o, l, e.getItem(l)), i(l, c)) : n.render();
    }
  });
};
function fe() {
...
const Di = { create: function() {
  var t = O({}, { createDatastore: function(n) {
    var e = (n.type || "").toLowerCase() == "treedatastore" ? Ue : ot;
    if (n) {
      var i = this;
    ...
    for (var n = fe.call(this), e = 0; e < n.length; e++) n[e].silent(function() {
      n[e].clearAll();
    });
  ...
  return O(t, { getTask: function(n) {
    ...
    if (G(n.id) || (n.id = ut()), this.isTaskExists(n.id) && this.getTask(n.id).$index != n.$index) return n.start_date && typeof n.start_date == "string" && (n.start_date = this.date.parseDate(n.start_date, "parse_date")), n.end_date && typeof n.end_date == "string" && (n.end_date = this.date.parseDate(n.end_date, "parse_date")), this.$data.tasksStore.updateItem(n.id, n);
...
${o}`), a = s.subscales || [];
    ...
    for (var d = this.splitSize(s, i.length), u = r, h = [], _ = i.length - 1; _ >= 0; _--) {
      var f = _ == i.length - 1, y = this.initScaleConfig(i[_], o, l);
      f && this.processIgnores(y), this.initColSizes(y, a, u, d[_]), this.limitVisibleRange(y), f && (u = y.full_width), h.unshift(y);
    }
    ...
    if (t.config.skip_off_time) {
      for (var r = !0, s = i, o = 0; o < a.step; o++) o && (s = n.add(i, o, a.unit)), r = r && !this.isWorkTime(s, a.unit);
      return r;
    }
    return !1;
    ...
    for (var c = i.ignore_x || {}, d = 0; d < i.trace_x.length; d++) if (c[i.trace_x[d].valueOf()] || i.display_count == i.count) i.width[d] = 0;
      ...
      var u = 1;
      i.unit == "month" && (u = Math.round((n.add(i.trace_x[d], i.step, i.unit) - i.trace_x[d]) / 864e5)), i.width[d] = u;
    }
    this.adjustSize(o - this.getSum(i.width), i.width), i.full_width = this.getSum(i.width);
  }, initScaleConfig: function(i, a, r) {
    var s = O({ count: 0, col_width: 0, full_width: 0, height: 0, width: [], left: [], trace_x: [], trace_indexes: {}, min_date: new Date(a), max_date: new Date(r) }, i);
    ...
    for (var l = a.trace_x, c = i.trace_x, d = r || 0, u = s || c.length - 1, h = 0, _ = 1; _ < l.length; _++) {
      ...
      f !== void 0 && f <= u && (o && o.apply(this, [h, _, d, f]), d = f, h = _);
    }
    ...
    var d = new Date(l);
    for (+d >= +c && (c = n.add(d, a, i)); +d < +c; ) {
      o.call(this, new Date(d));
      var u = d.getTimezoneOffset();
      d = n.add(d, a, i), d = t._correct_dst_change(d, u, a, i), n[i + "_start"] && (d = n[i + "_start"](d));
    }
    ...
    var l = a.length - 1, c = a[l], d = n.add(c, i.step, i.unit);
...
function Ai(t) {
  var n = function(d) {
    var u = new zn(d).primaryScale(), h = u.unit, _ = u.step;
    if (d.config.scale_offset_minimal) {
      var f = new jn(d), y = [f.primaryScale()].concat(f.getSubScales());
      f.sortScales(y), h = y[y.length - 1].unit, _ = y[y.length - 1].step || 1;
    }
    return { unit: h, step: _ };
  }(t), e = n.unit, i = n.step, a = function(d, u) {
    ...
    if (u.config.start_date && u.config.end_date) {
      ...
      var _ = new Date(u.config.end_date), f = u.date[d + "_start"](new Date(_));
      _ = +_ != +f ? u.date.add(f, 1, d) : f, h.end_date = _;
    }
    return h;
  }(e, t);
  if (!a.start_date || !a.end_date) {
    ...
    a.start_date && a.end_date || (a = { start_date: /* @__PURE__ */ new Date(), end_date: /* @__PURE__ */ new Date() }), t.eachTask(function(d) {
      t.config.deadlines && d.deadline && pe(a, d.deadline, d.deadline), d.constraint_date && d.constraint_type && t.config.constraint_types && d.constraint_type !== t.config.constraint_types.ASAP && d.constraint_type !== t.config.constraint_types.ALAP && pe(a, d.constraint_date, d.constraint_date), t.config.baselines && d.baselines && d.baselines.forEach(function(u) {
        pe(a, u.start_date, u.end_date);
      });
...
class Mi {
  ...
  attach() {
    ...
    this._dataProcessorHandlers.push(e.attachEvent("onAfterTaskAdd", function(o, l) {
      ...
      const c = !a(o), d = e.config.cascade_delete && i[o];
      if (c || d) {
        if (d) {
        ...
        c && (n.storeItem(l), n.deleteAfterConfirmation || n.setUpdated(o, !0, "deleted")), n.updateMode === "off" || n._tSend || n.sendAllData();
      }
    ...
    this._dataProcessorHandlers.push(e.attachEvent("onTaskIdChange", function(o, l) {
      ...
      return !0;
    }), n.attachEvent("insertCallback", function(o, l, c, d) {
      const u = o.data || e.xml._xmlNodeToJSON(o.firstChild), h = { add: e.addTask, isExist: e.isTaskExists };
      d === "links" && (h.add = e.addLink, h.isExist = e.isLinkExists), h.isExist.call(e, l) || (u.id = l, h.add.call(e, u));
      ...
      for (const u in c) {
        ...
        switch (u) {
          ...
          case "end_date":
            ...
            break;
          case "duration":
            d.end_date = e.calculateEndDate({ start_date: d.start_date, duration: h, task: d });
        }
        d[u] = h;
      }
      e.updateTask(l), e.refreshData();
    }), n.attachEvent("deleteCallback", function(o, l, c, d) {
      const u = { delete: e.deleteTask, isExist: e.isTaskExists };
      d === "links" ? (u.delete = e.deleteLink, u.isExist = e.isLinkExists) : d === "assignment" && (u.delete = function(h) {
...
let ee = se, Fn = class {
  ...
  ignore(t, n) {
    this._silent_mode = !0, t.call(n || Y), this._silent_mode = !1;
  }
  setUpdated(t, n, e) {
  ...
  afterUpdate(t, n, e) {
    ...
    const c = s.xmltop("data", n.xmlDoc);
    if (!c) return this.cleanUpdate(e);
    const d = s.xpath("//data/action", c);
    if (!d.length) return this.cleanUpdate(e);
    for (let u = 0; u < d.length; u++) {
      const h = d[u], _ = h.getAttribute("type"), f = h.getAttribute("sid"), y = h.getAttribute("tid");
  ...
  _sendData(t, n) {
    ...
    if (this._tMode === "CUSTOM") {
      const l = this.getState(n), c = this.getActionByState(l);
      delete t[this.action_param];
      const d = this.getGanttMode(), u = (_) => {
        let f = l || "updated", y = n, v = n;
        _ && (f = _.action || l, y = _.sid || y, v = _.id || _.tid || v), this.afterUpdateCallback(y, v, f, _, d);
      };
      let h;
      if (this._router instanceof Function) if (this._routerParametersFormat === "object") {
        const _ = { entity: d, action: c, data: t, id: n };
        h = this._router(_);
      } else h = this._router(d, c, t, n);
      else if (this._router[d] instanceof Function) h = this._router[d](c, t, n);
      else {
...
See https://docs.dhtmlx.com/gantt/desktop__server_side.html#customrouting and https://docs.dhtmlx.com/gantt/api__gantt_createdataprocessor.html for details.`;
        if (!this._router[d]) throw new Error(`${_}: router for the **${d}** entity is not defined. ${f}`);
        switch (l) {
          case "inserted":
            if (!this._router[d].create) throw new Error(`${_}: **create** action for the **${d}** entity is not defined. ${f}`);
            h = this._router[d].create(t);
            break;
          case "deleted":
            if (!this._router[d].delete) throw new Error(`${_}: **delete** action for the **${d}** entity is not defined. ${f}`);
            h = this._router[d].delete(n);
            break;
          default:
            if (!this._router[d].update) throw new Error(`${_}: **update**" action for the **${d}** entity is not defined. ${f}`);
            h = this._router[d].update(t, n);
        }
      }
      if (h) {
...
function Ni(t) {
  ...
  return t.$services.getService("state").registerProvider("batchUpdate", function() {
    ...
    if (e) o(l);
      ...
      e = !1, c || this.render(), u && (this._dp.setUpdateMode(d), this._dp.setGanttMode("task"), this._dp.sendData(), this._dp.setGanttMode("link"), this._dp.sendData());
    }
  };
}
function Pi(t) {
...
function Hi(t) {
  ...
  function s(l, c, d) {
    ...
    return ht(c, function(f) {
      _[a(f)] = !0;
    }), n[h] ? u = n[h] : (u = n[h] = [], t.eachTask(function(f) {
      if (d) {
        if (!d[t.getTaskType(f)]) return;
      } else if (f.type == t.config.types.project) return;
      l in f && ht(Lt(f[l]) ? f[l] : [f[l]], function(y) {
  ...
  function o(l, c, d) {
    ...
    Array.isArray(h) || (h = [h]);
    for (var f = 0; f < h.length; f++) h[f].resource_id == l && d.push({ task_id: _.id, resource_id: h[f].resource_id, value: h[f].value });
  }
  return { getTaskBy: function(l, c, d) {
    return typeof l == "function" ? (u = l, h = [], t.eachTask(function(_) {
      u(_) && h.push(_);
    }), h) : Lt(c) ? s(l, c, d) : s(l, [c], d);
    var u, h;
    ...
    const r = { renderEditableLabel: function(s, o, l, c, d) {
      ...
      a.attachEvent("onGanttReady", function() {
        ...
        a.event(a.$container, "keypress", function(c) {
          ...
          c.key === "Tab" && (s = Ut(a.$container).indexOf(document.activeElement));
            ...
            if (d) {
              ...
              if (isNaN(h)) a.getDatastore(a.config.resource_store).refresh(_);
                ...
                if (a.plugins().undo && a.ext.undo.saveState(y, "task"), f) {
                  ...
                  if (w.start_date.valueOf() === b.valueOf() && w.end_date.valueOf() === g.valueOf()) w.value = h, h ? m.updateItem(w.id) : m.removeItem(w.id);
                  else {
                    if (w.end_date.valueOf() > g.valueOf()) {
                      var k = a.copy(w);
                      k.id = a.uid(), k.start_date = g, k.duration = a.calculateDuration({ start_date: k.start_date, end_date: k.end_date, task: p }), k.delay = a.calculateDuration({ start_date: p.start_date, end_date: k.start_date, task: p }), k.mode = w.mode || "default", k.duration !== 0 && m.addItem(k);
                    }
                    w.start_date.valueOf() < b.valueOf() ? (w.end_date = b, w.duration = a.calculateDuration({ start_date: w.start_date, end_date: w.end_date, task: p }), w.mode = "fixedDuration", w.duration === 0 ? m.removeItem(w.id) : m.updateItem(w.id)) : m.removeItem(w.id), h && m.addItem({ task_id: w.task_id, resource_id: w.resource_id, value: h, start_date: b, end_date: g, duration: a.calculateDuration({ start_date: b, end_date: g, task: p }), delay: a.calculateDuration({ start_date: p.start_date, end_date: b, task: p }), mode: "fixedDuration" });
                  }
                  a.updateTaskAssignments(p.id), a.updateTask(p.id), o();
                } else if (h) {
                  var w = { task_id: y, resource_id: v, value: h, start_date: b, end_date: g, duration: a.calculateDuration({ start_date: b, end_date: g, task: p }), delay: a.calculateDuration({ start_date: p.start_date, end_date: b, task: p }), mode: "fixedDuration" };
                  m.addItem(w), a.updateTaskAssignments(p.id), a.updateTask(p.id), o();
                }
              }
            }
          }
...
function Bi(t) {
  ...
  var e = "auto", i = "singleValue", a = "valueArray", r = "resourceValueArray", s = "assignmentsArray", o = e, l = "fixedDates", c = "fixedDuration", d = "default";
  function u(p, k) {
    ...
    var w = Number(p.delay), x = !1;
    if (isNaN(w) ? (p.delay = 0, x = !0) : p.delay = w, t.defined(p.value) || (p.value = null), !p.task_id || !p.resource_id) return !1;
    if (p.mode = p.mode || d, p.mode === c && (isNaN(Number(p.duration)) && (k = k || t.getTask(p.task_id), p.duration = t.calculateDuration({ start_date: p.start_date, end_date: p.end_date, id: k })), x && (k = k || t.getTask(p.task_id), p.delay = t.calculateDuration({ start_date: k.start_date, end_date: p.start_date, id: k }))), p.mode !== l && (k || t.isTaskExists(p.task_id))) {
  ...
  function _(p, k) {
    ...
    var w, x, $ = p.delay ? t.calculateEndDate({ start_date: k.start_date, duration: p.delay, task: k }) : new Date(k.start_date);
    return p.mode === c ? (w = t.calculateEndDate({ start_date: $, duration: p.duration, task: k }), x = p.duration) : (w = new Date(k.end_date), x = k.duration - p.delay), { start_date: $, end_date: w, duration: x };
  }
  function f(p) {
    ...
    if (t.defined(w) && w) {
      ...
      w.forEach(function(T) {
        T.resource_id || (T = { resource_id: T }, $ && (o = a, $ = !1)), $ && (T.id && T.resource_id ? (o = s, $ = !1) : (o = r, $ = !1));
        let E, C = d;
        T.mode || (T.start_date && T.end_date || T.start_date && T.duration) && (C = c), E = T.id || !T.$id || S[T.$id] ? T.id && !S[T.id] ? T.id : t.uid() : T.$id, S[E] = !0;
        const D = { id: E, start_date: T.start_date, duration: T.duration, end_date: T.end_date, delay: T.delay, task_id: p.id, resource_id: T.resource_id, value: T.value, mode: T.mode || C };
        Object.keys(T).forEach((A) => {
          A != "$id" && (D[A] = T[A]);
        }), D.start_date && D.start_date.getMonth && D.end_date && D.end_date.getMonth && typeof D.duration == "number" || u(D, p), x.push(D);
      });
    }
    return x;
  }
  ...
  function v(p, k) {
    k.sort(function(w, x) {
      ...
      return { $id: w.id, start_date: w.start_date, duration: w.duration, end_date: w.end_date, delay: w.delay, resource_id: w.resource_id, value: w.value, mode: w.mode };
    })), p[n] = k;
  }
  function b(p) {
    var k = f(p);
  ...
  function g(p, k) {
    var w = function(x, $) {
      ...
      if (o == i) {
        var T = x[0], E = T ? T.resource_id : null, C = !1;
        $.forEach(function(M) {
          M.resource_id != E ? S.inStoreNotInTask.push(M) : M.resource_id == E && (S.inBoth.push({ store: M, task: T }), C = !0);
        ...
        x.forEach(function(M) {
          ...
          if (!I[M.resource_id]) {
            I[M.resource_id] = !0;
            var L = D[M.resource_id], N = A[M.resource_id];
            L && N ? S.inBoth.push({ store: N, task: L }) : L && !N ? S.inTaskNotInStore.push(L) : !L && N && S.inStoreNotInTask.push(N);
          }
        });
      } else o != s && o != r || (D = {}, A = {}, I = {}, x.forEach(function(M) {
        D[M.id || M.$id] = M;
      }), $.forEach(function(M) {
        A[M.id] = M;
      }), x.concat($).forEach(function(M) {
        ...
        if (!I[L]) {
          I[L] = !0;
          var N = D[L], P = A[L];
          N && P ? S.inBoth.push({ store: P, task: N }) : N && !P ? S.inTaskNotInStore.push(N) : !N && P && S.inStoreNotInTask.push(P);
        }
      }));
      return S;
    }(f(p), k);
    w.inStoreNotInTask.forEach(function(x) {
      ...
      if (function(S, T) {
        ...
        return !1;
      }(x.task, x.store)) (function(S, T) {
        var E = { id: !0 };
        for (var C in S) E[C] || (T[C] = S[C]);
      })(x.task, x.store), h.updateItem(x.store.id);
      else if (x.task.start_date && x.task.end_date && x.task.mode !== l) {
        var $ = _(x.store, p);
        x.store.start_date.valueOf() == $.start_date.valueOf() && x.store.end_date.valueOf() == $.end_date.valueOf() || (x.store.start_date = $.start_date, x.store.end_date = $.end_date, x.store.duration = $.duration, h.updateItem(x.store.id));
      }
    }), y(p.id);
  }
  function m(p) {
    ...
    if (t.config.process_resource_assignments) {
      ...
      t.attachEvent("onBeforeBatchUpdate", function() {
        ...
        if (k) {
          ...
          for (var C in t.config.process_resource_assignments && o === "resourceValueArray" && (T = null), w) g(w[C], E[C]);
        }
        k = !1, p = !1, w = {};
      ...
      h.attachEvent("onStoreUpdated", function() {
        ...
        return $ === null && ($ = {}, S = {}, h.eachItem(function(A) {
        ...
        const C = t.getDatastore("resource"), D = t.getTaskAssignments(E), A = {};
...
function zi(t) {
  ...
  t.config.types.placeholder = "placeholder", t.attachEvent("onDataProcessorReady", n(function(o) {
    o && !o._silencedPlaceholder && (o._silencedPlaceholder = !0, o.attachEvent("onBeforeUpdate", n(function(l, c, d) {
...
function ji(t) {
  ...
  })), t.attachEvent("onAfterTaskAdd", n(function(d) {
    l && i(d);
  })), t.attachEvent("onAfterTaskUpdate", n(function(d) {
    l && i(d);
  })), t.attachEvent("onBeforeTaskDelete", n(function(d, u) {
    return a = t.getParent(d), !0;
  })), t.attachEvent("onAfterTaskDelete", n(function(d, u) {
    c(a);
  })), t.attachEvent("onRowDragStart", n(function(d, u, h) {
    return s = t.getParent(d), !0;
  })), t.attachEvent("onRowDragEnd", n(function(d, u) {
    c(s), i(d);
  })), t.attachEvent("onBeforeTaskMove", n(function(d, u, h) {
    return o = t.getParent(d), !0;
  })), t.attachEvent("onAfterTaskMove", n(function(d, u, h) {
  ...
  constructor(n = null) {
    this.canParse = (e) => {
      ...
      for (let d = 0; d < o.length; d++) {
        const u = o[d], h = this._getValueFromMinutes(s, u, d === c);
        s -= this._getValueInMinutes(h, u), l += `${this._getLabelForConvert(h, u, r)}${d === c ? "" : " "}`;
      }
      return l;
    }, this.parse = (e) => {
      if (this.canParse(e)) {
        ...
        for (let c = 0; c < e.length; c++) {
          const d = e[c];
          l.test(d) ? r = a : a = !0, (r || o === c) && (r || (i += d), s += this._getNumericValue(i), a = r = !1, i = ""), i += d;
        }
        if (s) {
          const c = this._config.store;
          return Math.round(this.transferUnits[c].fromMinutes(Math.ceil(s)));
        }
      }
      return null;
...
ce.create = (n = null, e) => new ce(n, e);
let Ne = ce;
function Fi(t) {
  t.ext.formatters = { durationFormatter: function(n) {
    return n || (n = {}), n.store || (n.store = t.config.duration_unit), n.enter || (n.enter = t.config.duration_unit), Ie.create(n, t);
...
const Ge = function(t, n) {
  ...
  let l = o.maxHeight, c = e.height, d = c > i, u = e.rowHeight >= i && !o.splitChild && !s;
  (d || u) && (c = i), l < c && (c = l);
  let h = Math.floor((e.rowHeight - c) / 2);
  if (o.splitChild && (h = Math.floor((l - c) / 2)), r || s) {
    let _ = Math.min(e.height, l) - c, f = 2, y = s && a.bar_height >= a.row_height, v = o.splitChild && e.height >= l;
    (y || v) && (f = 0), h = Math.floor(_ / 2) + f, e.rowHeight;
  }
  return { height: c, marginTop: h };
};
function Vi(t) {
    ...
    t.config.baselines && (t.attachEvent("onParse", function() {
      n.eachItem(function(a) {
        ...
        if (t.isTaskExists(r)) {
          ...
          o && s.baselines.push(a), J(t) || (pt(s) ? e(s) : t.adjustTaskHeightForBaselines(s));
        }
      });
      ...
      return function(s) {
        ...
        }), o && (pt(s) ? e(s) : t.adjustTaskHeightForBaselines(s), t.render());
      }(r), !0;
      ...
      if (Ge && r.parent && t.isTaskExists(r.parent)) {
...
function Vn(t) {
  ...
  return { _resetTopPositionHeight: function() {
    ...
    for (var c = l.getIndexRange(), d = 0, u = 0, h = 0; h < c.length; h++) e[h] = d, d += this.getItemHeight(c[h].id), h < o && (u = d);
    return u;
    ...
    if (this.$config.rowStore) {
      ...
      return n[o] = this.getRowTop(c), n[o];
    }
    return 0;
...
class Gi {
  ...
  init() {
    ...
    this._dnd = new n(this.$grid.$grid_scale, { updates_per_second: 60 }), this._scrollableGrid = new Ui({ gantt: this.$gantt, grid: this.$grid, dnd: this._dnd, getCurrentX: this.calculateCurrentPosition }), this.attachEvents();
  }
  attachEvents() {
  ...
  findColumnsIndexes() {
    ...
    let l, c = 0, d = e.length - 1, u = (f, y) => f <= y, h = (f) => ++f;
    this.$gantt.config.rtl && (c = e.length - 1, d = 0, u = (f, y) => f >= y, h = (f) => --f);
    const _ = this._dragX - this.$grid.$grid.getBoundingClientRect().left + this._scrollableGrid.getCorrection();
    for (let f = c; u(f, d) && (i === void 0 || a === void 0); f = h(f)) e[f].hide || (o.startX = o.endX, o.endX += e[f].width, _ >= o.startX && (_ <= o.endX || !u(h(f), d)) && (i = f, r = o.startX, s = o.endX, l = (_ - o.startX) / (o.endX - o.startX)), n === e[f].name && (a = f));
...
var ue = function(t, n, e, i) {
  this.$config = O({}, n || {}), this.$gantt = i, this.$parent = t, _t(this), this.$state = {}, O(this, Vn(this));
};
function qi(t) {
  function n(e) {
...
ue.prototype = { init: function(t) {
  ...
  var l = function(d, u) {
    var h = { column_before_start: d.bind(function(_, f, y) {
      var v = u.$getConfig(), b = tt(y, v.grid_resizer_column_attribute);
      if (!b || !dt(b, ".gantt_grid_column_resize_wrap")) return !1;
      var g = this.locate(y, v.grid_resizer_column_attribute), m = u.getGridColumns()[g];
      return u.callEvent("onColumnResizeStart", [g, m]) !== !1 && void 0;
    }, d), column_after_start: d.bind(function(_, f, y) {
      var v = u.$getConfig(), b = this.locate(y, v.grid_resizer_column_attribute);
      _.config.marker.innerHTML = "", _.config.marker.className += " gantt_grid_resize_area", _.config.marker.style.height = u.$grid.offsetHeight + "px", _.config.marker.style.top = "0px", _.config.drag_index = b;
    }, d), column_drag_move: d.bind(function(_, f, y) {
      var v = u.$getConfig(), b = _.config, g = u.getGridColumns(), m = parseInt(b.drag_index, 10), p = g[m], k = K(u.$grid_scale), w = parseInt(b.marker.style.left, 10), x = p.min_width ? p.min_width : v.min_grid_column_width, $ = u.$grid_data.offsetWidth, S = 0, T = 0;
      ...
      if (w < x && (w = x), v.keep_grid_width) {
        ...
        C && (x = u.$grid_data.offsetWidth - C), w < x && (w = x), w > $ && (w = $);
      } else if (!u.$config.scrollable) {
        var D = w, A = d.$container.offsetWidth, I = 0;
        if (u.$grid_data.offsetWidth <= A - 25) for (E = m + 1; E < g.length; E++) I += g[E].width;
        else {
      ...
      return b.left = w - 1, T = Math.abs(w - S), p.max_width && T > p.max_width && (T = p.max_width), v.rtl && (S = k.width - S + 2 - T), b.marker.style.top = k.y + "px", b.marker.style.left = k.x - 1 + S + "px", b.marker.style.width = T + "px", u.callEvent("onColumnResize", [m, g[m], T - 1]), !0;
    }, d), column_drag_end: d.bind(function(_, f, y) {
      for (var v = u.$getConfig(), b = u.getGridColumns(), g = 0, m = parseInt(_.config.drag_index, 10), p = b[m], k = 0; k < m; k++) g += b[k].width;
      var w = p.min_width && _.config.left - g < p.min_width ? p.min_width : _.config.left - g;
      if (p.max_width && p.max_width < w && (w = p.max_width), u.callEvent("onColumnResizeEnd", [m, p, w]) !== !1 && p.width != w) {
        if (p.width = w, v.keep_grid_width) g = v.grid_width;
        else {
          k = m;
          for (var x = b.length; k < x; k++) g += b[k].width;
        }
        u.callEvent("onColumnResizeComplete", [b, u._setColumnsWidth(g, m)]), u.$config.scrollable || d.$layout._syncCellSizes(u.$config.group, { value: v.grid_width, isGravity: !1 }), this.render();
      }
    }, d) };
    return { init: function() {
      var _ = d.$services.getService("dnd"), f = u.$getConfig(), y = new _(u.$grid_scale, { updates_per_second: 60 });
      d.defined(f.dnd_sensitivity) && (y.config.sensitivity = f.dnd_sensitivity), y.attachEvent("onBeforeDragStart", function(v, b) {
      ...
      for (var _ = u.getGridColumns(), f = u.$getConfig(), y = 0, v = u.$config.width, b = f.scale_height, g = 0; g < _.length; g++) {
        var m, p = _[g];
        if (y += p.width, m = f.rtl ? v - y : y, p.resize && g != _.length - 1) {
          var k = document.createElement("div");
          k.className = "gantt_grid_column_resize_wrap", k.style.top = "0px", k.style.height = b + "px", k.innerHTML = "<div class='gantt_grid_column_resize'></div>", k.setAttribute(f.grid_resizer_column_attribute, g), k.setAttribute("column_index", g), d._waiAria.gridSeparatorAttr(k), u.$grid_scale.appendChild(k), k.style.left = Math.max(0, m) + "px";
        }
      }
    } };
  }(n, this);
  ...
  var c = function(d, u) {
    var h = { row_before_start: d.bind(function(_, f, y) {
      var v = u.$getConfig(), b = u.$config.rowStore;
      if (!tt(y, v.task_grid_row_resizer_attribute)) return !1;
      var g = this.locate(y, v.task_grid_row_resizer_attribute), m = b.getItem(g);
      return u.callEvent("onBeforeRowResize", [m]) !== !1 && void 0;
    }, d), row_after_start: d.bind(function(_, f, y) {
    ...
    }, d), row_drag_move: d.bind(function(_, f, y) {
      var v = u.$config.rowStore, b = u.$getConfig(), g = _.config, m = g.drag_id, p = u.getItemHeight(m), k = u.getItemTop(m) - f.scrollTop, w = K(u.$grid_data), x = parseInt(g.marker.style.top, 10), $ = k + w.y, S = 0, T = b.min_task_grid_row_height;
      return (S = x - $) < T && (S = T), g.marker.style.left = w.x + "px", g.marker.style.top = $ - 1 + "px", g.marker.style.height = Math.abs(S) + 1 + "px", g.marker_height = S, u.callEvent("onRowResize", [m, v.getItem(m), S + p]), !0;
    }, d), row_drag_end: d.bind(function(_, f, y) {
      var v = u.$config.rowStore, b = _.config, g = b.drag_id, m = v.getItem(g), p = u.getItemHeight(g), k = b.marker_height;
      u.callEvent("onBeforeRowResizeEnd", [g, m, k]) !== !1 && m.row_height != k && (m.row_height = k, v.updateItem(g), u.callEvent("onAfterRowResize", [g, m, p, k]), this.render());
    }, d) };
    return { init: function() {
      var _ = d.$services.getService("dnd"), f = u.$getConfig(), y = new _(u.$grid_data, { updates_per_second: 60 });
      d.defined(f.dnd_sensitivity) && (y.config.sensitivity = f.dnd_sensitivity), y.attachEvent("onBeforeDragStart", function(v, b) {
  ...
  c.init(), this._addLayers(this.$gantt), this._initEvents(), r && (this._columnDND = new Gi(n, this), this._columnDND.init()), this.callEvent("onReady", []);
  ...
  for (var e, i = this.getGridColumns(), a = 0, r = (c = this.$getConfig()).grid_elastic_columns, s = 0, o = i.length; s < o; s++) this._validateColumnWidth(i[s], "min_width"), this._validateColumnWidth(i[s], "max_width"), this._validateColumnWidth(i[s], "width"), a += 1 * i[s].width;
  ...
  e !== t && (e !== void 0 ? (c.grid_width = e, this.$config.width = e - 1) : isNaN(a) || (this._setColumnsWidth(a), c.grid_width = a, this.$config.width = a - 1));
  ...
  var l = r - a, c = 0;
  for (s = 0; s < n + 1; s++) c += i[s].width;
  for (a -= c, s = n + 1; s < i.length; s++) {
    var d = i[s], u = Math.round(l * (d.width / a));
    l < 0 ? d.min_width && d.width + u < d.min_width ? u = d.min_width - d.width : !d.min_width && e.min_grid_column_width && d.width + u < e.min_grid_column_width && (u = e.min_grid_column_width - d.width) : d.max_width && d.width + u > d.max_width && (u = d.max_width - d.width), a -= d.width, d.width += u, l -= u;
  }
  ...
  if (t.autofit || i.length) {
    ...
    if (t.autofit && !t.grid_elastic_columns) for (r = 0; r < a.length; r++) {
      ...
      a[r] += c, (d = this._getColumnWidth(n[r], t, a[r])) != a[r] && (c = d - a[r], a[r] = d), l -= c;
    }
    else if (i.length) for (r = 0; r < i.length; r++) {
      c = Math.round(l / (i.length - r));
      var d, u = i[r];
      a[u] += c, (d = this._getColumnWidth(n[u], t, a[u])) != a[u] && (c = d - a[u], a[u] = d), l -= c;
    }
  ...
  for (var d = 0; d < a.length; d++) {
    ...
    var y = t._sort && h.name == t._sort.name ? `<div data-column-id="${h.name}" class="gantt_sort gantt_${t._sort.direction}"></div>` : "", v = ["gantt_grid_head_cell", "gantt_grid_head_" + h.name, u ? "gantt_last_cell" : "", i.grid_header_class(h.name, h)].join(" "), b = "width:" + (_ - (u ? 1 : 0)) + "px;", g = h.label || o["column_" + h.name] || o[h.name];
    typeof g == "function" && (g = g.call(t, h.name, h)), g = g || "";
    let p = !1;
    t.config.external_render && t.config.external_render.isElement(g) && (p = !0, c[h.name] = g);
    var m = "<div class='" + v + "' style='" + b + "' " + t._waiAria.gridScaleCellAttrString(h, g) + " data-column-id='" + h.name + "' column_id='" + h.name + "' data-column-name='" + h.name + "' data-column-index='" + d + "'>" + (p ? "<div data-component-container></div>" : g) + y + "</div>";
    r.push(m);
  }
  this.$grid_scale.style.height = n.scale_height + "px", this.$grid_scale.style.lineHeight = l + "px", this.$grid_scale.innerHTML = r.join("");
  for (let p in c) t.config.external_render.renderElement(c[p], this.$grid_scale.querySelector("[data-column-id='" + p + "'] [data-component-container]"));
...
var Un = function(t) {
  return { getWorkHoursArguments: function() {
    var n = arguments[0];
    if (!Et((n = at(n) ? { date: n } : O({}, n)).date)) throw t.assert(!1, "Invalid date argument for getWorkHours method"), new Error("Invalid date argument for getWorkHours method");
    return n;
    ...
    if ((n = e.date ? new me(e.date, e.unit, e.task, null, e.calendar) : new me(arguments[0], arguments[1], arguments[2], null, arguments[3])).unit = n.unit || t.config.duration_unit, !Et(n.date)) throw t.assert(!1, "Invalid date argument for isWorkTime method"), new Error("Invalid date argument for isWorkTime method");
    return n;
  }, getClosestWorkTimeArguments: function(n) {
    var e, i = arguments[0];
    if (i instanceof ve) return i;
    if (e = at(i) ? new ve(i) : new ve(i.date, i.dir, i.unit, i.task, null, i.calendar), i.id && (e.task = i), e.dir = i.dir || "any", e.unit = i.unit || t.config.duration_unit, !Et(e.date)) throw t.assert(!1, "Invalid date argument for getClosestWorkTime method"), new Error("Invalid date argument for getClosestWorkTime method");
    return e;
  }, _getStartEndConfig: function(n) {
    var e, i = Yi;
    if (n instanceof i) return n;
    if (at(n) ? e = new i(arguments[0], arguments[1], arguments[2], arguments[3]) : (e = new i(n.start_date, n.end_date, n.task), n.id !== null && n.id !== void 0 && (e.task = n)), e.unit = e.unit || t.config.duration_unit, e.step = e.step || t.config.duration_step, e.start_date = e.start_date || e.start || e.date, !Et(e.start_date)) throw t.assert(!1, "Invalid start_date argument for getDuration method"), new Error("Invalid start_date argument for getDuration method");
    if (!Et(e.end_date)) throw t.assert(!1, "Invalid end_date argument for getDuration method"), new Error("Invalid end_date argument for getDuration method");
    return e;
    ...
    if (r = at(s) ? new ke(arguments[0], arguments[1], arguments[2], void 0, arguments[3], void 0, arguments[4]) : new ke(s.start_date, s.duration, s.unit, s.step, s.task, null, s.calendar), s.id !== null && s.id !== void 0 && (r.task = s, r.unit = null, r.step = null), r.unit = r.unit || t.config.duration_unit, r.step = r.step || t.config.duration_step, !Et(r.start_date)) throw t.assert(!1, "Invalid start_date argument for calculateEndDate method"), new Error("Invalid start_date argument for calculateEndDate method");
    return r;
  } };
};
function Gn() {
...
Gn.prototype = { _getIntervals: function(t) {
  ...
  const e = X(t.getConfig()), i = X(n.getConfig()), a = e.parsed, r = i.parsed;
    ...
    for (let u in c.dates) {
      ...
      for (const _ in d.dates) {
        ...
        if (_ == u && (s.dates[u] = !(!h || !f)), Array.isArray(h)) {
          const y = Array.isArray(f) ? f : d.hours;
...
class Zi {
  ...
  getEndDate(n, e, i, a, r) {
    ...
    if (s.endDates[l] === void 0) {
      ...
      s.endDates[l] = u, s.durations[this._durationCacheKey(o, u)] = e, c = d;
    } else c = new Date(s.endDates[l]);
    return c;
  }
  getDuration(n, e, i, a, r) {
    const s = this._getCacheObject(n, i, a), o = n.valueOf(), l = e.valueOf(), c = this._durationCacheKey(o, l);
    let d;
...
function Pe(t, n) {
  this.argumentsHelper = n, this.$gantt = t, this._workingUnitsCache = typeof Map < "u" ? new Ji() : new Ki(), this._largeUnitsCache = new Xi(this), this._dateDurationCache = new Zi(), this._worktime = null, this._cached_timestamps = {}, this._cached_timestamps_count = 0;
}
Pe.prototype = { units: ["year", "month", "week", "day", "hour", "minute"], _clearCaches: function() {
  ...
  for (var _ = !1; r.valueOf() < s.valueOf(); ) {
    if (_ = (d = this._nextDate(r, e, i)).valueOf() > s.valueOf(), this._isWorkTime(r, e)) (u || h && _) && (o = a[e + "_start"](new Date(r)), l = a.add(o, i, e)), u ? (u = !1, d = this._nextDate(o, e, i), c += (l.valueOf() - r.valueOf()) / (l.valueOf() - o.valueOf())) : h && _ ? (h = !1, c += (s.valueOf() - r.valueOf()) / (l.valueOf() - o.valueOf())) : c++;
    else {
  ...
  for (a = z(e == "minute" ? this._getMinutesPerDay : this.getHoursPerDay, this); s.valueOf() < o.valueOf(); ) if (o - s > 27648e5 && s.getDate() === 0) {
  ...
  return d + this._getWorkUnitsForRange(o, l, e, i) + u;
}, _getHoursBetween: function(t, n, e, i) {
  var a = new Date(t), r = new Date(n);
  i = i || 1;
  var s = new Date(a), o = this.$gantt.date.add(this.$gantt.date.day_start(new Date(a)), 1, "day");
  if (r.valueOf() <= o.valueOf()) return Math.round(this._getMinutesBetweenSingleDay(t, n) / 60);
  var l = this.$gantt.date.day_start(new Date(r)), c = r, d = this._getMinutesBetweenSingleDay(s, o, e, i) / 60, u = this._getMinutesBetweenSingleDay(l, c, e, i) / 60, h = d + this._getWorkUnitsForRange(o, l, e, i) + u;
  return Math.round(h);
}, getConfig: function() {
  ...
  if (Array.isArray(t)) {
    ...
    t.forEach(function(o) {
      typeof o == "number" ? n.push(60 * o * 60) : typeof o == "string" && o.split("-").map(function(l) {
        ...
        c[1] && (d += parseInt(60 * c[1])), c[2] && (d += parseInt(c[2])), n.push(d);
      });
    });
  ...
  for (var r = 0, s = t, o = !1; r < n && (!a || !a(s)); ) {
    ...
    i > 0 && (c = new Date(l.valueOf() - 1)), this._isWorkTime(c, e) && !o && r++, s = l;
  }
  ...
  for (var o = 0, l = [], c = 0; a < n; ) {
    ...
    if (l.length && c) if (l[l.length - 1].end <= f && _ > c) a += c, i = this.$gantt.date.add(i, -1, "day");
    else {
      for (var y = !1, v = null, b = null, g = l.length - 1; g >= 0; g--) if (l[g].start < f - 1 && l[g].end >= f - 1) {
        y = !0, v = l[g], b = l[g - 1];
        break;
      }
      if (y) if (f === v.end && _ >= v.durationMinutes) a += v.durationMinutes, i = this.$gantt.date.add(i, -v.durationMinutes, "minute");
        ...
        m <= _ ? (a += m, i = this._nextDate(i, "hour", e)) : (s = this._subtractMinutesUntilHourStart(i, _), a += s.added, i = s.end);
      }
  ...
  a += r.added, i = r.end;
  for (var s = 0, o = [], l = 0, c = this._isMinutePrecision(i); a < n; ) {
    ...
    if (o.length && l) if (o[0].start >= h && u >= l) {
      ...
      for (var _ = !1, f = null, y = 0; y < o.length; y++) if (o[y].start <= h && o[y].end > h) {
        _ = !0, f = o[y];
        break;
      }
      if (_) if (h === f.start && u >= f.durationMinutes) a += f.durationMinutes, i = this.$gantt.date.add(i, f.durationMinutes, "minute");
        ...
        v <= u ? (a += v, i = c ? this.$gantt.date.add(i, v, "minute") : this._nextDate(i, "hour", e)) : (a += (r = this._addMinutesUntilHourEnd(i, u)).added, i = r.end);
      }
...
const zt = { isLegacyResourceCalendarFormat: function(t) {
  ...
  return null;
} }, Qi = (Kt = {}, { getCalendarIdFromMultipleResources: function(t, n) {
  var e = function(a) {
...
function Yn(t) {
  this.$gantt = t.$gantt, this.argumentsHelper = Un(this.$gantt), this.calendarManager = t, this.$disabledCalendar = new Re(this.$gantt, this.argumentsHelper);
}
qn.prototype = { _calendars: {}, _convertWorkTimeSettings: function(t) {
  ...
  var n = new Pe(this.$gantt, Un(this.$gantt));
  n.id = String(ut());
  ...
  var n;
  return t || (t = {}), O(n = t.getConfig ? X(t.getConfig()) : t.worktime ? X(t.worktime) : X(t), X(this.defaults.fulltime.worktime)), this._createCalendarFromConfig(n);
  ...
  if (n.resource_calendars) {
    var e;
    if (e = this._legacyConfig === !1 ? n.resource_property : zt.getResourceProperty(n), Array.isArray(t[e]) && t[e].length) n.dynamic_resource_calendars ? i = Qi.getCalendarIdFromMultipleResources(t[e], this) : a = this.getResourceCalendar(t[e]);
...
} }, Re.prototype = { getWorkHours: function() {
  return [0, 24];
...
const ta = function(t, n) {
  ...
  }, mergeCalendars: z(t.mergeCalendars, t), createCalendar: z(t.createCalendar, t), addCalendar: z(t.addCalendar, t), getCalendar: z(t.getCalendar, t), getCalendars: z(t.getCalendars, t), getResourceCalendar: z(t.getResourceCalendar, t), getTaskCalendar: z(t.getTaskCalendar, t), deleteCalendar: z(t.deleteCalendar, t) };
};
function ea(t) {
  ...
  function a(s, o, l, c) {
    ...
    let h;
    h = s.type === t.config.types.project && s.auto_scheduling === !1 ? u : d, o.$no_start && (s[h.start] = l ? new Date(l) : n(s, this.getParent(s))), o.$no_end && (s[h.end] = c ? new Date(c) : this.calculateEndDate({ start_date: s[h.start], duration: this.config.duration_step, task: s })), (o.$no_start || o.$no_end) && this._init_task_timing(s);
  }
  function r(s) {
  ...
  t._init_task_timing = function(s) {
    var o = e(s, !0), l = s.$rendered_type != o.type, c = o.type;
    ...
    if (s) {
      ...
      c.rollup && (l = !0);
      var d = this.getParent(c), u = e(c), h = !0;
      if (l || c.start_date && c.end_date && (u.$no_start || u.$no_end)) {
        const y = c.$auto_start_date ? "$auto_start_date" : "start_date", v = c.$auto_end_date ? "$auto_end_date" : "end_date";
        var _ = c[y].valueOf(), f = c[v].valueOf();
        t.resetProjectDates(c), l || _ != c[y].valueOf() || f != c[v].valueOf() || (h = !1), h && !o && this.refreshTask(c.id, !0), u.scheduled_summary && (h = !0);
      }
...
function na(t) {
  ...
  var i = (function() {
    ...
    J(t) || (this.$root.innerHTML = "", this.$root.gantt = this, Ae(this), this.config.layout.id = "main", this.$layout = this.$ui.createView("layout", this.$root, this.config.layout), this.$layout.attachEvent("onBeforeResize", function() {
      ...
      s.className = "gantt_container_resize_watcher", s.tabIndex = -1, r.config.wai_aria_attributes && (s.setAttribute("role", "none"), s.setAttribute("aria-hidden", !0)), r.env.isSalesforce && (r.config.container_resize_method = "timeout"), r.$root.appendChild(s), s.contentWindow ? gn(r, s.contentWindow) : (r.$root.removeChild(s), gn(r, window));
    }(this));
  }).bind(t);
...
function Ha(t) {
  ...
  n.plugins = function(l) {
    ...
    return { cache: !0, method: "get", parse: function(c) {
      ...
      if (d.nodeName || (d = d.responseXML || d), bt.isIE) return d.selectNodes(c) || [];
    ...
    }, _call: function(c, d, u, h, _, f) {
      return new l.Promise(function(y, v) {
        var b = typeof XMLHttpRequest !== void 0 ? new XMLHttpRequest() : new Y.ActiveXObject("Microsoft.XMLHTTP"), g = navigator.userAgent.match(/AppleWebKit/) !== null && navigator.userAgent.match(/Qt/) !== null && navigator.userAgent.match(/Safari/) !== null;
        h && (b.onreadystatechange = function() {
          if (b.readyState == 4 || g && b.readyState == 3) {
            ...
            setTimeout(function() {
              typeof _ == "function" && _.apply(Y, [{ xmlDoc: b, filePath: d }]), y(b), typeof _ == "function" && (_ = null, b = null);
            }, 0);
          }
        });
        var m = !this || !this.cache;
        if (c == "GET" && m && (d += (d.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (/* @__PURE__ */ new Date()).getTime() + "=1"), b.open(c, d, h), f) for (var p in f) b.setRequestHeader(p, f[p]);
  ...
  }(n), n.date = xi(n), n.RemoteEvents = Si;
  var a = function(l) {
    function c(u) {
    ...
    function d(u, h) {
      this._obj = u, this._settings = h || {}, _t(this);
      var _ = this.getInputMethods();
      this._drag_start_timer = null, l.attachEvent("onGanttScroll", z(function(v, b) {
        this.clearDragTimer();
      }, this));
      for (var f = { passive: !1 }, y = 0; y < _.length; y++) z(function(v) {
        l.event(u, v.down, z(function(g) {
          v.accessor(g) && (g.button !== void 0 && g.button !== 0 || (h.preventDefault && h.selector && dt(g.target, h.selector) && g.preventDefault(), l.config.touch && g.timeStamp && g.timeStamp - 0 < 300 || (this._settings.original_target = c(g), this._settings.original_element_sizes = { ...ct(g, Mn(u)), width: g.target.offsetWidth, height: g.target.offsetHeight }, l.config.touch ? (this.clearDragTimer(), this._drag_start_timer = setTimeout(z(function() {
    ...
    return d.prototype = { traceDragEvents: function(u, h) {
      ...
      var f = z(function(m) {
        if (!this.config.started || !G(this.config.updates_per_second) || Bn(this, this.config.updates_per_second)) {
          var p = _(m);
          if (p) try {
      ...
      }, this), y = Dt(l.$root), v = this.config.mousemoveContainer || Dt(l.$root), b = { passive: !1 }, g = z(function(m) {
        return l.eventRemove(v, h.move, f), l.eventRemove(y, h.up, g, b), this.dragEnd(u);
      }, this);
      ...
      if (l.config.touch) {
        var _ = h(u), f = _.target || _.srcElement, y = f.cloneNode(!0);
        this.config.original_target = c(_), this.config.original_target.target = y, this.config.backup_element = f, f.parentNode.appendChild(y), f.style.display = "none", (this.config.mousemoveContainer || document.body).appendChild(f);
      }
      ...
      if (u.push({ move: "mousemove", down: "mousedown", up: "mouseup", accessor: function(_) {
        ...
        } }) : Y.navigator.pointerEnabled ? u.push({ move: "pointermove", down: "pointerdown", up: "pointerup", accessor: function(_) {
          return _.pointerType == "mouse" ? null : _;
        } }) : Y.navigator.msPointerEnabled && u.push({ move: "MSPointerMove", down: "MSPointerDown", up: "MSPointerUp", accessor: function(_) {
  ...
  var r = /* @__PURE__ */ function(l) {
    ...
    function d(u, h, _) {
      ...
      l.config[u] && c[_] != f[u] && (h && y[_] || (y[_] = l.date.date_to_str(f[u]), c[_] = f[u]));
    }
    return { initTemplates: function() {
      ...
      d("date_scale", !0, void 0, l.config, l.templates), d("date_grid", !0, "grid_date_format", l.config, l.templates), d("task_date", !0, void 0, l.config, l.templates), l.mixin(l.templates, { xml_format: void 0, format_date: f, xml_date: void 0, parse_date: y, progress_text: function(v, b, g) {
        return "";
        ...
        var b = l.getTask(v.source), g = l.getTask(v.target);
        ...
        return g && (k += "<b> " + (g = l.getTask(g)).text + "</b> " + (m ? p.link_start : p.link_end) + "<br/>"), k;
      }, drag_link_class: function(v, b, g, m) {
        var p = "";
        return v && g && (p = " " + (l.isLinkAllowed(v, g, b, m) ? "gantt_link_allow" : "gantt_link_deny")), "gantt_link_tooltip" + p;
      }, tooltip_date_format: u.date_to_str("%Y-%m-%d"), tooltip_text: function(v, b, g) {
  ...
  s.registerProvider("global", function() {
    ...
    return s;
  }), O(n, Hn), n.Promise = Ei, n.env = bt, function(l) {
    var c = Di.create();
    O(l, c);
    var d, u = l.createDatastore({ name: "task", type: "treeDatastore", rootId: function() {
      ...
      var p = null;
      (m.duration || m.duration === 0) && (m.duration = p = 1 * m.duration), p && (m.start_date && !m.end_date ? m.end_date = this.calculateEndDate(m) : !m.start_date && m.end_date && (m.start_date = this.calculateEndDate({ start_date: m.end_date, duration: -m.duration, task: m }))), l.config.deadlines !== !1 && m.deadline && (m.deadline = l.date.parseDate(m.deadline, "parse_date")), m.progress = Number(m.progress) || 0, this._isAllowedUnscheduledTask(m) && this._set_default_task_timing(m), this._init_task_timing(m), m.start_date && m.end_date && this.correctTaskWorkTime(m), m.$source = [], m.$target = [];
      var k = this.$data.tasksStore.getItem(m.id);
      return k && !G(m.open) && (m.$open = k.$open), m.parent === void 0 && (m.parent = this.config.root_id), m.open && (m.$open = !0), m;
    }, l), getConfig: function() {
      return l.config;
    } }), h = l.createDatastore({ name: "link", initItem: z(function(m) {
    ...
    function _(m) {
      ...
      if (!p && l.isTaskExists(m)) {
        var k = l.getParent(m);
        l.isTaskExists(k) && l.isTaskVisible(k) && (k = l.getTask(k), l.isSplitTask(k) && (p = !0));
      }
      return p;
    }
    function f(m) {
      if (l.isTaskExists(m.source)) {
        ...
        p.$source = p.$source || [], y(m.id, p.$source) && p.$source.push(m.id);
      }
      if (l.isTaskExists(m.target)) {
        var k = l.getTask(m.target);
        k.$target = k.$target || [], y(m.id, k.$target) && k.$target.push(m.id);
      }
    }
    function y(m, p) {
    ...
    function v(m) {
      if (l.isTaskExists(m.source)) {
        for (var p = l.getTask(m.source), k = 0; k < p.$source.length; k++) if (p.$source[k] == m.id) {
          p.$source.splice(k, 1);
          break;
        }
      }
      if (l.isTaskExists(m.target)) {
        ...
        for (k = 0; k < w.$target.length; k++) if (w.$target[k] == m.id) {
          w.$target.splice(k, 1);
          break;
        }
      }
    ...
    function b() {
      for (var m = null, p = l.$data.tasksStore.getItems(), k = 0, w = p.length; k < w; k++) (m = p[k]).$source = [], m.$target = [];
      var x = l.$data.linksStore.getItems();
      for (k = 0, w = x.length; k < w; k++) f(x[k]);
    }
    function g(m) {
      var p = m.source, k = m.target;
      for (var w in m.events) (function(x, $) {
    ...
    l.attachEvent("onDestroy", function() {
      ...
      for (var p = l.getTask(m.source).$source, k = 0; k < p.length; k++) {
        var w = l.getLink(p[k]), x = m.source == w.source, $ = m.target == w.target, S = m.type == w.type;
        if (x && $ && S) return !1;
      }
      return !0;
    }), u.attachEvent("onBeforeRefreshAll", function() {
      if (!u._skipTaskRecalculation) for (var m = u.getVisibleItems(), p = 0; p < m.length; p++) {
        var k = m[p];
        k.$index = p, k.$local_index = l.getTaskIndex(k.id), l.resetProjectDates(k);
      }
      ...
      if (l.config.start_date && l.config.end_date) {
        ...
        if (k = l.config.start_date.valueOf(), w = l.config.end_date.valueOf(), +p.start_date > w || +p.end_date < +k) return !1;
      }
      return !0;
      ...
      for (p.$target || (p.$target = []), k = 0; k < p.$target.length; k++) h.refresh(p.$target[k]);
    }), u.attachEvent("onBeforeItemMove", function(m, p, k) {
      return !Gt(m, l, u) || (console.log("The placeholder task cannot be moved to another position."), !1);
      ...
      if (k == "delete" && l._update_flags(m, null), !l.$services.getService("state").getState("batchUpdate").batch_update) {
        if (l.config.fit_tasks && k !== "paint") {
          var w = l.getState();
          Ae(l);
          var x = l.getState();
          if (+w.min_date != +x.min_date || +w.max_date != +x.max_date) return l.render(), l.callEvent("onScaleAdjusted", []), !0;
        }
        k == "add" || k == "move" || k == "delete" ? l.$layout && (this.$config.name != "task" || k != "add" && k != "delete" || this._skipTaskRecalculation != "lightbox" && (this._skipTaskRecalculation = !0), l.$layout.resize()) : m || h.refresh();
      }
      ...
      v(l.mixin({ id: m }, l.$data.linksStore.getItem(p))), f(l.$data.linksStore.getItem(p));
    }), h.attachEvent("onFilterItem", function(m, p) {
      if (!l.config.show_links) return !1;
      var k = _(p.source), w = _(p.target);
    ...
    }), d = {}, l.attachEvent("onBeforeTaskDelete", function(m, p) {
      return d[m] = Me.getSubtreeLinks(l, m), !0;
    }), l.attachEvent("onAfterTaskDelete", function(m, p) {
      d[m] && l.$data.linksStore.silent(function() {
        for (var k in d[m]) l.isLinkExists(k) && l.$data.linksStore.removeItem(k), v(d[m][k]);
        d[m] = null;
      });
    }), l.attachEvent("onAfterLinkDelete", function(m, p) {
      l.isTaskExists(p.source) && l.refreshTask(p.source), l.isTaskExists(p.target) && l.refreshTask(p.target);
  ...
  }(n), n.dataProcessor = Ii, n.createDataProcessor = Li, function(l) {
    l.ext || (l.ext = {});
    for (var c = [Pi, Ri, Oi, Bi, zi, ji, Fi, Wi, Vi], d = 0; d < c.length; d++) c[d] && c[d](l);
  }(n), function(l) {
    (function(c) {
      c.getGridColumn = function(d) {
        for (var u = c.config.columns, h = 0; h < u.length; h++) if (u[h].name == d) return u[h];
        return null;
      }, c.getGridColumns = function() {
        return c.config.columns.slice();
      };
    })(l), ue.prototype.getGridColumns = function() {
      for (var c = this.$getConfig().columns, d = [], u = 0; u < c.length; u++) c[u].hide || d.push(c[u]);
      return d;
    };
  }(n), function(l) {
    ...
    var c = new qn(l), d = new Yn(c);
    O(l, ta(c, d));
  }(n), ea(n), function(l) {
    l.getTaskType = function(c) {
      var d = c;
      for (var u in c && typeof c == "object" && (d = c.type), this.config.types) if (this.config.types[u] == d) return d;
  ...
  var o = new xa({ en: ua, ar: ia, be: aa, ca: ra, cn: sa, cs: oa, da: la, de: ca, el: da, es: ha, fa: _a, fi: ga, fr: fa, he: pa, hr: ma, hu: va, id: ka, it: ya, jp: ba, kr: $a, nb: wa, nl: Sa, no: Ta, pl: Ea, pt: Ca, ro: Da, ru: Aa, si: Ma, sk: Ia, sv: La, tr: Na, ua: Pa });
  return n.i18n = { addLocale: o.addLocale, setLocale: function(l) {
    if (typeof l == "string") {
      var c = o.getLocale(l);
      c || (c = o.getLocale("en")), n.locale = c;
    } else if (l) if (n.locale) for (var d in l) l[d] && typeof l[d] == "object" ? (n.locale[d] || (n.locale[d] = {}), n.mixin(n.locale[d], l[d], !0)) : n.locale[d] = l[d];
    else n.locale = l;
...
function Oa(t) {
    ...
    if (e) {
      ...
      if (v.keyboard) {
        if (m == 13 || m == 32) {
          ...
          it(k).indexOf("gantt_popup_button") > -1 && k.click ? k.click() : (i(e, !0), p = !0);
        }
        m == 27 && (i(e, !1), p = !0);
      }
  ...
  function c(g, m, p) {
    ...
    var w = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - k.offsetWidth) / 2)), x = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - k.offsetHeight) / 2));
    return g.position == "top" ? k.style.top = "-3px" : k.style.top = x + "px", k.style.left = w + "px", k.onkeydown = a, y.focus(k), g.hidden && y.hide(k), t.callEvent("onMessagePopup", [k]), k;
  }
  function d(g) {
    return c(g, !0, !1);
  }
  ...
  function f(g, m, p, k) {
    return typeof g != "object" && (g = { text: g, type: m, expire: p, id: k }), g.id = g.id || ut(), g.expire = g.expire || v.expire, g;
  }
  ...
  var v = function(g, m, p, k) {
    switch ((g = f.apply(this, arguments)).type = g.type || "info", g.type.split("-")[0]) {
      ...
      default:
        return function(w) {
          v.area || (v.area = document.createElement("div"), v.area.className = "gantt_message_area", v.area.style[v.position] = "5px"), et(v.area, document.body) || document.body.appendChild(v.area), v.hide(w.id);
  ...
  v.seed = (/* @__PURE__ */ new Date()).valueOf(), v.uid = ut, v.expire = 4e3, v.keyboard = !0, v.position = "top", v.pull = {}, v.timers = {}, v.hideAll = function() {
...
function Ba(t, n) {
  var e, i, a;
  O(t, (e = n, { $getConfig: function() {
    return i || (i = e ? e.$getConfig() : this.$gantt.config), this.$config.config ? pn.call(this, "config", i) : i;
  }, $getTemplates: function() {
    return a || (a = e ? e.$getTemplates() : this.$gantt.templates), this.$config.templates ? pn.call(this, "templates", a) : a;
  } }));
}
const za = function(t) {
  var n = {}, e = {};
  function i(a, r, s, o) {
    ...
    a != "resizer" || s.mode || (o.$config.cols ? s.mode = "x" : s.mode = "y"), a != "viewcell" || s.view != "scrollbar" || s.scroll || (o.$config.cols ? s.scroll = "y" : s.scroll = "x"), (s = X(s)).id || e[s.view] || (s.id = s.view), s.id && !s.css && (s.css = s.id + "_cell");
    var c = new l.create(r, s, this, t);
    return l.configure && l.configure(c), Ba(c, o), c.$id || (c.$id = s.id || t.uid()), c.$parent || typeof r != "object" || (c.$parent = r), c.$config || (c.$config = s), e[c.$id] && (c.$id = t.uid()), e[c.$id] = c, c;
  }
...
var ja = /* @__PURE__ */ function(t) {
  return function(n) {
    ...
    function a(h) {
      h = h || window.event;
      var _ = n.locate(h), f = s(h, e.click), y = !0;
    ...
    function s(h, _) {
      for (var f = h.target || h.srcElement, y = []; f; ) {
        ...
        if (v) {
          v = v.split(" ");
          for (var b = 0; b < v.length; b++) if (v[b] && _[v[b]]) for (var g = _[v[b]], m = 0; m < g.length; m++) g[m].root && !t.isChildOf(f, g[m].root) || y.push(g[m].handler);
        }
        f = f.parentNode;
      }
      return y;
    ...
    function l(h) {
      h = h || window.event;
      var _ = n.locate(h), f = s(h, e.doubleclick), y = !n.checkEvent("onTaskDblClick") || _ === null || n.callEvent("onTaskDblClick", [_, h]);
      if (y) {
        if (!o(f, h, _)) return;
    ...
    return { reset: u, global: function(h, _, f) {
      ...
      if (e[h] && e[h][_]) {
        for (var v = e[h], b = v[_], g = 0; g < b.length; g++) b[g].root == y && (b.splice(g, 1), g--);
        b.length || delete v[_];
      }
...
var Wa = function(t) {
  var n = /* @__PURE__ */ function(e) {
    ...
    function s(o, l, c) {
      ...
      var d = null, u = null, h = null, _ = null, f = null;
      typeof l.renderer == "function" ? (d = l.renderer, h = ie) : (d = l.renderer.render, u = l.renderer.update, _ = l.renderer.onrender, l.renderer.isInViewPort ? f = l.renderer.isInViewPort : h = l.renderer.getRectangle, h || h === null || (h = ie));
      var y = l.filter;
      return c && c.setAttribute(e.config.layer_attribute, !0), a[o] = { render_item: function(v, b, g, m, p) {
        if (b = b || c, !y || y(v)) {
          var k = m || r(l), w = p || (k ? k.$getConfig() : null), x = g;
          !x && w && w.smart_rendering && (x = k.getViewPort());
          var $ = null;
          !Wt(e) && (h || f) && x ? (f ? f(v, x, k, w, e) : mn(x, h(v, k, w, e))) && ($ = d.call(e, v, k, w, x)) : $ = d.call(e, v, k, w, x), this.append(v, $, b);
          var S = b.nodeType == 11;
          _ && !S && $ && _.call(e, v, $, k);
        ...
        for (var w = 0, x = v.length; w < x; w++) this.render_item(v[w], g, m, p, k);
        b.appendChild(g, b);
        var $ = {};
        ...
        if (g && g.$getConfig().smart_rendering && !Wt(e) && this.rendered && (h || f)) {
          b = b || c;
          ...
          for (var T = {}, E = (S = 0, v.length); S < E; S++) {
            ...
            $[C.id] = !1, D && D.parentNode ? (f ? f(C, k, g, m, e) : mn(k, h(C, g, m, e))) ? (u && u.call(e, C, D, g, m, k), this.restore(C, p)) : $[C.id] = !0 : (T[v[S].id] = !0, this.render_item(v[S], p, k, g, m));
          }
        ...
        g ? g.parentNode || this.append(v, g, b || c) : this.render_item(v, b || c);
  ...
  return { createGroup: function(e, i, a, r) {
    var s = { tempCollection: [], renderers: {}, container: e, filters: [], getLayers: function() {
      ...
      for (let d = 0; d < c.length; d++) {
        ...
        this.renderers[h] = n.getRenderer(h, o, u), r && r(o, t), this.tempCollection.splice(d, 1), d--;
      }
    }, addLayer: function(o) {
      if (o) {
        typeof o == "function" && (o = { renderer: o }), o.filter === void 0 ? o.filter = vn(a || []) : o.filter instanceof Array && (o.filter.push(a), o.filter = vn(o.filter)), o.container || (o.container = document.createElement("div"));
        var l = this;
...
function kn(t, n, e) {
  ...
  var i = n.posFromDate(t.start_date), a = n.posFromDate(t.end_date), r = Math.min(i, a) - 200, s = Math.max(i, a) + 200;
  ...
  function i(r, s, o) {
    s.$getConfig(), r.getVisibleItems().forEach(function(l) {
      var c = function(d, u, h, _) {
        ...
        var f = kn(_.getTask(d.source), u), y = kn(_.getTask(d.target), u);
        if (!f || !y) return null;
        var v = 100, b = Math.min(f.left, y.left) - v, g = Math.max(f.left + f.width, y.left + y.width) + v, m = Math.min(f.top, y.top) - v, p = Math.max(f.top + f.height, y.top + y.height) + v;
...
function Kn(t, n, e, i, a) {
  var r = e.$gantt.getTask(t.source), s = e.$gantt.getTask(t.target), o = e.getItemTop(r.id), l = e.getItemHeight(r.id), c = e.getItemTop(s.id), d = e.getItemHeight(s.id);
  if (n.y > o + l && n.y > c + d || n.y_end < c && n.y_end < o) return !1;
  var u = e.posFromDate(r.start_date), h = e.posFromDate(r.end_date), _ = e.posFromDate(s.start_date), f = e.posFromDate(s.end_date);
  if (u > h) {
    var y = h;
    h = u, u = y;
  }
...
var wt = function() {
  function t(n, e, i, a) {
    n && (this.$container = We(n), this.$parent = n), this.$config = O(e, { headerHeight: 33 }), this.$gantt = a, this.$domEvents = a._createDomEventScope(), this.$id = e.id || "c" + ut(), this.$name = "cell", this.$factory = i, this.$externalComponent = null, _t(this);
  }
...
var Xn = function(t) {
  ...
  return W(n, t), n.prototype.destructor = function() {
    this.$container && this.$view && Cn(this.$view);
    ...
    for (var d, u = 0; u < i.length; u++) e[(d = i[u]).$config.scroll] ? c(d) : d.shouldHide() ? o.push(d) : d.shouldShow() ? l(d) : d.isVisible() ? r.push(d) : s.push(d);
    var h = {};
    for (u = 0; u < r.length; u++) r[u].$config.group && (h[r[u].$config.group] = !0);
    for (o.forEach(function(f) {
      f.$config.group && h[f.$config.group] || c(f);
    ...
    if (e.length) for (var a = e[0].$parent._xLayout ? "width" : "height", r = e[0].$parent.getNextSibling(e[0].$id) ? 1 : -1, s = i.value, o = i.isGravity, l = 0; l < e.length; l++) {
      var c = e[l].getSize(), d = r > 0 ? e[l].$parent.getNextSibling(e[l].$id) : e[l].$parent.getPrevSibling(e[l].$id);
      d.$name == "resizer" && (d = r > 0 ? d.$parent.getNextSibling(d.$id) : d.$parent.getPrevSibling(d.$id));
      var u = d.getSize();
      if (o) e[l].$config.gravity = s;
      else if (d[a]) {
        var h = c.gravity + u.gravity, _ = c[a] + u[a], f = h / _;
        e[l].$config.gravity = f * s, d.$config[a] = _ - s, d.$config.gravity = h - f * s;
      } else e[l].$config[a] = s;
    ...
    for (var a = Dn(e, "gantt_layout_cell"), r = a.length - 1; r >= 0; r--) {
      var s = this.$cells[r];
    ...
    for (var e = 0, i = 0, a = 1e11, r = 0, s = 1e11, o = 0, l = 0; l < this.$cells.length; l++) {
      ...
      this.$cells[l].$config.hidden || (this._xLayout ? (!c.width && c.minWidth ? e += c.minWidth : e += c.width, a += c.maxWidth, i += c.minWidth, r = Math.max(r, c.height), s = Math.min(s, c.maxHeight), o = Math.max(o, c.minHeight)) : (!c.height && c.minHeight ? r += c.minHeight : r += c.height, s += c.maxHeight, o += c.minHeight, e = Math.max(e, c.width), a = Math.min(a, c.maxWidth), i = Math.max(i, c.minWidth)));
    }
  ...
  function n(e, i, a) {
    ...
    function l(c) {
      var d = c.pageX, u = c.pageY;
      return c.touches && (d = c.touches[0].pageX, u = c.touches[0].pageY), { x: d, y: u };
    }
    return o._moveHandler = function(c) {
      o._moveResizer(o._resizer, l(c).x, l(c).y);
    }, o._upHandler = function(c) {
      var d = o._getNewSizes();
      o.callEvent("onResizeEnd", [r, s, d ? d.back : 0, d ? d.front : 0]) !== !1 && o._setSizes(), o._setBackground(!1), o._clearResizer(), o._clearListeneres(), c.touches && (o.$gantt._prevent_touch_scroll = !1);
    ...
    }, o._startDND = function(c) {
      if (this._callStartDNDEvent() !== !1) {
        var d = !1;
        this._eachGroupItem(function(u) {
          u._getSiblings(), u._callStartDNDEvent() === !1 && (d = !0);
        }), d || (o._moveHandler(c), o.$domEvents.attach(document, "mousemove", o._moveHandler), o.$domEvents.attach(document, "mouseup", o._upHandler));
      }
    }, o._cancelDND = function() {
      o._setBackground(!1), o._clearResizer(), o._clearListeneres();
    }, o._startOnMove = function(c) {
      c.touches && (o.$gantt._touch_drag = !0, o.$gantt._prevent_touch_scroll = !0), o._isPosChanged(c) && (o._clearListeneres(), o._startDND(c));
    }, o._downHandler = function(c) {
      o._getSiblings(), o._behind.$config.collapsed || o._front.$config.collapsed || (o._setBackground(!0), o._resizer = o._setResizer(), o._positions = { x: l(c).x, y: l(c).y, timestamp: Date.now() }, o.$domEvents.attach(document, "mousemove", o._startOnMove), o.$domEvents.attach(document, "mouseup", o._cancelDND));
    }, o.$name = "resizer", o;
  }
  return W(n, t), n.prototype.init = function() {
    ...
    var c, d, u = this._getDirection(e, i);
    if (u === -1) {
      if (d = o - a, c = r - Math.abs(a), o - a > this._front.$config.maxWidth) return;
      Math.abs(a) >= r && (a = -Math.abs(r - 2)), r - Math.abs(a) <= s && (a = -Math.abs(r - s));
    } else d = o - Math.abs(a), c = r + a, r + a > this._behind.$config.maxWidth && (a = this._behind.$config.maxWidth - r), Math.abs(a) >= o && (a = o - 2), o - Math.abs(a) <= l && (a = Math.abs(o - l));
    return u === -1 ? (d = o - a, c = r - Math.abs(a)) : (d = o - Math.abs(a), c = r + a), { size: a, newFrontSide: d, newBehindSide: c };
    ...
    this._eachGroupItem(function(l) {
      l._getSiblings();
      var c = X(this._positions);
      this._xMode ? c.x += l._behind.$config.width - this._behind.$config.width : c.y += l._behind.$config.height - this._behind.$config.height, l._positions = c, s.push(l._getResizePosition(e, i));
    });
  ...
  function e(a, r, s, o) {
    ...
    this.$config = O(r, { scroll: "x" }), l._scrollHorizontalHandler = z(l._scrollHorizontalHandler, l), l._scrollVerticalHandler = z(l._scrollVerticalHandler, l), l._outerScrollVerticalHandler = z(l._outerScrollVerticalHandler, l), l._outerScrollHorizontalHandler = z(l._outerScrollHorizontalHandler, l), l._mouseWheelHandler = z(l._mouseWheelHandler, l), this.$config.hidden = !0;
  ...
  return W(e, t), e.prototype.init = function(a) {
    ...
    for (var a, r = 0, s = 0, o = this._isHorizontal(), l = this._getLinkedViews(), c = o ? "scrollWidth" : "scrollHeight", d = o ? "contentX" : "contentY", u = o ? "x" : "y", h = this._getScrollOffset(), _ = 0; _ < l.length; _++) if ((a = l[_]) && a.$content && a.$content.getSize && !a.$config.hidden) {
      ...
      if (f = y.hasOwnProperty(c) ? y[c] : y[d], h) y[d] > y[u] && y[d] > r && f > y[u] - h + 2 && (r = f + (o ? 0 : 2), s = y[u]);
      else {
        var v = Math.max(y[d] - f, 0);
    ...
    if (this._checkWheelTarget(r)) {
      ...
      var c = bt.isFF, d = c ? a.deltaX : a.wheelDeltaX, u = c ? a.deltaY : a.wheelDelta, h = -20;
      if (c) {
        const k = parseInt(navigator.userAgent.split("Firefox/")[1]);
        h = k <= 87 ? a.deltaMode !== 0 ? -40 : -10 : k <= 90 ? -3 : k <= 96 ? -1.5 : -1;
      }
      var _ = c ? d * h * o.x : 2 * d * o.x, f = c ? u * h * o.y : u * o.y, y = this.$gantt.config.horizontal_scroll_key;
      if (y !== !1 && n.indexOf(y) >= 0 && (!a[y] || a.deltaX || a.wheelDeltaX || (_ = 2 * f, f = 0)), _ && Math.abs(_) > Math.abs(f)) {
  ...
  function l(u, h, _) {
    var f = Math.floor(500 / u) || 1, y = Math.floor(500 / h) || 1, v = document.createElement("canvas");
    v.height = h * y, v.width = u * f;
    var b = v.getContext("2d");
    return function(m, p, k, w, x, $) {
      var S = x.createImageData(p * w, m * k);
      S.imageSmoothingEnabled = !1;
      for (var T = 1 * $.rightBorderWidth, E = a($.rightBorderColor), C = 0, D = 0, A = 0, I = 1; I <= w; I++) for (C = I * p - 1, A = 0; A < T; A++) for (D = 0; D < m * k; D++) g(C - A, D, E, S);
      var M = 1 * $.bottomBorderWidth, L = a($.bottomBorderColor);
      D = 0;
      for (var N = 1; N <= k; N++) for (D = N * m - 1, A = 0; A < M; A++) for (C = 0; C < p * w; C++) g(C, D - A, L, S);
      x.putImageData(S, 0, 0);
    }(h, u, y, f, b, _), v.toDataURL();
    function g(m, p, k, w) {
      var x = 4 * (p * (u * f) + m);
      w.data[x] = k.r, w.data[x + 1] = k.g, w.data[x + 2] = k.b, w.data[x + 3] = k.a;
    }
  }
  function c(u) {
    ...
    if ((h.static_background || h.timeline_placeholder) && document.createElement("canvas").getContext) {
      ...
      var v = function(p) {
        ...
        for (var C in S) {
          ...
          if (!r(A)) {
            var I = l(D, T, p);
            o(A, I), E += "." + c(A) + "{ background-image: url('" + I + "');}";
          }
          $[C] = c(A);
        }
        return E && (function() {
          var M = document.getElementById(i);
          return M || ((M = document.createElement("style")).id = i, document.body.appendChild(M)), M;
        }().innerHTML += E), $;
      }(v, 0, _, y), g = function(p, k, w, x) {
        ...
        for (var M = 0; M < C.length; M++) {
          ...
          if (L != S && S !== void 0 || M == C.length - 1 || E > A) {
            for (var N = x, P = 0, R = Math.floor(A / k.row_height) * k.row_height, B = E; N > 0; ) {
              var H = Math.min(N, R);
              N -= R, ($ = document.createElement("div")).style.height = H + "px", $.style.position = "absolute", $.style.top = P + "px", $.style.left = D + "px", $.style.pointerEvents = "none", $.style.whiteSpace = "no-wrap", $.className = p[S || L], M == C.length - 1 && (B = L + B - 1), $.style.width = B + "px", T.push($), P += H;
            }
            E = 0, D += B;
          }
          L && (E += L, S = L);
...
var Ye = function(t, n, e, i) {
  this.$config = O({}, n || {}), this.$scaleHelper = new jn(i), this.$gantt = i, this._posFromDateCache = {}, this._timelineDragScroll = null, O(this, Vn(this)), _t(this);
};
function ye(t) {
...
function Je(t) {
  ...
  return { init: function() {
    ...
    ye(this), e.apply(this, arguments);
    ...
    if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
      ...
      var r = this, s = Qt(function() {
        if (r.$gantt.getState().lightbox) s();
          ...
          const l = r.$config.rowStore, c = r._getRelevantResources();
          if (c && l.$config.name === r.$gantt.config.resource_store) {
            if (c == "nothing_to_repaint") return;
            l._quick_refresh = !0, r.relevantResources.forEach(function(d) {
              l.refresh(d);
            }), l._quick_refresh = !1;
          } else l.refresh();
        }
    ...
    a.$config.fetchTasks && a.silent(function() {
      var r = [], s = {}, o = {};
      for (var l in a.eachItem(function(c) {
        if (c.$role != "task") {
          var d = i.getResourceAssignments(c.id), u = {};
          d.sort(function(h, _) {
            const f = a.pull, y = f[`${h.task_id}_${h.resource_id}`], v = f[`${_.task_id}_${_.resource_id}`];
            return y && v ? y.$local_index - v.$local_index : 0;
          }), d.forEach(function(h) {
            if (!u[h.task_id] && i.isTaskExists(h.task_id)) {
              u[h.task_id] = !0;
              var _, f = i.getTask(h.task_id);
              (_ = a.$config.copyOnParse ? i.copy(f) : Object.create(f)).id = f.id + "_" + c.id, _.$task_id = f.id, _.$resource_id = c.id, _[a.$parentProperty] = c.id, _.$role = "task", r.push(_), s[_.id] = !0;
            }
          });
        } else o[c.id] = !0;
...
Ye.prototype = { init: function(t) {
  ...
  var t = this, n = Ka(), e = t.$config.rowStore;
    ...
    if (i === null && t.isVisible()) {
      ...
      if (s.static_background || s.timeline_placeholder) {
        ...
        if (l || ((l = document.createElement("div")).className = "gantt_task_bg", t.$task_bg_static = l, t.$task_bg.nextSibling ? t.$task_data.insertBefore(l, t.$task_bg.nextSibling) : t.$task_data.appendChild(l)), o) {
          ...
          s.timeline_placeholder && (c = s.timeline_placeholder.height || t.$task_data.offsetHeight || 99999), n.render(l, s, t.getScale(), c, t.getItemHeight(a ? a.id : null));
        }
  ...
  if (this.isVisible()) {
    ...
    this._scales = l, this._posFromDateCache = {}, n = this._getScaleChunkHtml(l, 0, this.$config.width), e = c.full_width + "px", i += "px";
  }
  ...
  var d = 0, u = t.count;
  !a.smart_scales || isNaN(n) || isNaN(e) || (d = Bt(t.left, n), u = Bt(t.left, e) + 1), l = t.css || function() {
  }, !t.css && a.inherit_scale_class && (l = r.scale_cell_class);
  for (var h = d; h < u && t.trace_x[h]; h++) {
    o = new Date(t.trace_x[h]);
    var _ = c.call(this, o), f = t.width[h];
    t.height;
    var y = t.left[h], v = "", b = "", g = "";
    if (f) {
      ...
      const x = 70;
      if (k !== !1 && f > x || k === !0) {
        if (y < p.x && y + f / 2 - x / 2 < p.x) w = ` style='position:absolute;left: ${p.x - y + 10}px;' `;
        else if (y + f / 2 + x / 2 > p.x_end && f > x) {
          let $ = p.x_end - y - 10, S = "-100%";
  ...
  var e = Bt(this._tasks.left, t), i = this._tasks.left[e], a = n.width[e] || n.col_width, r = 0;
  a && (r = (t - i) / a, n.rtl && (r = 1 - r));
  var s = 0;
  return r && (s = this._getColumnDuration(n, n.trace_x[e])), new Date(n.trace_x[e].valueOf() + Math.round(r * s));
  ...
  var r = Bt(e, n), s = this._getClosestVisibleColumn(r, e, i), o = e[s], l = this._tasks.trace_index_transition;
  if (!o) return l ? l[0] : 0;
  var c = (t - e[s]) / this._getColumnDuration(this._tasks, e[s]);
...
var Xa = function(t) {
  ...
  return W(n, t), O(n.prototype, { init: function() {
  ...
  return W(n, t), O(n.prototype, { _createLayerConfig: function() {
    var e = this, i = function() {
      return e.isVisible();
    };
  ...
  } }, !0), O(n.prototype, Je(t), !0), n;
}(Zn);
const Qa = { init: function(t, n) {
  var e = n.$gantt;
  ...
  r.attachEvent("onBeforeFocus", function(s) {
    ...
    switch (h) {
      case u.ENTER:
        t.isVisible() ? (t.save(), o.preventDefault(), _ = !0) : c && !(o.ctrlKey || o.metaKey || o.shiftKey) && (e.startEdit(l.id, l.columnName), o.preventDefault(), _ = !0);
        break;
      case u.ESC:
      ...
      case u.RIGHT:
        ...
        break;
      case u.SPACE:
        t.isVisible() && (_ = !0), c && !t.isVisible() && (e.startEdit(l.id, l.columnName), o.preventDefault(), _ = !0);
        break;
      case u.DELETE:
        c && !t.isVisible() ? (e.startEdit(l.id, l.columnName), _ = !0) : c && t.isVisible() && (_ = !0);
        break;
      case u.TAB:
        if (t.isVisible()) {
      ...
      default:
        if (t.isVisible()) _ = !0;
          ...
          y.alt || v && r.getCommandHandler(s, "taskCell") || c && !t.isVisible() && (e.startEdit(l.id, l.columnName), _ = !0);
        }
    }
    return !_;
  });
...
function er(t) {
  ...
  return W(e, n), O(e.prototype, { show: function(i, a, r, s) {
...
function ar(t) {
  ...
  return W(r, n), O(r.prototype, { show: function(s, o, l, c) {
...
function rr(t) {
  ...
  return W(e, n), O(e.prototype, { show: function(l, c, d, u) {
...
function sr(t) {
  ...
  return W(e, n), O(e.prototype, { show: function(a, r, s, o) {
...
function lr(t) {
  t.config.editor_types = { text: new (er())(), number: new (nr())(), select: new (ir())(), date: new (ar(t))(), predecessor: new (rr(t))(), duration: new (sr(t))() };
}
function cr(t) {
  ...
  _t(e);
  var i = { init: lr, createEditors: function(a) {
    function r(u, h) {
      var _ = a.$getConfig(), f = function(b, g) {
        ...
        return m.rtl ? { top: p, right: $, height: k, width: S } : { top: p, left: x, height: k, width: S };
    ...
    var s = or(t), o = [], l = [], c = null, d = { _itemId: null, _columnName: null, _editor: null, _editorType: null, _placeholder: null, locateCell: function(u) {
      if (!et(u, a.$grid)) return null;
      var h = tt(u, a.$config.item_attribute), _ = tt(u, "data-column-name");
      if (h && _) {
      ...
      var h = this;
      o.push(c.attachEvent("onIdChange", function(_, f) {
      ...
      if (!y) return;
      var v = a.$getConfig().editor_types[y.type], b = r(_.id, _.columnName);
      ...
      }).bind(this), m = v.show(_.id, f, y, b);
      if (m && m.then) return m.then(() => {
        g();
      });
      g();
    }, setValue: function() {
      var u = this.getState(), h = u.id, _ = u.columnName, f = a.getColumn(_), y = c.getItem(h), v = this.getEditorConfig(_);
      if (v) {
        var b = y[v.map_to];
        v.map_to == "auto" && (b = c.getItem(h)), this._editor.set_value(b, h, f, this._placeholder), this.focus();
      }
    }, focus: function() {
      ...
      if (this.isVisible() && c.exists(this._itemId) && this.isChanged()) {
        ...
        if (c.exists(u)) {
          var _ = c.getItem(u), f = this.getEditorConfig(h), y = { id: u, columnName: h, newValue: this.getValue(), oldValue: this._getItemValue() };
          if (this.callEvent("onBeforeSave", [y]) !== !1 && (!this._editor.is_valid || this._editor.is_valid(y.newValue, y.id, a.getColumn(h), this._placeholder))) {
            ...
            v != "auto" ? (_[v] = b, s(_, v, t.config.inline_editors_date_processing), c.updateItem(u)) : this._editor.save(u, a.getColumn(h), this._placeholder), this.callEvent("onSave", [y]);
          }
          this.hide();
        }
      } else this.hide();
...
function It(t, n, e, i, a) {
  ...
  var o = e.posFromDate(t.start_date), l = e.posFromDate(t.end_date), c = Math.min(o, l) - 200, d = Math.max(o, l) + 200;
  return !(c > n.x_end || d < n.x);
}
function be(t) {
  function n(r, s, o) {
    ...
    if (y && v && r.bar_height !== "full" && r.bar_height < r.row_height) if (u === c.types.milestone) {
    ...
    s.$config.item_attribute && (b.setAttribute(s.$config.item_attribute, r.id), b.setAttribute(s.$config.bind + "_id", r.id)), c.show_progress && u != c.types.milestone && function(T, E, C, D, A) {
      var I = 1 * T.progress || 0;
      C = Math.max(C, 0);
      var M = document.createElement("div"), L = Math.round(C * I);
      L = Math.min(C, L), M.style.width = L + "px", M.className = "gantt_task_progress", M.innerHTML = A.progress_text(T.start_date, T.end_date, T), D.rtl && (M.style.position = "absolute", M.style.right = "0px");
      var N = document.createElement("div");
      N.className = "gantt_task_progress_wrapper", N.appendChild(M), E.appendChild(N);
      const P = !t.isReadonly(T), R = t.ext.dragTimeline && t.ext.dragTimeline._isDragInProgress();
      if (t.config.drag_progress && (P || R)) {
        var B = document.createElement("div"), H = L;
        D.rtl && (H = C - L), B.style.left = H + "px", B.className = "gantt_task_progress_drag", B.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
<path d="M5.58397 1.52543C5.78189 1.22856 6.21811 1.22856 6.41602 1.52543L10.5475 7.72265C10.769 8.05493 10.5308 8.5 10.1315 8.5L1.86852 8.5C1.46917 8.5 1.23097 8.05493 1.45249 7.72265L5.58397 1.52543Z" fill="var(--dhx-gantt-progress-handle-background)" stroke="var(--dhx-gantt-progress-handle-border)"/>
</svg>`, M.appendChild(B), E.appendChild(B);
      }
    }(r, b, g, c, d);
    ...
    var p = function(T, E, C, D) {
      var A = D.$getConfig(), I = [T];
      E && I.push(E);
      var M = t.getState(), L = t.getTask(C);
      if (t.getTaskType(L.type) == A.types.milestone ? I.push("gantt_milestone") : t.getTaskType(L.type) == A.types.project && I.push("gantt_project"), I.push("gantt_bar_" + t.getTaskType(L.type)), t.isSummaryTask(L) && I.push("gantt_dependent_task"), t.isSplitTask(L) && (A.open_split_tasks && !L.$open || !A.open_split_tasks) && I.push("gantt_split_parent"), A.select_task && t.isSelectedTask(C) && I.push("gantt_selected"), C == M.drag_id && (I.push("gantt_drag_" + M.drag_mode), M.touch_drag && I.push("gantt_touch_" + M.drag_mode)), M.link_source_id == C && (I.push("gantt_link_source"), M.link_from_start ? I.push("gantt_link_from_start") : I.push("gantt_link_from_end")), M.link_target_id == C && I.push("gantt_link_target"), A.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(L) && I.push("gantt_critical_task"), M.link_landing_area && M.link_target_id && M.link_source_id && M.link_target_id != M.link_source_id && (M.link_target_id == C || M.link_source_id == C)) {
        var N = M.link_source_id, P = M.link_from_start, R = M.link_to_start, B = "";
        B = t.isLinkAllowed(N, C, P, R) ? R ? "link_start_allow" : "link_finish_allow" : R ? "link_start_deny" : "link_finish_deny", I.push(B);
      }
      return I.join(" ");
    ...
    var w = function(T, E, C, D) {
      var A = "gantt_left " + i(!E.rtl, T), I = null;
      return D && (I = { type: "marginRight", value: D }), e(T, C.leftside_text, A, I);
    }(r, c, d, _);
    w && b.appendChild(w), w = function(T, E, C, D) {
      var A = "gantt_right " + i(!!E.rtl, T), I = null;
      return D && (I = { type: "marginLeft", value: D }), e(T, C.rightside_text, A, I);
    }(r, c, d, _), w && b.appendChild(w), t._waiAria.setTaskBarAttr(r, b);
    var x = t.getState();
    const $ = !t.isReadonly(r), S = t.ext.dragTimeline && t.ext.dragTimeline._isDragInProgress();
    return ($ || S) && (c.drag_resize && !t.isSummaryTask(r) && u != c.types.milestone && a(b, "gantt_task_drag", r, function(T) {
      var E = document.createElement("div");
      ...
      var D = !1;
      return x.link_source_id && c.touch && (D = !0), C.style.display = D ? "block" : "", E.appendChild(C), E;
    }, c, _)), b;
  }
  function e(r, s, o, l) {
    if (!s) return null;
  ...
  return function(r, s, o) {
    var l = (o = s.$getConfig()).type_renderers[t.getTaskType(r.type)], c = n;
...
function dr(t, n, e, i, a) {
  ...
  if (r > n.y_end || r + s < n.y) return !1;
  const o = [];
  t.start_date && o.push(e.posFromDate(t.start_date)), t.end_date && o.push(e.posFromDate(t.end_date)), t.$auto_start_date && o.push(e.posFromDate(t.$auto_start_date)), t.$auto_end_date && o.push(e.posFromDate(t.$auto_end_date));
  var l = Math.min(...o) - 200, c = Math.max(...o) + 200;
  return !(l > n.x_end || c < n.x);
}
function ur(t) {
  function n(r, s, o) {
    if (t._isAllowedUnscheduledTask(r) || !t._isTaskInTimelineLimits(r)) return;
    ...
    const k = document.createElement("div"), w = s.getItemPosition(r, r.$auto_start_date || r.start_date, r.$auto_end_date || r.end_date);
    k.classList.add("gantt_task_line_actual", "gantt_task_line", "gantt_project"), k.style.cssText = ["position:absolute", "left:" + w.left + "px", "top:16px", "height:8px", "width:" + w.width + "px"].join(";"), b.appendChild(k), c.show_progress && u != c.types.milestone && function(T, E, C, D, A) {
      var I = 1 * T.progress || 0;
      C = Math.max(C - 2, 0);
      var M = document.createElement("div"), L = Math.round(C * I);
      L = Math.min(C, L), T.progressColor && (M.style.backgroundColor = T.progressColor, M.style.opacity = 1), M.style.width = L + "px", M.className = "gantt_task_progress", M.innerHTML = A.progress_text(T.start_date, T.end_date, T), D.rtl && (M.style.position = "absolute", M.style.right = "0px");
      var N = document.createElement("div");
      if (N.className = "gantt_task_progress_wrapper", N.appendChild(M), E.appendChild(N), t.config.drag_progress && !t.isReadonly(T)) {
        var P = document.createElement("div"), R = L;
        D.rtl && (R = C - L), P.style.left = R + "px", P.className = "gantt_task_progress_drag", M.appendChild(P), E.appendChild(P);
      }
    }(r, k, g, c, d);
    ...
    $ && m.appendChild($), $ = function(T, E, C, D) {
      var A = "gantt_right " + i(!!E.rtl, T), I = null;
      return D && (I = { type: "marginLeft", value: D }), e(T, C.rightside_text, A, I);
    }(r, c, d, _), $ && m.appendChild($), t._waiAria.setTaskBarAttr(r, b);
    var S = t.getState();
    return t.isReadonly(r) || (c.drag_resize && a(m, "gantt_task_drag", r, function(T) {
      var E = document.createElement("div");
      return E.className = T, E;
    }, c), c.drag_links && c.show_links && a(m, "gantt_link_control", r, function(T) {
      var E = document.createElement("div");
      E.className = T, E.style.cssText = ["height:" + h + "px", "line-height:" + h + "px"].join(";");
      var C = document.createElement("div");
      C.className = "gantt_link_point";
      var D = !1;
      return S.link_source_id && c.touch && (D = !0), C.style.display = D ? "block" : "", E.appendChild(C), E;
    }, c, _)), b;
  }
  function e(r, s, o, l) {
    if (!s) return null;
...
function Vt(t, n, e, i) {
  var a = n.width[t];
  if (a <= 0) return !1;
  if (!i.config.smart_rendering || Wt(i)) return !0;
...
function gr(t) {
  var n = { current_pos: null, dirs: { left: "left", right: "right", up: "up", down: "down" }, path: [], clear: function() {
    ...
    var l = this.get_endpoint(a, r, s, o), c = t.config, d = l.e_y - l.y, u = l.e_x - l.x, h = n.dirs, _ = r.getItemHeight(a.source);
    this.clear(), this.point({ x: l.x, y: l.y });
    var f = 2 * c.link_arrow_size, y = this.get_line_type(a, r.$getConfig()), v = l.e_x > l.x;
    if (y.from_start && y.to_start) this.point_to(h.left, f), v ? (this.point_to(h.down, d), this.point_to(h.right, u)) : (this.point_to(h.right, u), this.point_to(h.down, d)), this.point_to(h.right, f);
    else if (!y.from_start && y.to_start) if (d !== 0 && (v = l.e_x > l.x + 2 * f), this.point_to(h.right, f), v) u -= f, this.point_to(h.down, d), this.point_to(h.right, u);
    else {
      u -= 2 * f;
      var b = d > 0 ? 1 : -1;
      this.point_to(h.down, b * (_ / 2)), this.point_to(h.right, u), this.point_to(h.down, b * (Math.abs(d) - _ / 2)), this.point_to(h.right, f);
    }
    else y.from_start || y.to_start ? y.from_start && !y.to_start && (d !== 0 && (v = l.e_x > l.x - 2 * f), this.point_to(h.left, f), v ? (u += 2 * f, b = d > 0 ? 1 : -1, this.point_to(h.down, b * (_ / 2)), this.point_to(h.right, u), this.point_to(h.down, b * (Math.abs(d) - _ / 2)), this.point_to(h.left, f)) : (u += f, this.point_to(h.down, d), this.point_to(h.right, u))) : (this.point_to(h.right, f), v ? (this.point_to(h.right, u), this.point_to(h.down, d)) : (this.point_to(h.down, d), this.point_to(h.right, u)), this.point_to(h.left, f));
    return this.path;
  ...
  function i(a, r, s) {
    ...
    let l = ne(t, r, a), c = l.maxHeight, d = l.splitChild;
    ...
    if (_) {
      ...
      h = Math.sqrt(2 * f * f), l.shrinkHeight && c < f && (f = c, h = c), o.left -= h / 2, o.width = h;
    }
    if (d) if (c >= o.height) {
  ...
  return { render: function(a, r, s) {
    ...
    var c = e.get_endpoint(a, r, o, l), d = c.e_y - c.y;
    ...
    const h = function(v, b) {
      ...
      if (k.direction === "right" || k.direction === "left") {
        k.size -= 3 * m / 4;
        let w = k.direction === "right" ? k.x + k.size : k.x - k.size - m / 2, x = k.y - b.link_line_width / 2 - m / 2 + 1;
      ...
      return p;
    }(n.get_lines(u, r).filter((v) => v.size > 0), s), _ = function(v, b, g, m) {
      const p = document.createElement("div");
      return v.forEach((k) => {
        let w;
        k.type === "line" ? w = n.render_line(k.data, null, b, g.source) : k.type === "corner" ? w = n.render_corner(k.data, b) : k.type === "arrow" && (w = n.render_arrow(k.data, m)), p.appendChild(w);
      }), p;
    }(h, r, a, s);
    var f = "gantt_task_link";
    a.color && (f += " gantt_link_inline_color");
    var y = t.templates.link_class ? t.templates.link_class(a) : "";
    return y && (f += " " + y), s.highlight_critical_path && t.isCriticalLink && t.isCriticalLink(a) && (f += " gantt_critical_link"), _.className = f, r.$config.link_attribute && (_.setAttribute(r.$config.link_attribute, a.id), _.setAttribute("link_id", a.id)), a.color && _.style.setProperty("--dhx-gantt-link-background", a.color), t._waiAria.linkAttr(a, _), _;
...
function Qn(t) {
  ...
  return t.$data.tasksStore.attachEvent("onStoreUpdated", function() {
    ...
    let o;
    return o = n[s] ? n[s] : n[s] = function(l, c, d, u) {
      let h, _ = !1, f = {};
      t.config.process_resource_assignments && c === t.config.resource_property ? (h = l.$role == "task" ? t.getResourceAssignments(l.$resource_id, l.$task_id) : t.getResourceAssignments(l.id), _ = !0) : h = l.$role == "task" ? [] : t.getTaskBy(c, l.id), f = function($, S, T) {
        const E = S.unit, C = S.step, D = {}, A = {};
        for (let I = 0; I < $.length; I++) {
          const M = $[I];
          let L = M;
          if (T && (L = t.getTask(M.task_id)), L.unscheduled) continue;
          let N = M.start_date || L.start_date, P = M.end_date || L.end_date;
          T && (M.start_date && (N = new Date(Math.max(M.start_date.valueOf(), L.start_date.valueOf()))), M.end_date && (P = new Date(Math.min(M.end_date.valueOf(), L.end_date.valueOf()))), M.mode && M.mode == "fixedDates" && (N = M.start_date, P = M.end_date));
          let R = Bt(S.trace_x, N.valueOf()), B = new Date(S.trace_x[R] || t.date[E + "_start"](new Date(N))), H = new Date(Math.min(N.valueOf(), B.valueOf())), F = t.config.work_time ? t.getTaskCalendar(L) : t;
          for (A[F.id] = {}; H < P; ) {
            const V = A[F.id], j = H.valueOf();
            H = t.date.add(H, C, E), V[j] !== !1 && (D[j] || (D[j] = { tasks: [], assignments: [] }), D[j].tasks.push(L), T && D[j].assignments.push(M));
          }
        }
        return D;
      }(h, d, _);
      const y = d.unit, v = d.step, b = [];
      let g, m, p, k, w;
      const x = u.$getConfig();
      for (let $ = 0; $ < d.trace_x.length; $++) g = new Date(d.trace_x[$]), m = t.date.add(g, v, y), w = f[g.valueOf()] || {}, p = w.tasks || [], k = w.assignments || [], p.length || x.resource_render_empty_cells ? b.push({ start_date: g, end_date: m, tasks: p, assignments: k }) : b.push(null);
      return b;
    }(e, i, a, r), o;
  };
}
...
function vr(t) {
  ...
  function r(l, c) {
    var d = e[l];
    d && d[c] && d[c].parentNode && d[c].parentNode.removeChild(d[c]);
  }
  function s(l, c, d, u, h, _, f) {
    var y = a[l.id];
    y && y.parentNode && y.parentNode.removeChild(y);
    var v = function(b, g, m, p) {
      for (var k = g.getScale(), w = document.createElement("div"), x = Ct(k, p), $ = x.start; $ <= x.end; $++) {
        var S = k.trace_x[$], T = k.trace_x[$ + 1] || t.date.add(S, k.step, k.unit), E = k.trace_x[$].valueOf(), C = Math.min(b[E] / m, 1) || 0;
        if (C < 0) return null;
        var D = Math.min(b[T.valueOf()] / m, 1) || 0, A = pr(C, S, T, g);
        A && w.appendChild(A);
    ...
    return v && c && (v.setAttribute("data-resource-id", l.id), v.setAttribute(h.$config.item_attribute, l.id), v.style.position = "absolute", v.style.top = c.top + 1 + "px", v.style.height = h.getItemHeight(l.id) - 1 + "px", v.style.left = 0), v;
  }
  function o(l, c, d, u, h, _, f) {
    var y = h.histogram_cell_class(_.start_date, _.end_date, l, _.tasks, _.assignments), v = h.histogram_cell_label(_.start_date, _.end_date, l, _.tasks, _.assignments), b = h.histogram_cell_allocated(_.start_date, _.end_date, l, _.tasks, _.assignments), g = f.getItemHeight(l.id) - 1;
    if (y || v) {
      var m = document.createElement("div");
      return m.className = ["gantt_histogram_cell", y].join(" "), m.setAttribute(f.$config.item_attribute, l.id), m.style.cssText = ["left:" + c.left + "px", "width:" + c.width + "px", "height:" + g + "px", "line-height:" + g + "px", "top:" + (c.top + 1) + "px"].join(";"), v && (v = "<div class='gantt_histogram_label'>" + v + "</div>"), b && (v = "<div class='gantt_histogram_fill' style='height:" + 100 * Math.min(b / d || 0, 1) + "%;'></div>" + v), v && (m.innerHTML = v), m;
    }
    return null;
  }
  return { render: function(l, c, d, u) {
    var h = c.$getTemplates(), _ = c.getScale(), f = n(l, d.resource_property, _, c), y = [], v = {}, b = l.capacity || c.$config.capacity || 24;
    e[l.id] = {}, i[l.id] = null, a[l.id] = null;
    for (var g = !!u, m = Ct(_, u), p = m.start; p <= m.end; p++) {
      var k = f[p];
      if (k && (!g || Vt(p, _, u, t))) {
        var w = h.histogram_cell_capacity(k.start_date, k.end_date, l, k.tasks, k.assignments);
        v[k.start_date.valueOf()] = w || 0;
        var x = c.getItemPosition(l, k.start_date, k.end_date), $ = o(l, x, b, 0, h, k, c);
        $ && (y.push($), e[l.id][p] = $);
      }
    }
    var S = null;
    if (y.length) {
      ...
      var E = s(l, x, v, 0, c, b, u);
      E && (S.appendChild(E), a[l.id] = E), i[l.id] = S;
    }
    return S;
  }, update: function(l, c, d, u, h) {
    var _ = d.$getTemplates(), f = d.getScale(), y = n(l, u.resource_property, f, d), v = l.capacity || d.$config.capacity || 24, b = {}, g = !!h, m = Ct(f, h), p = {};
    ...
    for (var w = m.start; w <= m.end; w++) {
      ...
      if (p[w] = !1, x) {
        ...
        var S = d.getItemPosition(l, x.start_date, x.end_date);
        if (!g || Vt(w, f, h, t)) {
          var T = e[l.id];
          if (T && T[w]) T && T[w] && !T[w].parentNode && c.appendChild(T[w]);
          else {
            var E = o(l, S, v, 0, _, x, d);
            E && (c.appendChild(E), e[l.id][w] = E);
          }
        } else r(l.id, w);
      }
    }
    for (var k in p) p[k] !== !1 && r(l.id, k);
    var C = s(l, S, b, 0, d, v, h);
    C && (c.appendChild(C), a[l.id] = C);
  }, getRectangle: He, getVisibleRange: Q };
}
function Ke(t, n, e, i, a, r) {
  const s = { id: t.id, parent: t.id };
  function o(d) {
    if (!(d[r.start_date] && d[r.end_date])) return !1;
    for (let u = 0; u < r.length; u++) if (!d[r[u]]) return !1;
    return !0;
  }
  const l = o(t);
  let c = !1;
  return l && (s.start_date = t[r.start_date], s.end_date = t[r.end_date]), t.render == "split" && a.eachTask(function(d) {
    o(d) && (c = !0, s.start_date = s.start_date || d[r.start_date], s.end_date = s.end_date || d[r.end_date], s.start_date < d[r.start_date] && (s.start_date = d[r.start_date]), s.end_date > d[r.end_date] && (s.end_date = d[r.end_date]));
  }), !(!l && !c) && It(s, n, e);
}
function kr(t, n, e, i, a) {
  return a.config.auto_scheduling && a.config.auto_scheduling.show_constraints !== !1 ? Ke(t, n, e, 0, a, { start_date: "constraint_date", end_date: "constraint_date", additional_properties: ["constraint_type"] }) : !1;
}
function yr(t) {
  const n = {};
  ...
  function e(i, a, r) {
    ...
    let { height: c, marginTop: d } = Wn(t, a, l, 30, i, r), u = c, h = 0;
    switch (s) {
      case "snet":
      case "fnet":
      case "mso":
    ...
    switch (i.type === t.config.types.milestone && (d -= 1), o.style.height = c + "px", o.style.width = u + "px", o.style.left = l.left + "px", o.style.top = l.top + "px", o.style.marginLeft = h + "px", o.style.marginTop = d + "px", o.className = "gantt_constraint_marker gantt_constraint_marker_" + s, s) {
      case "snet":
      case "snlt":
      case "fnet":
      case "fnlt":
...
`;
  ...
  return { render: function(i, a, r, s) {
    if (!t.config.auto_scheduling_compatibility && t.config.auto_scheduling && t.config.auto_scheduling.show_constraints !== !1) {
      ...
      if (pt(i)) {
        const l = Ft(t, i.id);
        t.eachTask(function(c) {
          if (c.constraint_date && c.constraint_type) {
            const d = e(c, a, l);
            d && o.appendChild(d);
          }
        }, i.id);
  ...
  }, isInViewPort: kr, getVisibleRange: Q };
}
function br(t, n, e, i, a) {
  return Ke(t, n, e, 0, a, { start_date: "deadline", end_date: "deadline" });
}
function $r(t, n, e, i, a) {
  let r = !1;
  const s = { start_date: "start_date", end_date: "end_date" };
  return t.type == a.config.types.milestone && (s.end_date = s.start_date), t.baselines && (r = yn(t, n, e, i, a, s)), pt(t) && a.eachTask(function(o) {
    r || o.baselines && o.baselines.length && (o.type == a.config.types.milestone && (s.end_date = s.start_date), yn(o, n, e, i, a, s) && (r = !0));
  }, t.id), r;
}
function yn(t, n, e, i, a, r) {
  for (var s = 0; s < t.baselines.length; s++)
    if (Ke({ id: t.id, parent: t.parent, start_date: t.baselines[s].start_date, end_date: t.baselines[s].end_date }, n, e, 0, a, r)) return !0;
}
const xr = { init: function(t, n) {
  ...
  if (n.$config.bind && t.getDatastore(n.$config.bind)) {
    ...
    t.defined(n.$getConfig().dnd_sensitivity) && (i.config.sensitivity = n.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
      ...
      var d = c.getAttribute(n.$config.item_attribute);
      if (s(d)) return !1;
      var u = r().getItem(d);
      ...
      d && (d.style.position = "static"), i.config.id = c.getAttribute(n.$config.item_attribute);
      ...
      var l = K(n.$grid_data), c = l.x + n.$grid.scrollLeft, d = o.pos.y - 10, u = n.getItemHeight(i.config.id);
      d < l.y && (d = l.y);
      ...
      var l = K(n.$grid_data), c = n.$state.scrollTop || 0, d = t.$grid_data.getBoundingClientRect().height + c, u = o.pageY - l.y + c;
      return u > d ? u = d : u < c && (u = c), u;
    }, t), i._getTaskByY = t.bind(function(o, l) {
      var c = r();
      o = o || 0;
      var d = n.getItemIndexByTopPosition(o);
      return (d = l < d ? d - 1 : d) > c.countVisible() - 1 ? null : c.getIdByIndex(d);
    }, t), i.attachEvent("onDragMove", t.bind(function(o, l) {
      var c = t.$grid_data.getBoundingClientRect(), d = c.height + c.y + (n.$state.scrollTop || 0) + window.scrollY, u = i.config, h = i._getGridPos(l);
      ...
      if (f.exists(g) || (g = i.lastTaskOfLevel(_.order_branch_free ? v.$level : 0)) == i.config.id && (g = null), f.exists(g)) {
        var p = f.getItem(g), k = n.getItemTop(p.id), w = n.getItemHeight(p.id);
        if (k + w / 2 < b) {
          ...
          if (S) {
            ...
            p = S;
          } else if ($ = f.getIdByIndex(x), S = f.getItem($), s($) && (T = f.getPrev(S.id), S = f.getItem(T)), m(S, v) && S.id != v.id) return void f.move(v.id, -1, f.getParent(S.id));
...
function $n(t, n, e, i, a, r) {
  var s;
  if (n !== a.$getRootId()) {
    var o = a.getItem(n), l = a.calculateItemLevel(o);
    if (l === r) {
      var c = a.getPrevSibling(n);
      e < 0.5 && !c ? s = nt.prevSiblingTarget(t, n, a) : (e < 0.5 && (n = c), s = nt.nextSiblingTarget(t, n, a));
    } else if (l > r) a.eachParent(function(f) {
      a.calculateItemLevel(f) === r && (n = f.id);
    }, o), s = $e(t, n, r, a);
    else {
      var d = $e(t, n, r, a), u = bn(t, n, r, a);
      s = e < 0.5 ? d : u;
    }
  } else {
    var h = a.$getRootId(), _ = a.getChildren(h);
    s = nt.createDropTargetObject(), s = _.length && i >= 0 ? $e(t, function(f) {
...
const wn = { removeLineHighlight: function(t) {
  ...
  var i = function(r, s) {
    var o = K(s.$grid_data), l = ct(r, s.$grid_data), c = o.x + s.$grid.scrollLeft, d = l.y - 10, u = s.getItemHeight(r.targetId);
    d < o.y && (d = o.y);
    var h = s.getTotalHeight();
    return d > o.y + h - u && (d = o.y + h - u), o.x = c, o.y = d, o.width = xe(s.$gantt, o.width, 9), o;
  }(t, e);
  ...
  a || ((a = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", a.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", a.style.pointerEvents = "none"), t.child ? function(r, s, o) {
    var l = r.targetParent, c = xn({ x: 0, y: o.getItemTop(l) }, o), d = o.$grid_data.getBoundingClientRect().bottom + window.scrollY;
    ...
    var l = function(u, h) {
      ...
      if (u.targetId !== _.$getRootId()) {
        ...
        if (b = _.exists(u.targetId) ? _.calculateItemLevel(_.getItem(u.targetId)) : 0, u.prevSibling) f.y = m;
      ...
      return f.x = g + b * v, f.width = xe(h.$gantt, Math.max(h.$grid_data.offsetWidth - f.x, 0), f.x), xn(f, h);
  ...
  if (n.$config.bind && t.getDatastore(n.$config.bind)) {
    ...
    t.defined(n.$getConfig().dnd_sensitivity) && (i.config.sensitivity = n.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
      var c = a(l);
      if (!c || (t.hideQuickInfo && t.hideQuickInfo(), dt(l.target, ".gantt_grid_editor_placeholder"))) return !1;
      var d = c.getAttribute(n.$config.item_attribute), u = n.$config.rowStore.getItem(d);
      return !t.isReadonly(u) && !r(d) && (i.config.initial_open_state = u.$open, !!t.callEvent("onRowDragStart", [d, l.target || l.srcElement, l]) && void 0);
    }, t)), i.attachEvent("onAfterDragStart", t.bind(function(o, l) {
      var c = a(l);
      i.config.marker.innerHTML = c.outerHTML;
      var d = i.config.marker.firstChild;
      d && (i.config.marker.style.opacity = 0.4, d.style.position = "static", d.style.pointerEvents = "none"), i.config.id = c.getAttribute(n.$config.item_attribute);
      var u = n.$config.rowStore, h = u.getItem(i.config.id);
      i.config.level = u.calculateItemLevel(h), i.config.drop_target = nt.createDropTargetObject({ targetParent: u.getParent(h.id), targetIndex: u.getBranchIndex(h.id), targetId: h.id, nextSibling: !0 }), h.$open = !1, h.$transparent = !0, this.refreshData();
    }, t)), i.attachEvent("onDragMove", t.bind(function(o, l) {
      var c = s(l);
      return c && t.callEvent("onBeforeRowDragMove", [i.config.id, c.targetParent, c.targetIndex]) !== !1 || (c = nt.createDropTargetObject(i.config.drop_target)), wn.highlightPosition(c, i.config, n), i.config.drop_target = c, t._waiAria.reorderMarkerAttr(i.config.marker), this.callEvent("onRowDragMove", [i.config.id, c.targetParent, c.targetIndex]), !0;
    }, t)), i.attachEvent("onDragEnd", t.bind(function() {
      var o = n.$config.rowStore, l = o.getItem(i.config.id);
      wn.removeLineHighlight(i.config), l.$transparent = !1, l.$open = i.config.initial_open_state;
  ...
  function r(o) {
    return Gt(o, t, t.getDatastore(n.$config.bind));
  }
  function s(o) {
    var l, c = function(f) {
      var y = ct(f, n.$grid_data).y, v = n.$config.rowStore;
      ...
      var k = v.getIdByIndex(p), w = n.$state.scrollTop / n.getItemHeight(k), x = w - Math.floor(w);
      x > 0.1 && x < 0.9 && (g -= n.getItemHeight(k) * x, m += n.getItemHeight(k) * (1 - x));
      const $ = K(n.$grid_data), S = $.y + $.height, T = i.config.marker.offsetHeight;
      y + T + window.scrollY >= g && (i.config.marker.style.top = S - T + "px"), y >= g ? y = g : y <= m && (y = m, i.config.marker.style.top = $.y + "px");
    ...
    }(o), d = null, u = n.$config.rowStore, h = !n.$getConfig().order_branch_free, _ = ct(o, n.$grid_data).y;
    return document.doctype || (_ += window.scrollY), c !== u.$getRootId() && (d = (_ - n.getItemTop(c)) / n.getItemHeight(c)), h ? (l = $n(i.config.id, c, d, _, u, i.config.level)) && l.targetParent && r(l.targetParent) && (c = u.getPrevSibling(l.targetParent), l = $n(i.config.id, c, d, _, u, i.config.level)) : l = function(f, y, v, b, g) {
      var m;
      if (y !== g.$getRootId()) m = v < 0.25 ? nt.prevSiblingTarget(f, y, g) : !(v > 0.6) || g.hasChild(y) && g.getItem(y).$open ? nt.firstChildTarget(f, y, g) : nt.nextSiblingTarget(f, y, g);
      else {
        var p = g.$getRootId();
...
var Sr = function(t) {
  return { onCreated: function(n) {
    n.$config = O(n.$config, { bind: "task" }), n.$config.id == "grid" && (this.extendGantt(n), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(n), t.ext.inlineEditors.init()), this._mouseDelegates = qe(t);
  }, onInitialized: function(n) {
    var e = n.$getConfig();
    e.order_branch && (e.order_branch == "marker" ? wr.init(n.$gantt, n) : xr.init(n.$gantt, n)), this.initEvents(n, t), n.$config.id == "grid" && this.extendDom(n);
    ...
    this._mouseDelegates.delegate("click", "gantt_row", e.bind(function(i, a, r) {
      ...
      if (a !== null) {
        ...
        if (s.scroll_on_click) {
          const l = !e._is_icon_open_click(i), c = e.$ui.getView("timeline");
...
const Tr = { createTaskDND: function() {
  var t;
  return { extend: function(n) {
    ...
    return t = function(i, a) {
      ...
      return { drag: null, dragMultiple: {}, _events: { before_start: {}, before_finish: {}, after_finish: {} }, _handlers: {}, init: function() {
        ...
        this.set_actions(), r.getService("state").registerProvider("tasksDnd", z(function() {
        ...
        for (var c in s) {
          ...
          if (!u.unscheduled) {
            var h = this._drag_task_coords(u, d), _ = a.posFromDate(new Date(a.getState().min_date)), f = a.posFromDate(new Date(a.getState().max_date));
            if (h.end + o > f) {
              var y = f - h.end;
              (y < l || l === void 0) && (l = y);
            } else if (h.start + o < _) {
        ...
        if (this.drag.start_drag) {
          var o = ct(s, a.$task_data), l = this.drag.start_drag.start_x, c = this.drag.start_drag.start_y;
          ...
          if (this._handlers[o.mode]) {
            if (o.mode === l.drag_mode.move) {
              ...
              if (a.isSummaryTask(h) && a.config.drag_project) {
                var y = {};
                y[o.id] = X(o), f = !0, _ = O(y, this.dragMultiple);
              }
              ...
              for (var b in _) {
                var g = _[b];
                f && g.id != o.id && (a._bulk_dnd = !0), this._update_item_on_move(u, g.id, g.mode, g, s, m);
              }
              a._bulk_dnd = !1;
        ...
        if (s.button != 2 || s.button === void 0) {
          ...
          if (a.isTaskExists(c) && (d = a.getTask(c)), !a.isReadonly(d) && !this.drag.mode) {
            ...
            var u = it(o = o || s.target || s.srcElement), h = this._get_drag_mode(u, o);
        ...
        if (o.mode && o.id) {
          ...
          var _ = function() {
            if (u) for (var f in d) d[f].id != o.id && this._finalize_mouse_up(d[f].id, l, d[f], s);
        ...
        if (l["drag_" + o.mode] && a.callEvent("onBeforeDrag", [c, o.mode, s]) && this._fireEvent("before_start", o.mode, [c, o.mode, s])) {
          ...
          if (this._isMultiselect()) {
            ...
            u.indexOf(o.id) >= 0 && ht(u, a.bind(function(h) {
              var _ = a.getTask(h);
...
var Er = function(t, n) {
  ...
  var l = n.$services, c = l.getService("state"), d = l.getService("dnd");
  c.registerProvider("linksDnD", o);
  var u = "gantt_link_point", h = "gantt_link_control", _ = new d(t.$task_bars, { sensitivity: 0, updates_per_second: 60, mousemoveContainer: n.$root, selector: "." + u, preventDefault: !0 });
  function f(m, p) {
    var k, w = _.getPosition(m), x = function(A) {
      var I = 0, M = 0;
      return A && (I = A.offsetWidth || 0, M = A.offsetHeight || 0), { width: I, height: M };
    }(p), $ = { right: (k = n.$root).offsetWidth, bottom: k.offsetHeight }, S = n.config.tooltip_offset_x || 10, T = n.config.tooltip_offset_y || 10, E = n.config.scroll_size || 18, C = n.$container.getBoundingClientRect().y + window.scrollY, D = { y: w.y + T, x: w.x + S, bottom: w.y + x.height + T + E, right: w.x + x.width + S + E };
  ...
  function b(m, p, k, w) {
    ...
    if (T = Math.max(0, T - 3)) {
      ...
      if (window.navigator.userAgent.indexOf("MSIE 8.0") != -1) {
        ...
        var N = Math.abs(Math.round(m - k)), P = Math.abs(Math.round(w - p));
        switch (g(m, k, p, w)) {
          case 1:
            I -= P;
            break;
      ...
      L.push("top:" + I + "px"), L.push("left:" + M + "px"), x.style.cssText = L.join(";");
    }
  }
  function g(m, p, k, w) {
  ...
  _.attachEvent("onBeforeDragStart", n.bind(function(m, p) {
    ...
    var k = _.config, w = f(p, k.marker);
    (function(A, I) {
      A.style.left = I.x + "px", A.style.top = I.y + "px";
    })(k.marker, w);
    var x = !!yt(p, h), $ = i, S = e, T = a, E = n.locate(p), C = !0;
    if (et(At(p), n.$root) || (x = !1, E = null), x && (C = !yt(p, "task_end_date"), x = !!E), i = E, e = x, a = C, x) {
      const A = yt(p, h).querySelector(`.${u}`);
      if (A) {
        const I = An(A, t.$task_bg);
    ...
    var D = !(S == x && $ == E && T == C);
    return D && ($ && n.refreshTask($, !1), E && n.refreshTask(E, !1)), D && y(k.marker), b(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), !0;
  }, this)), _.attachEvent("onDragEnd", n.bind(function() {
    var m = o();
    if (m.link_source_id && m.link_target_id && m.link_source_id != m.link_target_id) {
      var p = n._get_link_type(m.link_from_start, m.link_to_start), k = { source: m.link_source_id, target: m.link_target_id, type: p };
...
var Dr = function(t) {
  ...
  return { onCreated: function(e) {
    var i = e.$config;
    i.bind = G(i.bind) ? i.bind : "task", i.bindLinks = G(i.bindLinks) ? i.bindLinks : "link", e._linksDnD = Cr(), e._tasksDnD = Tr.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = qe(t);
    ...
    this._mouseDelegates.delegate("click", "gantt_task_link", e.bind(function(a, r) {
      ...
      var s = ct(a, e.$task_data), o = e.dateFromPos(s.x), l = Math.floor(e.columnIndexByDate(o)), c = e.getScale().trace_x[l];
      e.callEvent("onScaleClick", [a, c]);
  ...
  return { getVerticalScrollbar: function() {
    ...
    for (var i, a = n.getCellsByType("resizer"), r = !0, s = 0; s < a.length; s++) {
      ...
      if (c && c.$content === e || c.isChild && c.isChild(e)) {
        i = o, r = !1;
        break;
      }
    }
    ...
    if (i.resizer) {
      ...
      s.attachEvent("onResizeStart", function(o, l) {
        ...
        var u = r ? o : l, h = r ? c : d, _ = t.$ui.getView("grid"), f = _ ? _.$parent : null;
...
const Mr = { init: function(t) {
  ...
  var e = za(t);
  e.registerView("cell", wt), e.registerView("resizer", qa), e.registerView("scrollbar", Ya), e.registerView("layout", Xn, function(r) {
    (r.$config ? r.$config.id : null) === "main" && n(r, Ar);
  }), e.registerView("viewcell", Ga), e.registerView("multiview", Ua), e.registerView("timeline", Ye, function(r) {
    (r.$config ? r.$config.id : null) !== "timeline" && r.$config.bind != "task" || n(r, Dr);
  }), e.registerView("grid", ue, function(r) {
    (r.$config ? r.$config.id : null) !== "grid" && r.$config.bind != "task" || n(r, Sr);
  }), e.registerView("resourceGrid", Xa), e.registerView("resourceTimeline", Zn), e.registerView("resourceHistogram", Za);
  var i = function(r) {
    var s = Wa(r);
    return { getDataRender: function(o) {
      ...
      var l = o.name, c = o.defaultContainer, d = o.defaultContainerSibling, u = s.createGroup(c, d, function(h, _) {
        ...
        for (var f = 0; f < u.filters.length; f++) if (u.filters[f](h, _) === !1) return !1;
      }, Va);
      ...
      return { addTaskLayer: function(c) {
        ...
        const d = Jn();
        return typeof c == "function" ? c = { renderer: { render: c, getVisibleRange: d } } : c.renderer && !c.renderer.getVisibleRange && (c.renderer.getVisibleRange = d), c.view = "timeline", c && c.renderer && (c.renderer.getRectangle || c.renderer.isInViewPort || (c.renderer.isInViewPort = Kn)), l.addLayer(c);
  ...
  return t.ext.inlineEditors = a, t.ext._inlineEditors = a, a.init(t), { factory: e, mouseEvents: Fa.init(t), layersApi: i.init(), render: { gridLine: function() {
    return /* @__PURE__ */ function(r) {
      return { render: function(s, o, l, c) {
        for (var d = o.getGridColumns(), u = o.$getTemplates(), h = o.$config.rowStore, _ = [], f = 0; f < d.length; f++) {
          var y, v, b, g = f == d.length - 1, m = d[f];
          m.name == "add" ? (v = "<div " + (S = r._waiAria.gridAddButtonAttrString(m)) + " class='gantt_add'></div>", b = "") : (at(v = m.template ? m.template(s) : s[m.name]) && (v = u.date_grid(v, s, m.name)), v == null && (v = ""), b = v, v = "<div class='gantt_tree_content'>" + v + "</div>");
          var p = "gantt_cell" + (g ? " gantt_last_cell" : ""), k = [];
          if (m.tree) {
            p += " gantt_cell_tree";
            for (var w = 0; w < s.$level; w++) k.push(u.grid_indent(s));
          ...
          k.push(v), y = "<div class='" + p + "' data-column-index='" + f + "' data-column-name='" + m.name + "' style='" + x + "' " + S + ">" + k.join("") + "</div>", _.push(y);
        }
      ...
      }, update: null, getRectangle: ie, isInViewPort: fr, getVisibleRange: Q, onrender: function(s, o, l) {
    ...
    return /* @__PURE__ */ function(r) {
      ...
      function h(_, f, y, v, b, g, m, p) {
        ...
        if (Vt(f, _, v, r)) {
          ...
          var T = document.createElement("div");
          return T.style.width = k + "px", w = "gantt_task_cell" + (f == b - 1 ? " gantt_last_cell" : ""), x && (w += " " + x), T.className = w, $ && (T.innerHTML = $), T.style.position = "absolute", T.style.left = _.left[f] + "px", s[y.id][f] = T, o[y.id][f] = f, T;
        }
        return null;
      }
      return { render: function(_, f, y, v) {
        ...
        var p, k = document.createElement("div"), w = d(f), x = u(f);
        if (p = v && y.smart_rendering && !Wt(r) ? Ct(g, v.x) : { start: 0, end: m - 1 }, y.show_task_cells) {
          s[_.id] = {}, o[_.id] = {};
        ...
        if (T.isSelected(_.id) && (D += " gantt_selected"), k.className = D, y.smart_rendering ? (k.style.position = "absolute", k.style.top = f.getItemTop(_.id) + "px", k.style.width = "100%") : k.style.position = "relative", k.style.height = f.getItemHeight(_.id) + "px", _.id == "timeline_placeholder_task") {
          var A = 0;
        ...
        var g = y.getScale(), m = g.count, p = d(y), k = u(y);
        if (v.show_task_cells) {
          s[_.id] || (s[_.id] = {}), o[_.id] || (o[_.id] = {});
          var w = Ct(g, b);
          for (var x in o[_.id]) {
            var $ = o[_.id][x];
            (Number($) < w.start || Number($) > w.end) && c(_.id, $);
          }
          o[_.id] = {};
          for (var S = w.start; S <= w.end; S++) {
            var T = h(g, S, _, b, m, p, k, v);
            !T && l(_, S) ? c(_.id, S) : T && !T.parentNode && f.appendChild(T);
          }
        }
      }, getRectangle: He, getVisibleRange: Q, prepareData: _r };
    }(t);
  }, taskBar: function() {
    return function(r) {
      return { render: be(r), update: null, isInViewPort: It, getVisibleRange: Q };
    }(t);
  }, timedProjectBar: function() {
    return function(r) {
      return { render: ur(r), update: null, isInViewPort: dr, getVisibleRange: Q };
    }(t);
    ...
    return function(r) {
      ...
      function l(u, h, _, f, y) {
        let v = !0;
        return f.smart_rendering && (v = It(u, h, _)), v;
      }
      function c(u, h, _, f) {
        ...
        return v.style.top = f.top + g + "px", v.classList.add("gantt_rollup_child"), v.setAttribute("data-rollup-parent-id", u.id), v;
      }
      function d(u, h) {
        return u + "_" + h;
      }
      return { render: function(u, h, _, f) {
        ...
        y.y = 0, y.y_end = r.$task_bg.scrollHeight, u.$rollup.forEach(function(g) {
          const m = r.getTask(g), p = d(m.id, u.id);
          let k = l(m, y, _, f);
          if (k !== !!o[p]) if (k) {
            const w = c(u, m, _, b);
            o[p] = w || !1;
    ...
    return function(r) {
      ...
      function l(h, _, f, y, v) {
        let b = !h.hide_bar;
        return y.smart_rendering && b && (b = It(h, _, f)), b;
      }
      function c(h, _, f, y, v) {
        ...
        let k;
        const w = y.rowHeight, x = f.getBarHeight(g.id, p);
        let $ = Math.floor((f.getItemHeight(h.id) - x) / 2);
        p && (k = un(x)), v && ($ = p ? Math.floor((k - x) / 2) + 2 : 2);
        ...
        if (p) {
          if (k > w) {
            ...
            const E = hn(w), C = (E - w) / 2, D = m.querySelector(".gantt_task_content");
        ...
        return m.style.top = y.top + $ + "px", m.classList.add("gantt_split_child"), b && m.classList.add("gantt_split_subproject"), m;
      }
      function d(h, _) {
        return h + "_" + _;
      }
      ...
      return { render: function(h, _, f, y) {
        if (u(h, f)) {
          const v = document.createElement("div"), b = r.getTaskPosition(h), g = Ft(r, h.id);
          return r.hasChild(h.id) && r.eachTask(function(m) {
            if (!l(m, y, _, f)) return;
            const p = c(h, m, _, b, g);
            p ? (o[d(m.id, h.id)] = p, v.appendChild(p)) : o[d(m.id, h.id)] = !1;
          }, h.id), v;
        }
        return !1;
      }, update: function(h, _, f, y, v) {
        if (u(h, y)) {
          const b = document.createElement("div"), g = r.getTaskPosition(h), m = Ft(r, h.id);
          r.eachTask(function(p) {
            ...
            o[k] && b.appendChild(o[k]), _.innerHTML = "", _.appendChild(b);
          }, h.id);
        }
      }, isInViewPort: hr, getVisibleRange: Q };
    }(t);
    ...
    return /* @__PURE__ */ function(r) {
      function s(o, l, c) {
        const d = document.createElement("div"), u = r.getTaskPosition(o, o.deadline, o.deadline), { height: h, marginTop: _ } = Wn(r, l, u, 20, o, c);
        let f = h;
        return r.config.rtl && (u.left += f), d.style.left = u.left - f + "px", d.style.top = u.top + "px", d.style.marginTop = _ + "px", d.style.width = f + "px", d.style.height = h + "px", d.style.fontSize = h + "px", d.className = "gantt_task_deadline", d.setAttribute("data-task-id", o.id), d;
      }
      return { render: function(o, l, c, d) {
        const u = document.createElement("div");
        if (u.className = "gantt_deadline_nodes", u.setAttribute("data-task-row-id", o.id), o.deadline) {
          const h = s(o, l);
          u.appendChild(h);
        }
        if (pt(o)) {
      ...
      }, isInViewPort: br, getVisibleRange: Q };
    }(t);
  }, taskBaselines: function() {
    return /* @__PURE__ */ function(r) {
      function s(o, l, c, d, u) {
        ...
        let v, b = 0;
        if (f) {
          let T = d.getBarHeight(o.id, !0);
          v = un(T), b = Math.floor((v - T) / 4);
        }
        let g = ne(r, d, o, y.rowHeight).maxHeight, m = y.top + 1 + b, p = d.getBarHeight(o.id, o.type);
        const k = r.config.baselines.row_height, w = r.config.baselines.bar_height;
        let x, $;
        switch (r.config.baselines.render_mode) {
          case "separateRow":
            ...
            break;
          case "individualRow":
            x = k * c, m += y.height + x + (k - w) / 2, p = w;
            break;
          default:
            $ = 1, u ? (g = ne(r, d, o).maxHeight, b ? g >= v ? $ = (g - p) / 2 - 1 - b : (p = hn(g), m = y.top, $ = Math.abs(p - g) / 2, b = 0) : (g > p && ($ = (g - p) / 2 - 1), $ -= b), o.bar_height || ($ -= 1)) : (o.bar_height && y.rowHeight >= o.bar_height && ($ = (y.rowHeight - o.bar_height) / 2 - 1), $ += b, o.bar_height || ($ += 2), f && ($ += 1));
        }
        let S = y.top + g + 1 - b;
        return !(m + p > S && (p -= m + p - S, p <= 0)) && (h.style.left = y.left + "px", h.style.width = y.width + "px", h.style.top = m + "px", h.style.height = Math.floor(p) + "px", $ && (h.style.marginTop = $ + "px"), h.className = `gantt_task_baseline gantt_task_baseline_${c} ${l.className || ""}`, f ? (h.className += " gantt_milestone_baseline", h.style.width = h.style.height = p + "px", h.style.marginLeft = Math.floor(-p / 2) + "px") : h.innerHTML = r.templates.baseline_text(o, l, c), h.setAttribute("data-task-id", o.id), h.setAttribute("data-baseline-id", l.id), h);
      }
      return { render: function(o, l, c, d) {
        if (!r.config.baselines.render_mode) return;
        const u = document.createElement("div");
        return u.className = "gantt_baseline_nodes", u.setAttribute("data-task-row-id", o.id), o.baselines && o.baselines.length && o.baselines.forEach(function(h, _) {
          const f = s(o, h, _, l);
          f && u.appendChild(f);
        ...
        }, o.id), u.childNodes.length ? u : void 0;
    ...
    return function(r) {
      var s = Qn(r), o = {};
      function l(d, u, h, _, f) {
        var y = h.resource_cell_class(u.start_date, u.end_date, d, u.tasks, u.assignments), v = h.resource_cell_value(u.start_date, u.end_date, d, u.tasks, u.assignments), b = f.getItemHeight(d.id) - 1;
        if (y || v) {
          var g = f.getItemPosition(d, u.start_date, u.end_date), m = document.createElement("div");
          return m.setAttribute(f.$config.item_attribute, d.id), m.className = ["gantt_resource_marker", y].join(" "), m.style.cssText = ["left:" + g.left + "px", "width:" + g.width + "px", "height:" + b + "px", "line-height:" + b + "px", "top:" + g.top + "px"].join(";"), v && (m.innerHTML = v), m;
        }
        return null;
      }
      function c(d, u) {
      ...
      return { render: function(d, u, h, _) {
        var f = u.$getTemplates(), y = u.getScale(), v = s(d, h.resource_property, u.getScale(), u), b = !!_, g = [];
        o[d.id] = {};
        for (var m = Ct(y, _), p = m.start; p <= m.end; p++) {
          var k = v[p];
          if (k && (!b || Vt(p, y, _, r))) {
            var w = l(d, k, f, 0, u);
            w && (g.push(w), o[d.id][p] = w);
          }
        }
        var x = null;
        if (g.length) {
        ...
        return x;
      }, update: function(d, u, h, _, f) {
        var y = h.$getTemplates(), v = h.getScale(), b = s(d, _.resource_property, h.getScale(), h), g = Ct(v, f), m = {};
        if (o && o[d.id]) for (var p in o[d.id]) m[p] = p;
        for (var k = g.start; k <= g.end; k++) {
          var w = b[k];
          if (m[k] = !1, w) if (Vt(k, v, f, r)) if (o[d.id] && o[d.id][k]) o[d.id] && o[d.id][k] && !o[d.id][k].parentNode && u.appendChild(o[d.id][k]);
          else {
            var x = l(d, w, y, 0, h);
            x && (u.appendChild(x), o[d.id][k] = x);
          }
          else c(d.id, k);
        }
        for (var p in m) m[p] !== !1 && c(d.id, p);
      }, getRectangle: He, getVisibleRange: Q };
    }(t);
...
function we(t, n) {
  ...
  var c = n.skins[n.skin] || n.skins.terrace;
  (function(h, _, f) {
    for (var y in _) (h[y] === void 0 || f) && (h[y] = _[y]);
  })(n.config, c.config, t), a || (n.config.link_radius = 1);
  var d = n.getGridColumns();
  for (d[1] && !n.defined(d[1].width) && (d[1].width = c._second_column_width), d[2] && !n.defined(d[2].width) && (d[2].width = c._third_column_width), o = 0; o < d.length; o++) {
    var u = d[o];
  ...
  c.config.task_height && (n.config.task_height = c.config.task_height || "full"), c.config.bar_height && (n.config.bar_height = c.config.bar_height || "full"), c._lightbox_template && (n._lightbox_template = c._lightbox_template), c._redefine_lightbox_buttons && (n.config.buttons_right = c._redefine_lightbox_buttons.buttons_right, n.config.buttons_left = c._redefine_lightbox_buttons.buttons_left), n.resetLightbox();
}
function Ir(t) {
  var n = null, e = !1, i = null, a = { started: !1 }, r = {};
  function s(_) {
    return _ && et(_, t.$root) && _.offsetHeight;
  }
  function o() {
  ...
  function d(_) {
    var f = o();
    if (!n && !i || f || c(!1), !t.config.autoscroll || !f) return !1;
    r = { x: _.clientX, y: _.clientY }, _.type == "touchmove" && (r.x = _.targetTouches[0].clientX, r.y = _.targetTouches[0].clientY), !n && f && c(!0);
  }
  function u() {
    if (!o()) return c(!1), !1;
    ...
    if (_) {
      ...
      var y = K(_), v = r.x - y.x, b = r.y - y.y + window.scrollY, g = e ? 0 : h(v, y.width, a.x - y.x), m = h(b, y.height, a.y - y.y + window.scrollY), p = t.getScrollState(), k = p.y, w = p.inner_height, x = p.height, $ = p.x, S = p.inner_width, T = p.width;
      (m && !w || m < 0 && !k || m > 0 && k + w >= x + 2) && (m = 0), (g && !S || g < 0 && !$ || g > 0 && $ + S >= T) && (g = 0);
      var E = t.config.autoscroll_step;
      E && E < 2 && (E = 2), m *= E || 30, ((g *= E || 30) || m) && function(C, D) {
        var A = t.getScrollState(), I = null, M = null;
        C && (I = A.x + C, I = Math.min(A.width, I), I = Math.max(0, I)), D && (M = A.y + D, M = Math.min(A.height, M), M = Math.max(0, M)), t.scrollTo(I, M);
      }(g, m);
    }
  }
  function h(_, f, y) {
...
var Se, Te;
typeof window < "u" && window.jQuery && (Se = window.jQuery, Te = [], Se.fn.dhx_gantt = function(t) {
  ...
  if (Te[t]) return Te[t].apply(this, []);
  Se.error("Method " + t + " does not exist on jQuery.dhx_gantt");
});
...
const Lr = ["ctrlKey", "altKey", "shiftKey", "metaKey"], Nr = [[{ unit: "month", date: "%M", step: 1 }, { unit: "day", date: "%d", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 8 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 1 }]];
class Pr {
  constructor(n) {
    this.zoomIn = () => {
...
function Rr(t) {
  ...
  t._touch_events = function(r, s, o) {
    var l, c = 0, d = !1, u = !1, h = null, _ = null, f = null, y = [], v = null;
    let b = {};
    ...
    (a = []).push([t.$container, r[0], function(p) {
      ...
      if (!o(p) && d) {
        _ && clearTimeout(_);
        var w = s(p);
        if (k && (k.drag.id || k.drag.start_drag)) return k.on_mouse_move(w), p.preventDefault && p.preventDefault(), p.cancelBubble = !0, !1;
        if (!t._prevent_touch_scroll) {
          if (w && h) {
            var x = h.pageX - w.pageX, $ = h.pageY - w.pageY;
            if (!u && (Math.abs(x) > 5 || Math.abs($) > 5) && (u = !0, c = 0, l = v ? e(v) : t.getScrollState()), u) {
              var S, T = l.x + x, E = l.y + $;
              if (v ? (function(C, D, A) {
    ...
    for (a.push([this.$container, "contextmenu", function(p) {
      ...
      if (b = p.touches.length, document && document.body && document.body.classList.add("gantt_touch_active"), !o(p)) if (p.touches && p.touches.length > 1) d = !1;
      else {
        h = s(p), v = function(w) {
        ...
        _ = setTimeout(function() {
          var w = t.locate(h);
          k && w && !t._locate_css(h, "gantt_link_control") && !t._locate_css(h, "gantt_grid_data") && (k.on_mouse_down(h), k.drag && k.drag.start_drag && (function(x) {
            ...
            if (S) {
              ...
              if (T) {
                ...
                for (let E = 0; E < $.length; E++) if (S = $[E].rendered[x], S && S.getAttribute(t.config.task_attribute) && S.getAttribute(t.config.task_attribute) == x) {
                  ...
                  y.push(S), $[E].rendered[x] = C, S.style.display = "none", C.className += " gantt_drag_move ", S.parentNode.appendChild(C);
                }
          ...
          }(w), k._start_dnd(h), t._touch_drag = !0, t.refreshTask(w), t._touch_feedback())), _ = null;
        }, t.config.touch_drag);
      }
      ...
      if (document && document.body && document.body.classList.remove("gantt_touch_active"), !o(p)) {
        ...
        var k = s(p), w = i();
        if (w && w.on_mouse_up(k), f && t.isTaskExists(f) && (t.refreshTask(f), y.length && (y.forEach(function($) {
          $.parentNode && $.parentNode.removeChild($);
        }), t._touch_feedback())), d = u = !1, y = [], f = null, h && c) {
          var x = /* @__PURE__ */ new Date();
          x - c < 500 && b <= 1 ? (t.$services.getService("mouseEvents").onDoubleClick(h), m(p)) : c = x;
...
var ae = { getHtmlSelect: function(t, n, e) {
  ...
  }), Ot("select", { innerHTML: i }, n);
}, getHtmlOption: function(t, n) {
  return Ot("option", t, n);
}, getHtmlButton: function(t, n) {
  return Ot("button", t, n);
  ...
  function i(a, r) {
    ...
    r && (s = t.getTaskByTime(), a.allow_root && s.unshift({ id: t.config.root_id, text: a.root_label || "" }), s = function(u, h, _) {
      ...
      for (var y = 0; y < u.length; y++) {
        var v = u[y];
        (v.id == _ || t.isChildOf(v.id, _) || f(v.id, v) === !1) && (u.splice(y, 1), y--);
      }
      return u;
...
function Or(t) {
  ...
  function a(l, c, d, u) {
    var h, _ = "";
    if (l) return h = [{ key: "data-item-id", value: l.key }, { key: "data-assignment-id", value: u || "" }, { key: "class", value: "gantt_resource_amount_input" }], d && h.push({ key: "disabled", value: "disabled" }), l.options ? _ += ae.getHtmlSelect(l.options, h, c) : (h[h.length] = { key: "value", value: c || "" }, _ += ae.getHtmlInput(h)), _;
  }
  function r(l) {
  ...
  return t.attachEvent("onAfterLightbox", function() {
    ...
    var d = t.locale.labels.resources_filter_placeholder || l.filter_placeholder || "type to filter", u = t.locale.labels.resources_filter_label || "hide empty";
    return c = "<div" + (isNaN(l.height) ? "" : " style='height: " + l.height + "px;'") + " class='gantt_section_" + l.name + "'>", c += "<div class='gantt_cal_ltext gantt_resources_filter'><input type='text' class='gantt_resources_filter_input' placeholder='" + d + "'> <label><input class='switch_unsetted' type='checkbox'><span class='matherial_checkbox_icon'></span>" + u + "</label></div>", c += "<div class='gantt_cal_ltext gantt_resources' data-name='" + l.name + "'></div>", c += "</div>";
  }, i.prototype.set_value = function(l, c, d, u) {
    var h, _ = function(y, v) {
      return e.resources[v.id] || (e.resources[v.id] = y.querySelector(".gantt_resources")), e.resources[v.id];
    }(l, u), f = "";
    (function(y, v) {
      if (!e.filter[v.id]) {
        var b = y.querySelector(".gantt_resources_filter"), g = b.querySelector(".gantt_resources_filter_input"), m = b.querySelector(".switch_unsetted");
        e.filter[v.id] = { container: b, input: g, checkbox: m, filterApplied: !1 };
      }
      e.filter[v.id];
    })(l, u), function(y, v, b, g) {
      if (e.eventsInitialized[b.id]) return;
      var m = function(S) {
        var T, E, C, D, A;
        k(b, y);
        var I = o(b);
        A = I.checkbox, D = I.input, C = A.checked, E = D.value.trim(), I.filterApplied = !!E, t.getState().lightbox && (v = t.getLightboxValues()), T = function(L, N, P, R) {
          var B, H;
          if (R) {
            var F = N[L.map_to] || [];
            if (Lt(F) || (F = [F]), (F = F.slice()).length === 0) {
              for (var V in F = [], (H = t.copy(L)).options = [], e.resourcesValues[L.id])
                (j = e.resourcesValues[L.id][V]).value !== "" && F.push({ resource_id: V, value: j.value, id: j.id });
              if (F.length === 0) return H;
            } else for (var V in e.resourcesValues[L.id]) {
              var j;
              (j = e.resourcesValues[L.id][V]).value !== "" && (Ee(F, function(St) {
                return St.id == V;
              }) || F.push({ resource_id: V, value: j.value, id: j.id }));
            }
            for (var st = {}, mt = 0; mt < F.length; mt++) st[F[mt].resource_id] = !0;
            B = function(q) {
              if (st[String(q.key)] && (P === "" || q.label.toLowerCase().indexOf(P.toLowerCase()) >= 0)) return q;
            };
          } else {
            if (P === "") return L;
            B = function(q) {
              if (q.label.toLowerCase().indexOf(P.toLowerCase()) >= 0) return q;
            };
          }
          return (H = t.copy(L)).options = function(q, St) {
            var Ht = [];
            if (q.filter) return q.filter(St);
            for (var Tt = 0; Tt < q.length; Tt++) St(q[Tt], Tt) && (Ht[Ht.length] = q[Tt]);
            return Ht;
          }(H.options, B), H;
        }(b, v, E, C);
        var M = v[b.map_to];
      ...
      function p(S) {
        ...
        if (S.target.type === "checkbox") {
          ...
          var C = T.getAttribute("data-item-id"), D = yt(S, "gantt_resource_row"), A = D.querySelector(".gantt_resource_amount_input");
          if (D.setAttribute("data-checked", E.checked), E.checked) {
            ...
            var I = C, M = b.default_value;
            b.options.forEach(function(L) {
              L.key == I && L.default_value && (M = L.default_value);
            }), A && !A.value && M !== void 0 && (A.value = M, k(b, this)), A.select ? A.select() : A.focus && A.focus();
          } else e.resourcesValues[b.id] && delete e.resourcesValues[b.id][C];
        } else S.target.type !== "text" && S.target.nodeName.toLowerCase() !== "select" || (E.parentNode.parentNode, T = S.target, k(b, this));
      }
      function k(S, T) {
        var E = r(), C = T.querySelectorAll(E);
        e.resourcesValues[S.id] = e.resourcesValues[S.id] || {};
        for (var D = 0; D < C.length; D++) {
          var A = C[D].getAttribute("data-item-id"), I = C[D].getAttribute("data-assignment-id");
          C[D].disabled ? delete e.resourcesValues[S.id][A] : e.resourcesValues[S.id][A] = { value: C[D].value, id: I };
        }
      }
      ...
      }, o(b).container.addEventListener("keyup", m), o(b).container.addEventListener("input", m, !0), o(b).container.addEventListener("change", m, !0), s(b).addEventListener("input", p), s(b).addEventListener("change", p), t.attachEvent("onResourcesSelectActivated", t.bind(p, s(b))), e.eventsInitialized[b.id] = !0;
      var w, x, $;
    }(l, d, u, this), ht(u.options, function(y, v) {
      u.unassigned_value != y.key && (h = function(b, g, m) {
        var p = {};
        if (g) {
          var k;
          Lt(g) ? k = Ee(g, function(w) {
            return w.resource_id == m.key;
          }) : g.resource_id == m.key && (k = g), k && (p.value = k.value, p.id = k.id);
        }
...
function Br(t) {
  var n = function() {
    ...
    return W(p, m), p.prototype.render = function(k) {
      const w = (k.height || "130") + "px", x = k.placeholder ? `placeholder='${k.placeholder}'` : "";
    ...
    return W(p, m), p.prototype.render = function(k) {
      ...
      return $ += w, k.single_date ? (w = g.form_blocks.getTimePicker.call(this, k, !0), $ += "<span></span>") : $ += "<span class='gantt_section_time_spacer'> &nbsp;&ndash;&nbsp; </span>", ($ += w) + "</div>";
    }, p.prototype.set_value = function(k, w, x, $) {
      var S = $, T = k.getElementsByTagName("select"), E = $._time_format_order;
      if (S.auto_end_date) for (var C = function() {
        I = new Date(T[E[2]].value, T[E[1]].value, T[E[0]].value, 0, 0), M = g.calculateEndDate({ start_date: I, duration: 1, task: x }), g.form_blocks._fill_lightbox_select(T, E.size, M, E, S);
      }, D = 0; D < 4; D++) T[D].onchange = C;
      var A = g._resolve_default_mapping($);
      typeof A == "string" && (A = { start_date: A });
      var I = x[A.start_date] || /* @__PURE__ */ new Date(), M = x[A.end_date] || g.calculateEndDate({ start_date: I, duration: 1, task: x });
      g.form_blocks._fill_lightbox_select(T, 0, I, E, S), g.form_blocks._fill_lightbox_select(T, E.size, M, E, S);
    ...
    return W(p, m), p.prototype.render = function(k) {
      ...
      if (k.options && k.options.length) for (var $ = 0; $ < k.options.length; $++) x += "<label><input type='checkbox' value='" + k.options[$].key + "' name='" + k.name + "'>" + k.options[$].label + "</label>";
      else k.single_value = !0, x += "<label><input type='checkbox' name='" + k.name + "'></label>";
      return x += "</div>", x;
    }, p.prototype.set_value = function(k, w, x, $) {
      var S = Array.prototype.slice.call(k.querySelectorAll("input[type=checkbox]"));
      !k._dhx_onchange && $.onchange && (k.onchange = $.onchange, k._dhx_onchange = !0), $.single_value ? S[0].checked = !!w : ht(S, function(T) {
    ...
    return W(p, m), p.prototype.render = function(k) {
      ...
      if (k.options && k.options.length) for (var $ = 0; $ < k.options.length; $++) x += "<label><input type='radio' value='" + k.options[$].key + "' name='" + k.name + "'>" + k.options[$].label + "</label>";
      return x += "</div>", x;
    }, p.prototype.set_value = function(k, w, x, $) {
      var S;
      $.options && $.options.length && (S = k.querySelector("input[type=radio][value='" + w + "']") || k.querySelector("input[type=radio][value='" + $.default_value + "']")) && (!k._dhx_onchange && $.onchange && (k.onchange = $.onchange, k._dhx_onchange = !0), S.checked = !0);
    ...
    return W(p, m), p.prototype.render = function($) {
      ...
      return $.name !== "time" && (M += " gantt_section_" + $.name), "<div style='padding-top:0px;font-size:inherit;' class='" + M + "'>" + S + " " + I + "</div>";
      ...
      function H() {
        var V = w.call(g, $, E), j = x.call(g, $, E), st = g.calculateEndDate({ start_date: V, duration: j, task: T }), mt = g.templates.task_end_date || g.templates.task_date;
        R.innerHTML = mt(st);
      }
      function F(V) {
        var j = N.value;
        j = k(E).parse(j), window.isNaN(j) && (j = 0), (j += V) < 1 && (j = 1), N.value = k(E).format(j), H();
      }
      P[0].onclick = g.bind(function() {
        F(-1 * g.config.duration_step);
      }, this), P[1].onclick = g.bind(function() {
        F(1 * g.config.duration_step);
      }, this), M[0].onchange = H, M[1].onchange = H, M[2].onchange = H, M[3] && (M[3].onchange = H), N.onkeydown = g.bind(function(V) {
        var j;
        return (j = (V = V || window.event).charCode || V.keyCode || V.which) == g.constants.KEY_CODES.DOWN ? (F(-1 * g.config.duration_step), !1) : j == g.constants.KEY_CODES.UP ? (F(1 * g.config.duration_step), !1) : void window.setTimeout(H, 1);
      }, this), N.onchange = g.bind(H, this), typeof (C = g._resolve_default_mapping(E)) == "string" && (C = { start_date: C }), D = T[C.start_date] || /* @__PURE__ */ new Date(), A = T[C.end_date] || g.calculateEndDate({ start_date: D, duration: 1, task: T }), I = Math.round(T[C.duration]) || g.calculateDuration({ start_date: D, end_date: A, task: T }), I = k(E).format(I), g.form_blocks._fill_lightbox_select(M, 0, D, B, E), N.value = I, H();
    ...
    return W(p, m), p.prototype.render = function(x) {
      ...
      return x.options = x.options || T, S += "<span data-constraint-type-select>" + ae.getHtmlSelect(x.options, [{ key: "data-type", value: "constraint-type" }]) + "</span>", S += "<label data-constraint-time-select>" + (g.locale.labels.constraint_date || "Constraint date") + ": " + g.form_blocks.getTimePicker.call(this, x) + "</label>", S += "</div>", S;
      ...
      return k(C) || (D = g.form_blocks.getTimePickerValue(E, S)), { constraint_type: C, constraint_date: D };
    ...
    return W(p, m), p.prototype.render = function(k) {
      var w = g.config.types, x = g.locale.labels, $ = [], S = k.filter || function(C, D) {
    ...
    function w(S, T, E, C) {
      ...
      const I = C.single_date ? " style='display:none'" : "", M = C.readonly ? " disabled='disabled'" : "", L = g._waiAria.lightboxDurationInputAttrString(C), N = g.locale.labels.baselines_remove_button;
      let P = "gantt_duration_value";
      C.formatter && (A = "", P += " gantt_duration_value_formatted");
      const R = "<div class='gantt_duration' " + I + "><div class='gantt_duration_inputs'><input type='button' class='gantt_duration_dec' value='−'" + M + "><input type='text' value='5days' class='" + P + "'" + M + " " + L + "><input type='button' class='gantt_duration_inc' value='+'" + M + "></div><div class='gantt_duration_end_date'>" + A + "<span></span></div></div></div>", B = `<div><div class='baseline_delete_button gantt_custom_button'>${N}</div></div>`, H = document.createElement("div");
      H.className = "gantt_section_time gantt_section_duration", H.setAttribute("data-baseline-id", T.id), H.innerHTML = D + R + B + "<br>", S.appendChild(H);
      var F, V, j, st = H.getElementsByTagName("select"), mt = H.getElementsByTagName("input"), q = mt[1], St = [mt[0], mt[2]], Ht = H.getElementsByTagName("span")[0], Tt = C._time_format_order;
      function $t() {
      ...
      function qt(vt) {
        var Z = q.value;
        Z = k(C).parse(Z), window.isNaN(Z) && (Z = 0), (Z += vt) < 1 && (Z = 1), q.value = k(C).format(Z), $t();
      }
      ...
      }, St[0].onclick = g.bind(function() {
        qt(-1 * g.config.duration_step);
      }, g), St[1].onclick = g.bind(function() {
        qt(1 * g.config.duration_step);
      }, g), st[0].onchange = $t, st[1].onchange = $t, st[2].onchange = $t, st[3] && (st[3].onchange = $t), q.onkeydown = g.bind(function(vt) {
        var Z;
        return (Z = (vt = vt || window.event).charCode || vt.keyCode || vt.which) == g.constants.KEY_CODES.DOWN ? (qt(-1 * g.config.duration_step), !1) : Z == g.constants.KEY_CODES.UP ? (qt(1 * g.config.duration_step), !1) : void window.setTimeout($t, 1);
      }, g), q.onchange = g.bind($t, g), g._resolve_default_mapping(C), F = T.start_date || /* @__PURE__ */ new Date(), V = T.end_date || g.calculateEndDate({ start_date: F, duration: 1, task: E }), j = g.calculateDuration({ start_date: F, end_date: V, task: E }), j = k(C).format(j), g.form_blocks._fill_lightbox_select(st, 0, F, Tt, C), q.value = j, $t();
    }
    function x(S, T) {
    ...
    return W(p, m), p.prototype.render = function(S) {
      ...
      return S.querySelectorAll("[data-baseline-id]").forEach((D) => {
        ...
        I = M ? g.copy(M) : { id: g.uid(), task_id: T.id, text: "Baseline 1" }, I.start_date = x(D, E), I.duration = $(D, E), I.end_date = g.calculateEndDate({ start_date: I.start_date, duration: I.duration, task: T }), C.push(I);
      }), C;
      ...
      if (g.callEvent("onSectionButton", [g._lightbox_id, E]) !== !1 && (T.closest(".gantt_custom_button.gantt_remove_baselines") && (C.innerHTML = g.locale.labels.baselines_section_placeholder), T.closest(".gantt_custom_button.gantt_add_baselines"))) {
        ...
        w(C, { id: g.uid(), task_id: D.id, start_date: D.start_date, end_date: D.end_date }, D, g._get_typed_lightbox_config()[S]);
      }
...
<div class="gantt_cal_ltitle_controls">
    ...
    if (this.config.round_dnd_dates) {
      ...
      if (function(p) {
        ...
        var m = t.getScale();
        g = Zt(m.unit) * m.step / 60;
      }
      return (!g || g >= 1440) && (g = this.config.time_step), g;
    }
    return this.config.time_step;
  }, t.getLabel = function(g, m) {
    for (var p = this._get_typed_lightbox_config(), k = 0; k < p.length; k++) if (p[k].map_to == g) {
      for (var w = p[k].options, x = 0; x < w.length; x++) if (w[x].key == m) return w[x].label;
    }
    return "";
    ...
    if (t.config.csp === !0 || t.env.isSalesforce ? t._lightbox_root = t.$root : t._lightbox_root = document.body, g === void 0 && (g = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this.getTaskType(g)) {
      this._lightbox_type = this.getTaskType(g), m = document.createElement("div"), $ = "gantt_cal_light", p = this._is_lightbox_timepicker(), t.config.wide_form && ($ += " gantt_cal_light_wide"), p && ($ += " gantt_cal_light_full"), m.className = $, m.style.visibility = "hidden", k = this._lightbox_template, k += "<div class='gantt_cal_lcontrols'>", k += y(this.config.buttons_left), k += "<div class='gantt_cal_lcontrols_push_right'></div>", k += y(this.config.buttons_right), k += "</div>", m.innerHTML = k, t._waiAria.lightboxAttr(m), t.config.drag_lightbox && (m.firstChild.onmousedown = t._ready_to_dnd, m.firstChild.ontouchstart = function(T) {
        t._ready_to_dnd(T.touches[0]);
      }, m.firstChild.onselectstart = function() {
        return !1;
      }, m.firstChild.style.cursor = "pointer", t._init_dnd_events()), this._lightbox && this.resetLightbox(), _(), this._cover.insertBefore(m, this._cover.firstChild), this._lightbox = m, w = this._get_typed_lightbox_config(g), k = this._render_sections(w);
      var S = (x = m.querySelector("div.gantt_cal_larea")).style.overflow;
      x.style.overflow = "hidden", x.innerHTML = k, function(T) {
        var E, C, D, A, I, M;
    ...
    for (var m = "", p = 0; p < g.length; p++) {
      ...
      if (k) {
        ...
        g[p].button && (x = "<div class='gantt_custom_button' data-index='" + p + "'><div class='gantt_custom_button_" + g[p].button + "'></div><div class='gantt_custom_button_label'>" + this.locale.labels["button_" + g[p].button] + "</div></div>"), g[p].type == "baselines" && (x = "<div class='gantt_custom_button gantt_remove_baselines' data-index='" + p + "'><div class='gantt_custom_button_delete_baselines'></div><div class='gantt_custom_button_label'>" + this.locale.labels.baselines_remove_all_button + "</div></div><div class='gantt_custom_button gantt_add_baselines' data-index='" + p + "'><div class='gantt_custom_button_add_baseline'></div><div class='gantt_custom_button_label'>" + this.locale.labels.baselines_add_button + "</div></div>"), this.config.wide_form && (m += "<div class='gantt_wrap_section' " + w + ">"), m += "<div id='" + g[p].id + "' class='gantt_cal_lsection'><label>" + x + (g[p].label || this.locale.labels["section_" + g[p].name] || g[p].name) + "</label></div>" + k.render.call(this, g[p]), m += "</div>";
      }
    }
    return m;
  ...
  function y(g, m) {
    var p, k, w = "";
    for (k = 0; k < g.length; k++) p = t.config._migrate_buttons[g[k]] ? t.config._migrate_buttons[g[k]] : g[k], w += "<div " + t._waiAria.lightboxButtonAttrString(p) + " class='gantt_btn_set gantt_left_btn_set " + p + "_set'><div dhx_button='1' data-dhx-button='1' class='" + p + "'></div><div>" + t.locale.labels[p] + "</div></div>";
    return w;
  }
  function v(g) {
    var m, p;
    return g.time_format ? g.time_format : (p = ["%d", "%m", "%Y"], Zt((m = t.getScale()) ? m.unit : t.config.duration_unit) < Zt("day") && p.push("%H:%i"), p);
  }
  function b(g, m, p) {
    var k, w, x, $, S, T, E = "";
    switch (p.timeFormat[m]) {
      case "%Y":
        for (g._time_format_order[2] = m, g._time_format_order.size++, g.year_range && (isNaN(g.year_range) ? g.year_range.push && (x = g.year_range[0], $ = g.year_range[1]) : k = g.year_range), k = k || 10, w = w || Math.floor(k / 2), x = x || p.date.getFullYear() - w, $ = $ || t.getState().max_date.getFullYear() + w, S = x; S <= $; S++) E += "<option value='" + S + "'>" + S + "</option>";
        break;
      case "%m":
  ...
  t._init_lightbox_events = function() {
    t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function() {
      ...
      if (m.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [m.className, m, g]);
        ...
        var p, k, w = it(m);
        if (w.indexOf("gantt_custom_button") != -1) if (w.indexOf("gantt_custom_button_") != -1) for (p = m.parentNode.getAttribute("data-index"), k = m; k && it(k).indexOf("gantt_cal_lsection") == -1; ) k = k.parentNode;
        else p = m.getAttribute("data-index"), k = m.closest(".gantt_cal_lsection"), m = m.firstChild;
        var x = t._get_typed_lightbox_config();
        p && (p *= 1, t.form_blocks[x[1 * p].type].button_click(p, m, k, k.nextSibling));
      }
      ...
      var m = g || window.event, p = g.target || g.srcElement, k = it(p).indexOf("gantt_btn_set") > -1;
      switch ((g || m).keyCode) {
    ...
    for (let p = 0; p < m.length; p++) {
      ...
      if (!w) continue;
      let x = w.get_value.call(this, k, g, m[p]), $ = t._resolve_default_mapping(m[p]);
      if (typeof $ == "string" && $ != "auto") g[$] = x;
      else if (typeof $ == "object") for (let S in $) $[S] && (g[$[S]] = x[S]);
    }
    ...
    var p = g, k = m.getElementsByTagName("span"), w = [];
    t.templates.lightbox_header ? (w.push(""), w.push(t.templates.lightbox_header(p.start_date, p.end_date, p)), k[1].innerHTML = "", k[2].innerHTML = t.templates.lightbox_header(p.start_date, p.end_date, p)) : (w.push(this.templates.task_time(p.start_date, p.end_date, p)), w.push(String(this.templates.task_text(p.start_date, p.end_date, p) || "").substr(0, 70)), k[1].innerHTML = this.templates.task_time(p.start_date, p.end_date, p), k[2].innerHTML = String(this.templates.task_text(p.start_date, p.end_date, p) || "").substr(0, 70)), k[1].innerHTML = w[0], k[2].innerHTML = w[1], t._waiAria.lightboxHeader(m, w.join(" "));
    ...
    var w = t._lightbox_root.querySelector("#" + k.id), x = w.nextSibling, $ = { section: k, header: w, node: x, getValue: function(T) {
    ...
    var p, k, w, x = "", $ = this.config, S = { first: 0, last: 1440, date: this.date.date_part(new Date(t._min_date.valueOf())), timeFormat: v(g) };
    for (g._time_format_order = { size: 0 }, t.config.limit_time_select && (S.first = 60 * $.first_hour, S.last = 60 * $.last_hour + 1, S.date.setHours($.first_hour)), p = 0; p < S.timeFormat.length; p++) p > 0 && (x += " "), (k = b(g, p, S)) && (w = t._waiAria.lightboxSelectAttrString(S.timeFormat[p]), x += "<select " + (g.readonly ? "disabled='disabled'" : "") + (m ? " style='display:none' " : "") + w + ">" + k + "</select>");
    return x;
  }, getTimePickerValue: function(g, m, p) {
    var k, w = m._time_format_order, x = 0, $ = 0, S = p || 0;
    return t.defined(w[3]) && (k = parseInt(g[w[3] + S].value, 10), x = Math.floor(k / 60), $ = k % 60), new Date(g[w[2] + S].value, g[w[1] + S].value, g[w[0] + S].value, x, $);
  }, _fill_lightbox_select: function(g, m, p, k) {
    if (g[m + k[0]].value = p.getDate(), g[m + k[1]].value = p.getMonth(), g[m + k[2]].value = p.getFullYear(), t.defined(k[3])) {
  ...
  }, template: new n(), textarea: new e(), select: new a(), time: new i(), duration: new o(), parent: new l(), radio: new s(), checkbox: new r(), resources: new c(), constraint: new d(), baselines: new h(), typeselect: new u() }, t._is_lightbox_timepicker = function() {
    ...
    if (!g) return p();
    var w = { text: g };
    m && (w.title = m), k && (w.ok = k), p && (w.callback = function(x) {
      x && p();
    }), t.confirm(w);
    ...
    if (this.getState().lightbox) {
      var p = this.getState().lightbox, k = this.getLightboxValues(), w = this.copy(this.getTask(p));
      this.resetLightbox();
      var x = this.mixin(w, k, !0), $ = this.getLightbox(g || void 0);
...
function zr(t) {
  if (!bt.isNode) {
    t.utils = { arrayFind: Ee, dom: Ln };
    var n = Ve();
    t.event = n.attach, t.eventRemove = n.detach, t._eventRemoveAll = n.detachAll, t._createDomEventScope = n.extend, O(t, Oa(t));
    var e = Mr.init(t);
    t.$ui = e.factory, t.$ui.layers = e.render, t.$mouseEvents = e.mouseEvents, t.$services.setService("mouseEvents", function() {
      ...
      function d(u, h, _, f) {
        var y = u(this);
        return y && y.isVisible() ? y[h].apply(y, _) : f ? f() : c;
      }
      return { getColumnIndex: function(u) {
        ...
        var f = d.call(this, i, "getItemPosition", [u, h, _]);
        return f === c ? { left: 0, top: this.getTaskTop(u.id), height: this.getTaskBarHeight(u.id), width: 0 } : f;
      }, getTaskBarHeight: function(u, h) {
        var _ = this, f = d.call(_, i, "getBarHeight", [u, h], function() {
        ...
        var _ = s(this), f = o(this), y = { position: 0 }, v = { position: 0 };
        _ && (v = _.getScrollState()), f && (y = f.getScrollState());
        var b = f && 1 * u == u, g = _ && 1 * h == h;
        if (b && g) for (var m = _._getLinkedViews(), p = f._getLinkedViews(), k = [], w = 0; w < m.length; w++) for (var x = 0; x < p.length; x++) m[w].$config.id && p[x].$config.id && m[w].$config.id === p[x].$config.id && k.push(m[w].$config.id);
        ...
        _ && ($ = _.getScrollState()), f && (S = f.getScrollState()), this.callEvent("onGanttScroll", [y.position, v.position, S.position, $.position]);
      }, showDate: function(u) {
      ...
      i.resetSkin || (i.resetSkin = function() {
        ...
        const o = this.skin !== s;
        this.skin = s, i._addThemeClass(), r(), i.$root && (we(!o, i), this.render());
      };
      let a = null;
      function r() {
        const s = i.$root;
      ...
      i.ext || (i.ext = {});
      for (var a = [Ir, null, null], r = 0; r < a.length; r++) a[r] && a[r](i);
      i.ext.zoom = new Pr(i);
    }(t), Rr(t), Br(t), function(i) {
      ...
      for (var c in i._waiAria = { getAttributeString: function(d) {
        ...
        var h = i.config.links, _ = d.type == h.finish_to_start || d.type == h.start_to_start, f = d.type == h.start_to_start || d.type == h.start_to_finish, y = i.locale.labels.link + " " + i.templates.drag_link(d.source, f, d.target, _);
  ...
  t.attachEvent("onParse", function() {
    ...
    this.config.scroll_size || (this.config.scroll_size = Tn() || 15), J(t) || (this._eventRemoveAll(), this.$mouseEvents.reset(), this.resetLightbox());
  }), t.attachEvent("onGanttReady", function() {
...
const Be = new class {
  constructor(t, n) {
    this.plugin = (e) => {
      this._ganttPlugin.push(e), Y.gantt !== void 0 && Y.gantt.getTask && e(Y.gantt);
    ...
    }, this._seed = 0, this._ganttPlugin = [], this._factoryMethod = t, this._bundledExtensions = n, this._extensionsManager = new On(n);
  }
}(function(t) {
  var n = Ha(t);
  return n.env.isNode || (zr(n), function(e) {
...
}, bi), Fr = Be.getGanttInstance();
Y.gantt = Fr, Y.Gantt = Be, Be.plugin((t) => {
  (function() {
    if (typeof window > "u") return !0;
    const n = typeof location < "u" ? location.hostname : window.location.hostname, e = ["ZGh0bWx4LmNvbQ==", "ZGh0bWx4Y29kZS5jb20=", "d2ViaXhjb2RlLmNvbQ==", "d2ViaXguaW8=", "cmVwbC5jbw==", "Y3NiLmFwcA==", "cmVwbGl0LmRldg=="];
    for (let i = 0; i < e.length; i++) {
      const a = window.atob(e[i]);
      if (a === n || n.endsWith("." + a)) return !0;
    }
    return !1;
  })() || setTimeout(() => {
    const n = ["This is an evaluation version dhtmlxGantt.", "Please contact us at <a href='mailto:contact@dhtmlx.com?subject=dhtmlxGantt licensing' target='_blank'>contact@dhtmlx.com</a> or visit", "<a href='https://dhtmlx.com/docs/products/dhtmlxGantt' target='_blank'>dhtmlx.com</a> in order to obtain a license."].join("<br>"), e = setInterval(() => {
      t && !t.$destroyed && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
