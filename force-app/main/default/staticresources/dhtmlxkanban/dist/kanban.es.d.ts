...
declare type TEditorShape = TTextFieldShape | TTitleFieldShape | TTextAreaFieldShape | TMultiselectFieldShape | TComboFieldShape | TSelectFieldShape | TProgressFieldShape | TColorFieldShape | TDateFieldShape | TFilesFieldShape | TDateRangeShape | TCommentsShape | TLinksShape;
...
declare class Rest<T> extends EventBus<T, keyof T> {
    ...
    send<T>(url: string, method: string, data?: object, customHeaders?: Record<string, string>): Promise<T>;
...
declare class RestDataProvider extends Rest<THandlersConfig> {
